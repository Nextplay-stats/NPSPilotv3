...
!function() {
    ...
    }, B = Array.prototype.slice, P = Array.prototype.indexOf, L = Array.prototype.push, I = function(e, t) {
        return P.call(e, t)
    }, M = function(e, t) {
        return -1 < I(e, t)
    }, F = function(e, t) {
    ...
    , ae = Object.keys, ue = Object.hasOwnProperty, se = function(e, t) {
        ...
        for (var o = d(n) ? e[0] : n, i = 0; i < e.length; i++)
            o = t.call(r, o, e[i], i);
        return o
    }, Ee = function(e, t, n) {
        for (var r = 0, o = e.length; r < o; r++)
    ...
    var Re, Te, De, Oe, Be, Pe, Le, Ie = function(e, t) {
    ...
    }, We = $e(/^\s+|\s+$/g), Ke = $e(/^\s+/g), Xe = $e(/\s+$/g), Ye = function(e) {
        return 0 < e.length
    }, Ge = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Je = function(t) {
        return function(e) {
            return Ve(e, t)
        }
    }, Qe = [{
        ...
        firefox: E(tt),
        safari: E("Safari")
    }, ot = "Windows", it = "Android", at = "Solaris", ut = "FreeBSD", st = "ChromeOS", ct = function(e) {
        var t = e.current
          , n = e.version
          , r = function(e) {
            return function() {
        ...
        var n, r, o, i, a, u, s, c, l, f, d, m, g = et.browsers(), p = et.oses(), h = je(g, e).fold(rt.unknown, rt.nu), v = He(p, e).fold(lt.unknown, lt.nu);
        return {
            browser: h,
            os: v,
            deviceType: (r = h,
    ...
    function() {
        ...
        return mt()
    }, pt = navigator.userAgent, ht = gt(), vt = ht.browser, yt = ht.os, bt = ht.deviceType, Ct = /WebKit/.test(pt) && !vt.isEdge(), wt = "FormData"in window && "FileReader"in window && "URL"in window && !!URL.createObjectURL, xt = -1 !== pt.indexOf("Windows Phone"), St = {
        opera: vt.isOpera(),
        webkit: Ct,
        ...
        return gt().browser.isIE() ? Lt(e, t) : (n = t,
        r = e.dom,
        o = n.dom,
        r !== o && r.contains(o));
        var n, r, o
    }, Mt = ("undefined" != typeof window || Function("return this;")(),
    function(e) {
    ...
    }, zt = Ut(1), jt = Ut(3), Ht = Ut(9), Vt = Ut(11), qt = function(e) {
    ...
    }, rn = m(Element.prototype.attachShadow) && m(Node.prototype.getRootNode), on = E(rn), an = rn ? function(e) {
    ...
    : $t, un = function(e) {
        ...
        return o = Tt.fromDom(t),
        i = an(o),
        (nn(i) ? U.some(i) : U.none()).fold(function() {
    ...
    }, Cn = bn, wn = function(e, t) {
        return e !== undefined ? e : t !== undefined ? t : 0
    }, xn = function(e) {
        var t, n = e.dom, r = n.ownerDocument.body;
        return r === n ? Cn(r.offsetLeft, r.offsetTop) : yn(e) ? (t = n.getBoundingClientRect(),
        Cn(t.left, t.top)) : Cn(0, 0)
    }, Sn = function(e) {
        ...
        var t, n, r = e === undefined ? window : e, o = r.document, i = Sn(Tt.fromDom(o));
    ...
    }, Mn = Dn(["textarea", "input"]), Fn = An(3), Un = An(8), zn = An(9), jn = An(11), Hn = Dn(["br"]), Vn = Dn(["img"]), qn = In("true"), $n = In("false"), Wn = Dn(["td", "th"]), Kn = Dn(["video", "audio", "object", "embed"]), Xn = function(e) {
        ...
        if (n = n || e,
        t) {
            if (n === e && t.getBoundingClientRect && "static" === nr(Tt.fromDom(e), "position"))
                return {
            ...
            for (r = t; r && r !== n && r.nodeType && !sr(r, n); )
                a += r.offsetLeft || 0,
                u += r.offsetTop || 0,
                r = r.offsetParent;
            for (r = t.parentNode; r && r !== n && r.nodeType && !sr(r, n); )
                a -= r.scrollLeft || 0,
                u -= r.scrollTop || 0,
                r = r.parentNode;
            u += (i = Tt.fromDom(t),
            ar.isFirefox() && "table" === Mt(i) ? ur(Qt(i)).filter(function(e) {
                return "caption" === Mt(e)
            }).bind(function(o) {
    ...
    var Er, kr, _r, Ar, Rr, Tr, Dr = function(e, t, n) {
        ...
        Bt(o) ? U.none() : U.from(o.querySelector(n)).map(Tt.fromDom);
        var n, r, o
    }, Ir = function(e, t, n) {
        ...
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof t)
                    return void Rr(Er(t, e), Er(Ur, this), Er(zr, this))
            }
            this._state = !0,
            this._value = e,
            jr.call(this)
    ...
    function jr() {
        for (var e = 0, t = this._deferreds.length; e < t; e++)
            Fr.call(this, this._deferreds[e]);
    ...
    var Vr, qr = function(e, t) {
        ...
        var p = 0
          ...
          , b = g.maxLoadTime || 5e3
          , n = function(e, t, n) {
            var r, o = At._addCacheSuffix(e), i = he(h, o).getOrThunk(function() {
                return {
                    id: "mce-u" + p++,
                    passed: [],
                    failed: [],
            ...
            u = Date.now(),
            g.contentCssCors && Gn(a, "crossOrigin", "anonymous"),
            g.referrerPolicy && Gn(a, "referrerpolicy", g.referrerPolicy),
            (r = a.dom).onload = d,
            r.onerror = f,
            s = a,
            mn(un(v), s),
    ...
    var Qr, Zr, eo = function(t) {
    ...
    }, to = eo(["h1", "h2", "h3", "h4", "h5", "h6"]), no = eo(["article", "aside", "details", "div", "dt", "figcaption", "footer", "form", "fieldset", "header", "hgroup", "html", "main", "nav", "section", "summary", "body", "p", "dl", "multicol", "dd", "figure", "address", "center", "blockquote", "h1", "h2", "h3", "h4", "h5", "h6", "listing", "xmp", "pre", "plaintext", "menu", "dir", "ul", "ol", "li", "hr", "table", "tbody", "thead", "tfoot", "th", "tr", "td", "caption"]), ro = function(e) {
        return zt(e) && !no(e)
    }, oo = function(e) {
        return zt(e) && "br" === Mt(e)
    }, io = eo(["h1", "h2", "h3", "h4", "h5", "h6", "p", "div", "address", "pre", "form", "blockquote", "center", "dir", "fieldset", "header", "footer", "article", "section", "hgroup", "aside", "nav", "figure"]), ao = eo(["ul", "ol", "dl"]), uo = eo(["li", "dd", "dt"]), so = eo(["thead", "tbody", "tfoot"]), co = eo(["td", "th"]), lo = eo(["pre", "script", "textarea", "style"]), fo = "\ufeff", mo = "\xa0", go = fo, po = function(e) {
        return e === fo
    }, ho = function(e) {
        return e.replace(/\uFEFF/g, "")
    }, vo = Tn, yo = Fn, bo = function(e) {
        return yo(e) && (e = e.parentNode),
        vo(e) && e.hasAttribute("data-mce-caret")
    }, Co = function(e) {
        ...
        n = t[t.length - 1],
        Pn(n) && n.parentNode.removeChild(n),
        ...
        e) : null;
        var t, n
    }, Ro = qn, To = $n, Do = Hn, Oo = Fn, Bo = Dn(["script", "style", "textarea"]), Po = Dn(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]), Lo = Dn(["table"]), Io = wo, Mo = function(e) {
        ...
        var n, r, o, i = Tt.fromDom(t), a = Tt.fromDom(e);
        return n = a,
        r = "pre,code",
        o = k(Pt, i),
        Pr(n, r, o).isSome()
        ...
        return Mo(e) && !1 === (o = t,
        Fn(r = e) && jo(r.data) && !1 === Ho(r, o)) || Tn(n = e) && "A" === n.nodeName && !n.hasAttribute("href") && (n.hasAttribute("name") || n.hasAttribute("id")) || qo(e);
        var n, r, o
    }, qo = Bn("data-mce-bookmark"), $o = Bn("data-mce-bogus"), Wo = (Qr = "data-mce-bogus",
    Zr = "all",
    function(e) {
        ...
        return Fn(e) && 0 < e.data.length && (o = new Gr(n = e,r = t).prev(!1),
        i = new Gr(n,r).next(!1),
        a = d(o) || Xo(o, r),
        u = d(i) || Xo(i, r),
        a && u);
        ...
        for (var o, i, a, u = t.childNodes, s = u.length - 1; 0 <= s; s--)
            Jo(e, u[s], r);
        return !Tn(t) || 1 === (o = t.childNodes).length && Yo(o[0]) && t.parentNode.insertBefore(o[0], t),
        jn(a = t) || zn(a) || Vo(t, r) || Tn(i = t) && 0 < i.childNodes.length || Go(t, r) || e.remove(t),
        t
    }, Qo = At.makeMap, Zo = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, ei = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, ti = /[<>&\"\']/g, ni = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, ri = {
        128: "\u20ac",
        130: "\u201a",
        131: "\u0192",
        132: "\u201e",
        ...
        decode: function(e) {
            return e.replace(ni, function(e, t) {
                ...
                String.fromCharCode(55296 + (t >> 10), 56320 + (1023 & t))) : ri[t] || String.fromCharCode(t) : ii[e] || ui[e] || (n = e,
                (r = Tt.fromTag("div").dom).innerHTML = n,
                r.textContent || r.innerText || n);
                var n, r
            })
        }
    }, di = {}, mi = {}, gi = At.makeMap, pi = At.each, hi = At.extend, vi = At.explode, yi = At.inArray, bi = function(e, t) {
        ...
        var e, s, t, n, r, o, a, c, u, l, S = {}, f = {}, N = [], d = {}, m = {}, g = function(e, t, n) {
            var r = i[e];
            return r ? r = gi(r, /[, ]/, gi(r.toUpperCase(), /[, ]/)) : (r = di[e]) || (r = gi(t, " ", gi(t.toUpperCase(), " ")),
            r = hi(r, n),
            di[e] = r),
            r
        }, p = (e = (i = i || {}).schema,
        ...
        u = function(e, t, n) {
            ...
            t = t || "",
            "string" == typeof (n = n || []) && (n = bi(n));
            for (var a = bi(e), u = a.length; u--; )
                o = {
        ...
        ,
        di[e] ? di[e] : (s = "id accesskey class dir lang style tabindex title role",
        ...
        u("label", "form for", n),
        u("input", "accept alt autocomplete checked dirname disabled form formaction formenctype formmethod formnovalidate formtarget height list max maxlength min multiple name pattern readonly required size src step type value width"),
        ...
        "html5-strict" !== e && (l("script", "language xml:space"),
        l("style", "xml:space"),
        ...
        var D = function(e) {
          ...
          , O = function(e) {
            var t, n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, y, b = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)])?$/, C = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/, w = /[*?+]/;
            if (e) {
                var x = bi(e, ",");
                        ...
                        s)
                            ...
                            o = (s = bi(s, "|")).length; r < o; r++)
                                if (i = C.exec(s[r])) {
                                    ...
                                    g && ("=" === g && (a.attributesDefault = a.attributesDefault || [],
          ...
          , P = function(e) {
            var a = /^(~)?(.+)$/;
            e && (di.text_block_elements = di.block_elements = null,
            pi(bi(e, ","), function(e) {
                ...
                R[i] = {}),
                S[i] || (t = S[o],
                delete (t = hi({}, t)).removeEmptyAttrs,
        ...
        var s, c, C = this, w = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi, x = /(?:url(?:(?:\(\s*\"([^\"]+)\"\s*\))|(?:\(\s*\'([^\']+)\'\s*\))|(?:\(\s*([^)\s]+)\s*\))))|(?:\'([^\']+)\')|(?:\"([^\"]+)\")/gi, S = /\s*([^:]+):\s*([^;]+);?/g, N = /\s+$/, E = {}, k = fo;
        b = b || {},
        ...
        return {
            ...
            parse: function(e) {
                var t, n, r, o, i, a, u, s, c = {}, l = b.url_converter, f = b.url_converter_scope || C, d = function(e, t, n) {
                    var r = c[e + "-top" + t];
                    if (r) {
                        var o = c[e + "-right" + t];
                        if (o) {
                ...
                if (e) {
                    for (e = (e = e.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, g).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
                        ...
                        n && r) {
                            ...
                            r = (r = r.replace(w, xi)).replace(x, y),
                            c[n] = o ? p(r, !0) : r
                        }
                    d("border", "", !0),
                    d("border", "-width"),
        ...
        e && (a = e,
        Ni.test(a.type)) && e.pageX === undefined && e.clientX !== undefined && (o = (r = s.target.ownerDocument || document).documentElement,
        i = r.body,
        ...
        s.preventDefault = function() {
            ...
            s.isDefaultPrevented = _i,
            e && (e.preventDefault ? e.preventDefault() : e.returnValue = !1)
        }
        ,
        s.stopPropagation = function() {
            s.cancelBubble = !0,
            s.isPropagationStopped = _i,
            e && (e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0)
        }
        ,
        !(s.stopImmediatePropagation = function() {
            s.isImmediatePropagationStopped = _i,
            s.stopPropagation()
        }
        ) == ((u = s).isDefaultPrevented === _i || u.isDefaultPrevented === ki) && (s.isDefaultPrevented = !0 === s.defaultPrevented ? _i : ki,
        s.isPropagationStopped = !0 === s.cancelBubble ? _i : ki,
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
            ...
            for (var m = t.split(" "), g = m.length; g--; )
                s = d,
                u = c = !1,
                "DOMContentLoaded" === (a = m[g]) && (a = "ready"),
                l.domLoaded && "ready" === a && "complete" === e.readyState ? n.call(r, Ti({
                    type: a
                    ...
                    if (n && t.contains)
                        ...
                        for (; n && n !== t; )
                            n = n.parentNode;
                    n || ((e = Ti(e || f.event)).type = "mouseout" === e.type ? "mouseleave" : "mouseenter",
                    e.target = t,
                ...
                s = function(e) {
                    (e = Ti(e || f.event)).type = "focus" === e.type ? "focusin" : "focusout",
                    l.executeHandlers(e, o)
                }
                ),
                ...
                "ready" === a ? function(e, t, n) {
                    ...
                    ,
                    "complete" === o.readyState || "interactive" === o.readyState && o.body ? r() : Ai(e, "DOMContentLoaded", r),
                    n.domLoaded || Ai(e, "load", r))
                }(e, s, l) : Ai(e, u || a, s, c)));
            return e = i = null,
            n
        }
            ...
            e) {
                for (var u, s, c, l, f = e.split(" "), d = f.length; d--; )
                    if (l = i[o = f[d]]) {
                        ...
                        Ri(n, l.fakeName || o, l.nativeHandler, l.capture))
                    }
            } else
                se(i, function(e, t) {
    ...
    var Bi, Pi, Li, Ii, Mi, Fi, Ui, zi, ji, Hi, Vi, qi, $i, Wi, Ki, Xi, Yi, Gi = "sizzle" + -new Date, Ji = window.document, Qi = 0, Zi = 0, ea = Oa(), ta = Oa(), na = Oa(), ra = function(e, t) {
        return e === t && (Hi = !0),
        0
    }, oa = typeof undefined, ia = {}.hasOwnProperty, aa = [], ua = aa.pop, sa = aa.push, ca = aa.push, la = aa.slice, fa = aa.indexOf || function(e) {
        for (var t = 0, n = this.length; t < n; t++)
            if (this[t] === e)
                return t;
        return -1
    }
    , da = "[\\x20\\t\\r\\n\\f]", ma = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ga = "\\[" + da + "*(" + ma + ")(?:" + da + "*([*^$|!~]?=)" + da + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ma + "))|)" + da + "*\\]", pa = ":(" + ma + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ga + ")*)|.*)\\)|)", ha = new RegExp("^" + da + "+|((?:^|[^\\\\])(?:\\\\.)*)" + da + "+$","g"), va = new RegExp("^" + da + "*," + da + "*"), ya = new RegExp("^" + da + "*([>+~]|" + da + ")" + da + "*"), ba = new RegExp("=" + da + "*([^\\]'\"]*?)" + da + "*\\]","g"), Ca = new RegExp(pa), wa = new RegExp("^" + ma + "$"), xa = {
        ID: new RegExp("^#(" + ma + ")"),
        CLASS: new RegExp("^\\.(" + ma + ")"),
        TAG: new RegExp("^(" + ma + "|[*])"),
        ATTR: new RegExp("^" + ga),
    ...
    }, Sa = /^(?:input|select|textarea|button)$/i, Na = /^h\d$/i, Ea = /^[^{]+\{\s*\[native \w/, ka = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, _a = /[+~]/, Aa = /'|\\/g, Ra = new RegExp("\\\\([\\da-f]{1,6}" + da + "?|(" + da + ")|.)","ig"), Ta = function(e, t, n) {
        var r = "0x" + t - 65536;
        return r != r || n ? t : r < 0 ? String.fromCharCode(65536 + r) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
    };
    try {
        ca.apply(aa = la.call(Ji.childNodes), Ji.childNodes),
        aa[Ji.childNodes.length].nodeType
    } catch (zk) {
        ca = {
    ...
    var Da = function(e, t, n, r) {
        ...
        if ((t ? t.ownerDocument || t : Ji) !== qi && Vi(t),
        n = n || [],
        !e || "string" != typeof e)
            return n;
        if (1 !== (u = (t = t || qi).nodeType) && 9 !== u)
            return [];
        if (Wi && !r) {
            if (o = ka.exec(e))
                if (a = o[1]) {
                    if (9 === u) {
                        ...
                        if (i.id === a)
                            return n.push(i),
                            n
                    } else if (t.ownerDocument && (i = t.ownerDocument.getElementById(a)) && Yi(t, i) && i.id === a)
                        return n.push(i),
                        n
                } else {
                    if (o[2])
                        return ca.apply(n, t.getElementsByTagName(e)),
                        n;
                    if ((a = o[3]) && Bi.getElementsByClassName)
                        return ca.apply(n, t.getElementsByClassName(a)),
                        n
                }
            if (Bi.qsa && (!Ki || !Ki.test(e))) {
                ...
                1 === u && "object" !== t.nodeName.toLowerCase()) {
                    for (c = Mi(e),
                    (l = t.getAttribute("id")) ? f = l.replace(Aa, "\\$&") : t.setAttribute("id", f),
                    f = "[id='" + f + "'] ",
                    s = c.length; s--; )
                        c[s] = f + Fa(c[s]);
                    d = _a.test(e) && Ia(t.parentNode) || t,
                    m = c.join(",")
                }
                if (m)
                    try {
                        return ca.apply(n, d.querySelectorAll(m)),
                        n
                    } catch (g) {} finally {
    ...
    function Oa() {
        var n = [];
        function r(e, t) {
            return n.push(e + " ") > Pi.cacheLength && delete r[n.shift()],
            r[e + " "] = t
        }
        return r
    }
    ...
    function Ua(a, e, t) {
        ...
        : function(e, t, n) {
            ...
            if (n) {
                ...
                for (; e = e[u]; )
                    if (1 === e.nodeType || s) {
                        if ((r = (o = e[Gi] || (e[Gi] = {}))[u]) && r[0] === Qi && r[1] === c)
                            return i[2] = r[2];
                        if ((o[u] = i)[2] = a(e, t, n))
                            return !0
                    }
        ...
        Ba(function(e, t, n, r) {
            var o, i, a, u = [], s = [], c = t.length, l = e || function(e, t, n) {
                for (var r = 0, o = t.length; r < o; r++)
                    Da(e, t[r], n);
                return n
            }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : ja(l, u, m, n, r), d = p ? v || (e ? m : c || h) ? [] : t : f;
            if (p && p(f, d, n, r),
            h)
                for (o = ja(d, s),
                h(o, [], n, r),
            ...
            if (e) {
                if (v || m) {
                    ...
                    for (i = d.length; i--; )
                        (a = d[i]) && -1 < (o = v ? fa.call(e, a) : u[i]) && (e[o] = !(t[o] = a))
                }
            } else
                d = ja(d === t ? d.splice(c, d.length) : d),
                v ? v(null, t, d, r) : ca.apply(t, d)
        })
    }
    Bi = Da.support = {},
    Ii = Da.isXML = function(e) {
        var t = e && (e.ownerDocument || e).documentElement;
        return !!t && "HTML" !== t.nodeName
    }
    ,
    Vi = Da.setDocument = function(e) {
        var t, s = e ? e.ownerDocument || e : Ji, n = s.defaultView;
        return s !== qi && 9 === s.nodeType && s.documentElement ? ($i = (qi = s).documentElement,
        Wi = !Ii(s),
        n && n !== function(e) {
            try {
                return e.top
        ...
        Bi.attributes = !0,
        Bi.getElementsByTagName = !0,
        Bi.getElementsByClassName = Ea.test(s.getElementsByClassName),
        Bi.getById = !0,
        Pi.find.ID = function(e, t) {
        ...
        Pi.find.TAG = Bi.getElementsByTagName ? function(e, t) {
            if (typeof t.getElementsByTagName != oa)
        ...
        Xi = [],
        Ki = [],
        Bi.disconnectedMatch = !0,
        Ki = Ki.length && new RegExp(Ki.join("|")),
        Xi = Xi.length && new RegExp(Xi.join("|")),
        t = Ea.test($i.compareDocumentPosition),
        Yi = t || Ea.test($i.contains) ? function(e, t) {
        ...
        : function(e, t) {
            ...
            if (!o || !i)
                return e === s ? -1 : t === s ? 1 : o ? -1 : i ? 1 : ji ? fa.call(ji, e) - fa.call(ji, t) : 0;
            if (o === i)
                return Pa(e, t);
    ...
    Da.matchesSelector = function(e, t) {
        if ((e.ownerDocument || e) !== qi && Vi(e),
        t = t.replace(ba, "='$1']"),
        Bi.matchesSelector && Wi && (!Xi || !Xi.test(t)) && (!Ki || !Ki.test(t)))
            try {
                var n = (void 0).call(e, t);
                if (n || Bi.disconnectedMatch || e.document && 11 !== e.document.nodeType)
                    return n
            } catch (zk) {}
    ...
    Da.contains = function(e, t) {
        return (e.ownerDocument || e) !== qi && Vi(e),
        Yi(e, t)
    }
    ,
    ...
    Da.uniqueSort = function(e) {
        var t, n = [], r = 0, o = 0;
        if (Hi = !Bi.detectDuplicates,
        ji = !Bi.sortStable && e.slice(0),
        e.sort(ra),
        Hi) {
            for (; t = e[o++]; )
                t === e[o] && (r = n.push(o));
    ...
    (Pi = Da.selectors = {
        ...
        preFilter: {
            ATTR: function(e) {
                return e[1] = e[1].replace(Ra, Ta),
                e[3] = (e[3] || e[4] || e[5] || "").replace(Ra, Ta),
                "~=" === e[2] && (e[3] = " " + e[3] + " "),
                e.slice(0, 4)
            },
            CHILD: function(e) {
                return e[1] = e[1].toLowerCase(),
                "nth" === e[1].slice(0, 3) ? (e[3] || Da.error(e[0]),
                e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])),
                e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && Da.error(e[0]),
                e
            },
            PSEUDO: function(e) {
                var t, n = !e[6] && e[2];
                return xa.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && Ca.test(n) && (t = Mi(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                e[2] = n.slice(0, t)),
                e.slice(0, 3))
            }
        },
        filter: {
            ...
            CHILD: function(m, e, t, g, p) {
                ...
                : function(e, t, n) {
                    ...
                    if (l) {
                        ...
                        v && d) {
                            for (u = (r = (o = l[Gi] || (l[Gi] = {}))[m] || [])[0] === Qi && r[1],
                            a = r[0] === Qi && r[2],
                        ...
                        } else if (d && (r = (e[Gi] || (e[Gi] = {}))[m]) && r[0] === Qi)
                            a = r[1];
                        else
                            for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Gi] || (i[Gi] = {}))[m] = [Qi, a]),
                            i !== e)); )
                                ;
            ...
            PSEUDO: function(e, i) {
                ...
                return a[Gi] ? a(i) : 1 < a.length ? (t = [e, e, "", i],
                Pi.setFilters.hasOwnProperty(e.toLowerCase()) ? Ba(function(e, t) {
                    for (var n, r = a(e, i), o = r.length; o--; )
                        e[n = fa.call(e, r[o])] = !(t[n] = r[o])
                }) : function(e) {
                    return a(e, 0, t)
                }
                ) : a
        ...
        pseudos: {
            ...
            lang: Ba(function(n) {
                return wa.test(n || "") || Da.error("unsupported lang: " + n),
                n = n.replace(Ra, Ta).toLowerCase(),
                function(e) {
                    var t;
                    do {
    ...
    Ma.prototype = Pi.filters = Pi.pseudos,
    Pi.setFilters = new Ma,
    Mi = Da.tokenize = function(e, t) {
        ...
        u = [],
        s = Pi.preFilter; a; ) {
            for (i in n && !(r = va.exec(a)) || (r && (a = a.slice(r[0].length) || a),
            u.push(o = [])),
            n = !1,
            (r = ya.exec(a)) && (n = r.shift(),
            o.push({
                value: n,
                type: r[0].replace(ha, " ")
            }),
            a = a.slice(n.length)),
            Pi.filter)
                Pi.filter.hasOwnProperty(i) && (!(r = xa[i].exec(a)) || s[i] && !(r = s[i](r)) || (n = r.shift(),
                o.push({
                    value: n,
                    type: i,
                    matches: r
    ...
    Fi = Da.compile = function(e, t) {
        ...
        if (!a) {
            ...
            r = function(e, t, n, r, o) {
                var i, a, u, s = 0, c = "0", l = e && [], f = [], d = zi, m = e || b && Pi.find.TAG("*", o), g = Qi += null == d ? 1 : Math.random() || .1, p = m.length;
                ...
                y && c !== s) {
                    ...
                    if (e) {
                        if (0 < s)
                            for (; c--; )
                                l[c] || f[c] || (f[c] = ua.call(r));
                        f = ja(f)
                    }
                    ca.apply(r, f),
                    o && !e && 0 < f.length && 1 < s + v.length && Da.uniqueSort(r)
                }
                return o && (Qi = g,
                zi = d),
                l
    ...
    Ui = Da.select = function(e, t, n, r) {
        ...
        1 === l.length) {
            if (2 < (i = l[0] = l[0].slice(0)).length && "ID" === (a = i[0]).type && Bi.getById && 9 === t.nodeType && Wi && Pi.relative[i[1].type]) {
                if (!(t = (Pi.find.ID(a.matches[0].replace(Ra, Ta), t) || [])[0]))
                    return n;
                c && (t = t.parentNode),
                e = e.slice(i.shift().value.length)
            }
            for (o = xa.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o],
            !Pi.relative[u = a.type]); )
        ...
        return (c || Fi(e, l))(r, t, !Wi, n, _a.test(e) && Ia(t.parentNode) || t),
        n
    }
    ,
    Bi.sortStable = Gi.split("").sort(ra).join("") === Gi,
    Bi.detectDuplicates = !!Hi,
    Vi(),
    Bi.sortDetached = !0;
    var Va = document
      ...
      , Ja = function(e, t) {
        var n, r = (t = t || Va).createElement("div"), o = t.createDocumentFragment();
    ...
    uu.fn = uu.prototype = {
        ...
        init: function(e, t) {
            ...
            if (Ga(e)) {
                if (!(n = "<" === (o.selector = e).charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : Wa.exec(e)))
                    return hu(t).find(e);
                if (n[1])
                    for (r = Ja(e, du(t)).firstChild; r; )
                        qa.call(o, r),
                        r = r.nextSibling;
                else {
                    if (!(r = du(t).getElementById(n[2])))
                        return o;
                    if (r.id !== n[2])
                        return o.find(e);
                    o.length = 1,
        ...
        css: function(n, r) {
            ...
            if ("object" == typeof n)
                ...
                n = t(n),
                "number" != typeof r || tu[n] || (r = r.toString() + "px"),
                i.each(function() {
                    var e = this.style;
                    if ((o = au[n]) && o.set)
                        o.set(this, r);
        ...
        toggleClass: function(o, i) {
            ...
            return "string" != typeof o || (-1 !== o.indexOf(" ") ? lu(o.split(" "), function() {
                ...
                var n, r = Za(t, o);
                r !== i && (n = t.className,
                r ? t.className = cu((" " + n + " ").replace(" " + o + " ", " ")) : t.className += n ? " " + o : o)
            })),
            e
        },
        hasClass: function(e) {
    ...
    lu({
        ...
        uu.fn[r] = function(t) {
            ...
            1 < this.length && (Xa[r] || (n = hu.unique(n)),
    ...
    ,
    uu.fn.init.prototype = uu.fn,
    uu.overrideDefaults = function(n) {
    ...
    var hu = uu
      ...
      , Su = function(a, u) {
        void 0 === u && (u = {});
        var n, r, o, i, e, t, s = {}, c = window, l = {}, f = 0, d = Yr.forElement(Tt.fromDom(a), {
            contentCssCors: u.contentCssCors,
            referrerPolicy: u.referrerPolicy
        }), m = [], g = u.schema ? u.schema : wi({}), p = Si({
            url_converter: u.url_converter,
            url_converter_scope: u.url_converter_scope
        }, u.schema), h = u.ownEvents ? new Di : Di.Event, v = g.getBlockElements(), y = hu.overrideDefaults(function() {
            return {
                context: a,
                element: $.getRoot()
            }
            ...
            var r, o, i = C(e);
            return i.length && (o = (r = W[t]) && r.get ? r.get(i, t) : i.attr(t)),
            void 0 === o && (o = n || ""),
            o
        }, x = function(e) {
            var t = b(e);
            ...
            return n ? r.css(t) : ("float" === (t = t.replace(/-(\D)/g, function(e, t) {
                return t.toUpperCase()
            })) && (t = St.browser.isIE() ? "styleFloat" : "cssFloat"),
            ...
            At.is(t, "string") && (t = "*" === (o = t) ? function(e) {
                return 1 === e.nodeType
            }
            : function(e) {
                return A(e, o)
            ...
            if (!t)
                return !1;
            if (At.isArray(t) && (t.length || 0 === t.length))
                return o = [],
                vu(t, function(e, t) {
        ...
        }, I = fi.encodeAllRaw, M = function(e, t) {
            var n = C(e);
            ...
            return D(e, function(e) {
                return At.is(e, "array") && (t = t.cloneNode(!0)),
            ...
            if (Tn(e)) {
                ...
                if (w(e, "name") || w(e, "data-mce-bookmark") || t)
                    return !0
            }
            return !1
        }, j = function() {
            ...
            return !u.collect || e !== a && e !== c || m.push([e, t, n, r]),
            h.bind(e, t, n, r || $)
        }, V = function(e, t, n) {
            if (At.isArray(e)) {
            ...
            rename: function(t, e) {
                var n;
                return t.nodeName !== e.toUpperCase() && (n = L(e),
                vu(x(t), function(e) {
                    S(n, e.nodeName, w(t, e.nodeName))
                }),
                U(n, t, !0)),
            ...
            isEmpty: function(e, t) {
                ...
                if (e = e.firstChild) {
                    ...
                    do {
                        ...
                        if (8 === n)
                            return !1;
                        if (3 === n && !jo(e.nodeValue))
                            return !1;
                        if (3 === n && e.parentNode && a[e.parentNode.nodeName] && jo(e.nodeValue))
                            return !1;
                        e = i.next()
                    } while (e)
                }
            ...
            split: function(e, t, n) {
                var r, o, i, a = j();
                if (e && t)
                    return a.setStart(e.parentNode, xu(e)),
                    a.setEnd(t.parentNode, xu(t)),
                    r = a.extractContents(),
                    (a = j()).setStart(t.parentNode, xu(t) + 1),
                    a.setEnd(e.parentNode, xu(e) + 1),
                    o = a.extractContents(),
    ...
    Au.prototype.loadScript = function(e, t, n) {
        ...
        a.onerror = function() {
            o(),
            m(n) ? n() : "undefined" != typeof console && console.log && console.log("Failed to load script: " + e)
        }
        ,
    ...
    var Ru = function(e) {
      ...
      , Bu = {
        ...
        translate: function(e) {
            var t, n, r = Ou().getOr({}), o = function(e) {
      ...
      , Pu = function() {
        var o = []
          ...
          , d = function(o, i, a, u, e) {
            var t, n;
            r[o] || (0 !== (t = "string" == typeof i ? i : i.prefix + i.resource + i.suffix).indexOf("/") && -1 === t.indexOf("://") && (t = Pu.baseURL + "/" + t),
          ...
          , e = function(e, t, n) {
            void 0 === n && (n = "added"),
            ve(s, e) && "added" === n || ve(r, e) && "loaded" === n ? t() : i.push({
                name: e,
                state: n,
                callback: t
            })
    ...
    var Lu = function(n, r) {
      ...
      , zu = function(e, t) {
        return o = t,
        0 < (i = H(Mu(n = e, r = "class"), function(e) {
            return e !== o
        })).length ? Gn(n, r, i.join(" ")) : er(n, r),
        !1;
        var n, r, o, i
    }
      , ju = function(e, t) {
      ...
      , $u = function(e, t) {
        return n = t,
        o = (r = e) === undefined ? document : r.dom,
        Bt(o) ? [] : z(o.querySelectorAll(n), Tt.fromDom);
        var n, r, o
    }
      , Wu = E("mce-annotation")
      ...
      , Yu = function(r, e) {
        var t = r.selection.getRng()
          ...
          , s = function(e, t) {
            return n = t,
            (r = e.dom) && r.hasAttribute && r.hasAttribute(n) ? U.some(Qn(e, t)) : U.none();
            var n, r
        };
        ...
        e.on("init", function() {
            e.serializer.addNodeFilter("span", function(e) {
                Y(e, function(t) {
                    var e;
                    e = t,
                    U.from(e.attr(Ku())).bind(n.lookup).each(function(e) {
      ...
      , ts = function(e, t) {
        var n, r, o = qt(e).dom, i = Tt.fromDom(o.createDocumentFragment()), a = (n = t,
      ...
      , Os = function(e) {
        ...
        return !!(Ts(e.toString()) && Ns(n.parentNode) && Fn(n) && (t = n.data,
        Ts(t[r - 1]) || Ts(t[r + 1])))
    }
      , Bs = function(e) {
      ...
      , Is = function(e) {
        var t, n, r = [], o = function(e) {
            ...
            if (t < e.data.length) {
                if (ys(e.data[t]))
                    return r;
                if (ys(e.data[t - 1]) && (n.setStart(e, t),
                n.setEnd(e, t + 1),
                !Os(n)))
                    return o(Ls(Ps(n), !1)),
                    r
        ...
        if (bs(e.container()))
            if (e.isAtEnd())
                n = As(e.container(), e.offset()),
                Es(n) && i(n, n.data.length),
                Ss(n) && !ks(n) && o(Ls(Ps(n), !1));
            else {
                if (n = As(e.container(), e.offset()),
                Es(n) && i(n, 0),
                Ss(n) && e.isAtEnd())
                    return o(Ls(Ps(n), !1)),
                    r;
                t = As(e.container(), e.offset() - 1),
                Ss(t) && !ks(t) && (!ws(t) && !ws(n) && Ss(n) || o(Ls(Ps(t), !1))),
                Ss(n) && o(Ls(Ps(n), !0))
            }
        return r
    }
    ...
    var Fs, Us, zs = function(e, t) {
        ...
        o = n,
        t.insertNode(o),
        zs(r, o.previousSibling),
        zs(r, o.nextSibling))
    }, Hs = Fn, Vs = Pn, qs = Su.nodeIndex, $s = function(e) {
        var t = e.parentNode;
        return Vs(t) ? $s(t) : t
    }, Ws = function(e) {
        return e ? Ne(e.childNodes, function(e, t) {
            return Vs(t) && "BR" !== t.nodeName ? e = e.concat(Ws(t)) : e.push(t),
            e
        }, []) : []
    }, Ks = function(t) {
        return function(e) {
        ...
        return t + "[" + function(e) {
            ...
            var n = Ne(r, function(e, t, n) {
                return Hs(t) && Hs(r[n - 1]) && e++,
                e
            }, 0);
            return r = xe(r, Dn([e.nodeName])),
            (t = Ee(r, Ks(e), e)) - n
        }(e) + "]"
    }, Ys = function(e, t) {
        var n, r, o, i = [], a = t.container(), u = t.offset();
        return Hs(a) ? n = function(e, t) {
            for (; (e = e.previousSibling) && Hs(e); )
                t += e.data.length;
            return t
        ...
        o = xe(o, y(Pn)),
        (i = i.concat(we(o, Xs))).reverse().join("/") + "," + n
    }, Gs = function(e, t) {
        if (!t)
            return null;
        var n = t.split(",")
        ...
        return i ? Hs(i) ? function(e, t) {
            ...
            return Hs(e) && t > e.data.length && (t = e.data.length),
            Ms(e, t)
        }(i, parseInt(o, 10)) : (o = "after" === o ? qs(i) + 1 : qs(i),
        Ms(i.parentNode, o)) : null
    }, Js = $n, Qs = function(e, t, n, r, o) {
        var i, a = r[o ? "startContainer" : "endContainer"], u = r[o ? "startOffset" : "endOffset"], s = [], c = 0, l = e.getRoot();
        for (Fn(a) ? s.push(n ? function(e, t, n) {
            for (var r = e(t.data.slice(0, n)).length, o = t.previousSibling; o && Fn(o); o = o.previousSibling)
                r += e(o.data).length;
            return r
        ...
        Tn(o) && "TR" === o.nodeName && (o = (n = o.childNodes)[Math.min(t ? i : i - 1, n.length - 1)]) && (i = t ? 0 : o.childNodes.length,
        ...
        l = i,
        f = (s = n).dom,
        (d = {}).start = Qs(f, u, c, l, !0),
        s.isCollapsed() || (d.end = Qs(f, u, c, l, !1)),
        d)
    }, oc = function(e, t, n) {
        var r = {
        ...
        var r, o
    }, uc = k(rc, g, !0), sc = Su.DOM, cc = function(e, t, n) {
        ...
        for (var t; -1 !== (t = e.data.lastIndexOf(go)); )
            e.deleteData(t, 1)
    }, Rc = function(e, t) {
        return Bc(e),
        t
    }, Tc = function(e, t) {
        var n, r, o = t.container(), i = (n = ie(o.childNodes),
        ...
        return Ec(e) && t.container() === e ? (r = t,
        o = _c((n = e).data.substr(0, r.offset())),
        i = _c(n.data.substr(r.offset())),
        0 < (o.text + i.text).length ? (Ac(n),
        Ms(n, r.offset() - o.count)) : r) : Rc(e, t);
        var n, r, o, i
    }, Oc = function(e, t) {
        return Ms.isTextPosition(t) ? Dc(e, t) : (n = e,
        ((r = t).container() === n.parentNode ? Tc : Rc)(n, r));
        var n, r
    }, Bc = function(e) {
        Nc(e) && wo(e) && (xo(e) ? e.removeAttribute("data-mce-caret") : kc(e)),
        Ec(e) && (Ac(e),
        0 === e.data.length && kc(e))
    }, Pc = gt().browser, Lc = $n, Ic = Kn, Mc = Wn, Fc = function(e, t, n) {
        var r, o, i, a, u = ls(t.getBoundingClientRect(), n), s = "BODY" === e.tagName ? (r = e.ownerDocument.documentElement,
        ...
        var n, u, s = Ru(U.none()), r = fc(e), c = 0 < r.length ? r : "p", l = function() {
            !function(e) {
                for (var t = $u(Tt.fromDom(e), "*[contentEditable=false],video,audio,embed,object"), n = 0; n < t.length; n++) {
                    ...
                    _o(i) && (1 === (r = i.data).length ? i.parentNode.removeChild(i) : i.deleteData(r.length - 1, 1)),
                    i = o.nextSibling,
                    ko(i) && (1 === (r = i.data).length ? i.parentNode.removeChild(i) : i.deleteData(0, 1))
                }
            }(i),
            u && (Bc(u),
            u = null),
            ...
            show: function(t, e) {
                ...
                if (!a(e))
                    return u = function(e, t) {
                        var n, r = e.ownerDocument.createTextNode(go), o = e.parentNode;
                        if (t) {
                    ...
                    jc(u.nextSibling) ? (r.setStart(u, 0),
        ...
        return jc(e) || Ln(e) && zc()
    }, Vc = $n, qc = Kn, $c = On("display", "block table table-cell table-caption list-item"), Wc = wo, Kc = bo, Xc = Tn, Yc = Mo, Gc = function(e, t) {
        for (var n; n = e(t); )
            if (!Kc(n))
                return n;
        return null
        ...
        return null
    }, rl = k(tl, !0), ol = k(tl, !1), il = function(e, t, n) {
        var r, o, i = k(nl, !0, t), a = k(nl, !1, t), u = n.startContainer, s = n.startOffset;
        if (bo(u)) {
            if (Xc(u) || (u = u.parentNode),
        ...
        if (Fn(u)) {
            ...
            if (_o(u) && s >= u.data.length - 1)
                return 1 === e && (r = a(u)) ? rl(r) : n;
            if (ko(u) && s <= 1)
                return -1 === e && (r = i(u)) ? ol(r) : n;
            if (s === u.data.length)
                return (r = a(u)) ? rl(r) : n;
            if (0 === s)
                return (r = i(u)) ? ol(r) : n
    ...
    (Us = Fs = Fs || {})[Us.Backwards = -1] = "Backwards",
    Us[Us.Forwards = 1] = "Forwards";
    var fl, dl, ml, gl, pl = $n, hl = Fn, vl = Tn, yl = Hn, bl = Mo, Cl = function(e) {
        return Po(e) || !!Fo(t = e) && !0 !== $(ie(t.getElementsByTagName("*")), function(e, t) {
            return e || Ro(t)
        }, !1);
        var t
    }, wl = Uo, xl = function(e, t) {
        return e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null
    }, Sl = function(e, t) {
        if (0 < e) {
            if (bl(t.previousSibling) && !hl(t.previousSibling))
                return Ms.before(t);
            if (hl(t))
                return Ms(t, 0)
        }
        if (e < 0) {
            if (bl(t.nextSibling) && !hl(t.nextSibling))
                return Ms.after(t);
            if (hl(t))
        ...
        if (t.isEqual(Ms.after(n)) && n.lastChild) {
            if (a = Ms.after(n.lastChild),
            e < 0 && bl(n.lastChild) && vl(n.lastChild))
                return yl(n.lastChild) ? Ms.before(n.lastChild) : a
        } else
            a = t;
        ...
        if (hl(l)) {
            ...
            if (e < 0 && 0 < f && (o = xl(l, f - 1),
            bl(o)))
                return !Cl(o) && (i = Jc(o, e, wl, o)) ? hl(i) ? Ms(i, i.data.length) : Ms.after(i) : hl(o) ? Ms(o, o.data.length) : Ms.before(o);
            if (0 < e && f < l.childNodes.length && (o = xl(l, f),
            bl(o)))
                return yl(o) ? (u = n,
                (c = (s = o).nextSibling) && bl(c) ? hl(c) ? Ms(c, 0) : Ms.before(c) : Nl(Fs.Forwards, Ms.after(s), u)) : !Cl(o) && (i = Jc(o, e, wl, o)) ? hl(i) ? Ms(i, 0) : Ms.before(i) : hl(o) ? Ms(o, 0) : Ms.after(o);
            r = o || a.getNode()
        }
        if ((0 < e && a.isAtEnd() || e < 0 && a.isAtStart()) && (r = Jc(r, e, R, n, !0),
        wl(r, n)))
            return Sl(e, r);
        o = Jc(r, e, wl, n);
        ...
        return e ? !Al(t, n) && (r = t,
        !(!Ms.isTextPosition(r) && Hn(r.getNode()))) && _l(t) && kl(n) : !Al(n, t) && kl(t) && _l(n);
        var r
    }, Tl = function(e, t, n) {
        var r = El(t);
        ...
        return Fn(u) ? U.some(Ms(u, e ? 0 : u.data.length)) : u ? Mo(u) ? U.some(e ? Ms.before(u) : Hn(a = u) ? Ms.before(a) : Ms.after(a)) : (r = t,
        o = u,
        i = (n = e) ? Ms.before(o) : Ms.after(o),
        Tl(n, r, i)) : U.none()
    }, Pl = k(Tl, !0), Ll = k(Tl, !1), Il = k(Bl, !0), Ml = k(Bl, !1), Fl = "_mce_caret", Ul = function(e) {
        return Tn(e) && e.id === Fl
    }, zl = function(e, t) {
        for (; t && t !== e; ) {
            if (t.id === Fl)
        ...
        return Tn(t) && e.isBlock(t) && !t.innerHTML && !St.ie && (t.innerHTML = '<br data-mce-bogus="1" />'),
        t
    }, Hl = function(e, t, n) {
        return !(!1 !== t.hasChildNodes() || !zl(e, t)) && (o = n,
        i = (r = t).ownerDocument.createTextNode(go),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        !0);
        ...
        if (c) {
            ...
            1) : ql(c.nextSibling) ? (r = c.nextSibling,
            0) : ql(c.previousSibling) ? (r = c.previousSibling,
            c.previousSibling.data.length) : (r = c.parentNode,
            e.nodeIndex(c) + 1) : e.nodeIndex(c) : l ? c.hasChildNodes() ? (r = c.firstChild,
            1) : ql(c.previousSibling) ? (r = c.previousSibling,
            c.previousSibling.data.length) : (r = c.parentNode,
            ...
            !l) {
                ...
                i = c.nextSibling,
                At.each(At.grep(c.childNodes), function(e) {
                    Fn(e) && (e.nodeValue = e.nodeValue.replace(/\uFEFF/g, ""))
                }); c = e.get(n.id + "_" + t); )
                    e.remove(c, !0);
                a && i && a.nodeType === i.nodeType && Fn(a) && !St.opera && (o = a.nodeValue.length,
        ...
        if (t) {
            ...
            At.isArray(p.start))
                return m = t,
                g = (d = h).createRng(),
                Vl(d, !0, m, g) && Vl(d, !1, m, g) ? U.some(g) : U.none();
            if (K(t.start))
                return U.some((c = t,
                l = (s = h).createRng(),
                f = Gs(s.getRoot(), c.start),
                l.setStart(f.container(), f.offset()),
                f = Gs(s.getRoot(), c.end),
                l.setEnd(f.container(), f.offset()),
                l));
            if (t.hasOwnProperty("id"))
                return a = $l(o = h, "start", i = t),
                u = $l(o, "end", i),
                us(a, u.or(a), function(e, t) {
                    var n = o.createRng();
                    return n.setStart(jl(o, e.container()), e.offset()),
                    n.setEnd(jl(o, t.container()), t.offset()),
                    n
                });
    ...
    function(e) {
        ...
        if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType)
            ...
            r = new Gr(s,e.getParent(s, e.isBlock))) : (s = i[i.length - 1],
            (r = new Gr(s,e.getParent(s, e.isBlock))).next(!0)),
            o = r.current(); o; o = r.next())
                if (3 === o.nodeType && !of(o))
        ...
        if (e) {
            ...
            for (e = n ? e : e[r]; e; e = e[r])
                if (1 === e.nodeType || !of(e))
                    return e
        }
    }, nf = function(e, t) {
        return Zl(t) && (t = t.nodeName),
    ...
    }, vf = Yl, yf = ff, bf = of, Cf = nf, wf = function(e, t) {
        for (var n = t; n; ) {
            if (Tn(n) && e.getContentEditable(n))
        ...
        i = a.getParent(Fn(n) ? n.parentNode : n, function(e) {
            return e !== u && Cf(t, e)
        }, o)),
        i && e[0].wrapper && (i = yf(a, i, "ul,ol").reverse()[0] || i),
        !i)
        ...
        if (Fn(n) && !bf(n) && (o ? 0 < r : r < n.data.length))
            return n;
        for (; ; ) {
            ...
            for (i = u[s]; i; i = i[s]) {
                ...
                if (!vf(i) && (!Hn(a = i) || !a.getAttribute("data-mce-bogus") || a.nextSibling) && !bf(i, l))
                    return u
            }
        ...
        var o = t.startContainer
          ...
          , u = t.endOffset
          , s = e.dom;
        return Tn(o) && o.hasChildNodes() && (o = hs(o, i),
        Fn(o) && (i = 0)),
        Tn(a) && a.hasChildNodes() && (a = hs(a, t.collapsed ? u : u - 1),
        Fn(a) && (u = a.nodeValue.length)),
        o = wf(s, o),
        a = wf(s, a),
        Tf(o) && (o = vf(o) ? o : o.parentNode,
        o = t.collapsed ? o.previousSibling || o : o.nextSibling || o,
        Fn(o) && (i = t.collapsed ? o.length : 0)),
        Tf(a) && (a = vf(a) ? a : a.parentNode,
        a = t.collapsed ? a.nextSibling || a : a.previousSibling || a,
        Fn(a) && (u = t.collapsed ? 0 : a.length)),
        t.collapsed && (Ef(s, e.getBody(), o, i, !0, r).each(function(e) {
            var t = e.container
              , n = e.offset;
            o = t,
            i = n
        ...
        (n[0].inline || n[0].block_expand) && (n[0].inline && Fn(o) && 0 !== i || (o = Rf(s, n, o, i, !0)),
        n[0].inline && Fn(a) && u !== a.nodeValue.length || (a = Rf(s, n, a, u, !1))),
        n[0].selector && !1 !== n[0].expand && !n[0].inline && (o = kf(s, n, t, o, "previousSibling"),
        a = kf(s, n, t, a, "nextSibling")),
        (n[0].block || n[0].selector) && (o = _f(e, n, o, "previousSibling"),
        a = _f(e, n, a, "nextSibling"),
        n[0].block && (s.isBlock(o) || (o = Rf(s, n, o, i, !0)),
        s.isBlock(a) || (a = Rf(s, n, a, u, !1)))),
        Tn(o) && (i = s.nodeIndex(o),
        o = o.parentNode),
        Tn(a) && (u = s.nodeIndex(a) + 1,
        a = a.parentNode),
        {
            startContainer: o,
            startOffset: i,
        ...
        if (1 === n.nodeType && n.hasChildNodes() && (n = Of(n, r)),
        1 === o.nodeType && o.hasChildNodes() && (o = Of(o, i - 1)),
        n === o)
            return u(s([n]));
        ...
        return us((a = (i = e).startContainer,
        u = i.startOffset,
        Fn(a) ? 0 === u ? U.some(Tt.fromDom(a)) : U.none() : U.from(a.childNodes[u]).map(Tt.fromDom)), (n = (t = e).endContainer,
        r = t.endOffset,
        Fn(n) ? r === n.data.length ? U.some(Tt.fromDom(n)) : U.none() : U.from(n.childNodes[r - 1]).map(Tt.fromDom)), function(e, t) {
            var n = W(Ff(o), k(Pt, e))
              , r = W(Uf(o), k(Pt, t));
        ...
        do {
            if (Fn(n) && 0 !== At.trim(n.nodeValue).length)
    ...
    ml = "text",
    {
        get: function(e) {
            if (!dl(e))
                throw new Error("Can only get " + ml + " value of a " + ml + " node");
            return gl(e).getOr("")
        },
        ...
        set: function(e, t) {
            if (!dl(e))
                throw new Error("Can only set raw " + ml + " value of a " + ml + " node");
            e.dom.nodeValue = t
        }
    }), Wf = function(e) {
        return $f.get(e)
        ...
        u.undoManager.transact(function() {
            var e, t, n, r, o = u.selection, i = o.getRng(), a = 0 < Mf(u).length;
            ...
            o.getRng().collapsed && !a ? (r = Xf(u.getDoc(), l, s, c.decorate),
            ts(r, mo),
            o.getRng().insertNode(r.dom),
            o.select(r.dom)) : qf(o, !1, function() {
                Vf(u, function(e) {
    ...
    var Zf = function(e, t) {
      ...
      , rd = $n
      , od = function(r, l) {
        var f, d, m, g, c, p, h, v, y, b, C, w, x, S, N, E = "data-mce-selected", k = l.dom, _ = At.each, A = l.getDoc(), R = document, T = Math.abs, D = Math.round, O = l.getBody(), B = {
            nw: [0, 0, -1, -1],
            ne: [1, 0, 1, -1],
            se: [1, 1, 1, 1],
            sw: [0, 1, -1, 1]
            ...
            !function(e, t) {
                if ("longpress" !== e.type && 0 !== e.type.indexOf("touch"))
                    return P(e.target) && !ed(e.clientX, e.clientY, t);
                var n = e.touches[0];
            ...
            var t, n, r, o, i, a, u, s = e.screenX - p, c = e.screenY - h;
            w = s * g[2] + v,
            x = c * g[3] + y,
            w = w < 5 ? 5 : w,
            x = x < 5 ? 5 : x,
            ((P(f) || L(f)) && !1 !== l.getParam("resize_img_proportional", !0, "boolean") ? !nd.modifierPressed(e) : nd.modifierPressed(e)) && (T(s) > T(c) ? (x = D(w * b),
            w = D(x / b)) : (w = D(x / b),
            x = D(w * b))),
            F(d, w, x),
            t = 0 < (t = g.startPos.x + s) ? t : 0,
            n = 0 < (n = g.startPos.y + c) ? n : 0,
            k.setStyles(m, {
                left: t,
                top: n,
                display: "block"
            ...
            g[2] < 0 && d.clientWidth <= w && k.setStyle(d, "left", void 0 + (v - w)),
            g[3] < 0 && d.clientHeight <= x && k.setStyle(d, "top", void 0 + (y - x)),
            (s = O.scrollWidth - S) + (c = O.scrollHeight - N) !== 0 && k.setStyles(m, {
                left: t - s,
                top: n - c
            }),
            C || (r = l,
            ...
            R !== A && (k.unbind(R, "mousemove", U),
            k.unbind(R, "mouseup", z)),
            k.remove(d),
            k.remove(m),
            k.remove(c),
            u(f),
            ...
            n(t = k.$(t).closest("table,img,figure.image,hr,video,span.mce-preview-object")[0], O) && (s(),
            n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? u(t) : j())
        }, i = function(e) {
            return rd(Zf(l.getBody(), e))
        }, H = function() {
            se(B, function(e) {
                e.elm && (k.unbind(e.elm),
                delete e.elm)
            })
        }, s = function() {
            try {
        ...
        l.on("init", function() {
            var e;
            s(),
            (St.browser.isIE() || St.browser.isEdge()) && (l.on("mousedown click", function(e) {
                var t = e.target
                  , n = t.nodeName;
        ...
        if (s.caretPositionFromPoint)
            ...
            try {
                ...
                r = function(e, n, t) {
                    ...
                    0 < (r = (r = At.toArray(i.getClientRects())).sort(function(e, t) {
      ...
      , fd = function(e, t, n, r, o) {
        ...
        if (r && Hn(o) && t && e.isEmpty(c))
            return U.some(Ms(o.parentNode, e.nodeIndex(o)));
        for (var l, f, d = new Gr(o,c); a = d[r ? "prev" : "next"](); ) {
            if ("false" === e.getContentEditableParent(a) || (f = u,
            wo(l = a) && !1 === sd(l, f, Ul)))
                return U.none();
            if (Fn(a) && 0 < a.nodeValue.length)
      ...
      , dd = function(e, t, n, r) {
        var o, i, a, u, s = e.getRoot(), c = !1, l = r[(n ? "start" : "end") + "Container"], f = r[(n ? "start" : "end") + "Offset"], d = Tn(l) && f === l.childNodes.length, m = e.schema.getNonEmptyElements(), g = n;
        if (wo(l))
            return U.none();
        if (Tn(l) && f > l.childNodes.length - 1 && (g = !1),
        zn(l) && (l = s,
        f = 0),
        l === s) {
            if (g && (o = l.childNodes[0 < f ? f - 1 : 0])) {
                if (wo(o))
                    return U.none();
                if (m[o.nodeName] || cd(o))
                    return U.none()
            }
            if (l.hasChildNodes()) {
                if (f = Math.min(!g && 0 < f ? f - 1 : f, l.childNodes.length - 1),
                l = l.childNodes[f],
                f = Fn(l) && d ? l.data.length : 0,
                !t && l === s.lastChild && cd(l))
                    return U.none();
                if (function(e, t) {
                    for (; t && t !== e; ) {
                        if ($n(t))
        ...
        Tn(l) && (!(o = (o = l.childNodes[f]) || l.childNodes[f - 1]) || !Hn(o) || (u = "A",
        (a = o).previousSibling && a.previousSibling.nodeName === u) || ld(e, o, !1) || ld(e, o, !0) || fd(e, d, t, !0, o).each(function(e) {
            l = e.container(),
            f = e.offset(),
            c = !0
        }))),
      ...
      , pd = function(e) {
        var t = e.startContainer
          ...
          , r = e.endContainer
          , o = e.endOffset;
        return t === r && Fn(t) ? 0 < n && n < t.nodeValue.length && (t = (r = gd(t, n)).previousSibling,
        n < o ? (t = r = gd(r, o -= n).previousSibling,
        o = r.nodeValue.length,
        n = 0) : o = 0) : (Fn(t) && 0 < n && n < t.nodeValue.length && (t = gd(t, n),
        n = 0),
        Fn(r) && 0 < o && o < r.nodeValue.length && (o = (r = gd(r, o).previousSibling).nodeValue.length)),
        {
            startContainer: t,
            startOffset: n,
            endContainer: r,
    ...
    hd.compareRanges = ud,
    hd.getCaretRangeFromPoint = ad,
    hd.getSelectedNode = ps,
    hd.getNode = hs;
    var vd, yd, bd, Cd, wd, xd = (vd = "height",
    yd = function(e) {
        var t = e.dom;
    ...
    ,
    {
        set: function(e, t) {
            if (!N(t) && !t.match(/^[0-9]+$/))
                throw new Error(vd + ".set accepts only positive integer values. Value was " + t);
            var n = e.dom;
    ...
    Object.freeze({
        ...
        var t, n, r, o = Tt.fromDom(document), i = Sn(o), a = (t = e,
        r = (n = Nd).owner(t),
        Sd(n, r)), u = xn(e), s = q(a, function(e, t) {
            var n = xn(t);
            return {
                left: e.left + n.left,
                top: e.top + n.top
        ...
        var n, r = function(e) {
            var t = e.dom.ownerDocument
              ...
              , o = t.documentElement;
            if (n === e.dom)
                return Cn(n.offsetLeft, n.offsetTop);
        ...
        i = u,
        e.fire("ScrollIntoView", i).isDefaultPrevented() || (n(t, Sn(t).top, r, o),
        a = u,
        ...
        var o, i = e.pos;
        n ? Nn(i.left, i.top, r) : (o = i.top - t + e.height,
        Nn(i.left, o, r))
        ...
        return void 0 === e && (e = Tt.fromDom(document)),
        U.from(e.dom.activeElement).map(Tt.fromDom)
    }, $d = function(e, t, n, r) {
        return {
            start: e,
            soffset: t,
    ...
    function(e) {
        ...
        var t, n, r = Wt(e);
        return t = r.dom,
        ((n = t.getSelection()) && 0 !== n.rangeCount ? U.from(n.getRangeAt(0)) : U.none()).map(nm).filter(em(e))
    }, om = function(e) {
        ...
        return (r.bookmark ? r.bookmark : U.none()).bind(function(e) {
            return t = Tt.fromDom(r.getBody()),
            n = e,
            U.from(n).filter(em(t)).map(Qd);
            var t, n
        }).bind(om)
    }, um = {
        ...
        r.on("init", function() {
            ...
            ,
            Su.DOM.bind(document, "mouseup", n),
        ...
        e.activeEditor || (lm.unbind(document, "focusin", wd),
        wd = null)
    }, gm = function(t, e) {
        ...
        return qd(e).filter(function(e) {
            return t = e.dom,
            !((n = t.classList) !== undefined && (n.contains("tox-edit-area") || n.contains("tox-edit-area__iframe") || n.contains("mce-content-body"))) && fm(r, e.dom);
            var t, n
        }).isSome()
    }, bm = function(e) {
        ...
        t.bookmark !== undefined && !1 === bm(t) && am(t).each(function(e) {
        ...
        if (t.$.contains(n, a))
            ...
            pm(t, r),
            void wm(t);
        t.inline || (St.opera || hm(n),
        t.getWin().focus()),
        (St.gecko || t.inline) && (hm(n),
        pm(t, r)),
        wm(t)
    }, wm = function(e) {
    ...
    Dm.prototype.attr = function(e, t) {
        var n, r = this;
        if ("string" != typeof e)
            return e !== undefined && null !== e && se(e, function(e, t) {
                r.attr(t, e)
            }),
            r;
        if (n = r.attributes) {
    ...
    Dm.prototype.getAll = function(e) {
        for (var t = [], n = this.firstChild; n; n = Am(n, this))
            n.name === e && t.push(n);
        return t
    }
    ,
    Dm.prototype.empty = function() {
        if (this.firstChild) {
            for (var e = [], t = this.firstChild; t; t = Am(t, this))
                e.push(t);
            for (var n = e.length; n--; )
        ...
        if (r)
            do {
                ...
                if (3 === r.type && !function(e) {
                    ...
                    return !1;
                if (3 === r.type && r.parent && t[r.parent.name] && jo(r.value))
                    return !1;
                if (n && n(r))
                    return !1
            } while (r = Am(r, this));
    ...
    var Om = function(e, t) {
      ...
      , Pm = function(e, t, n) {
        ...
        o = n,
        !(X(r) ? M(Bm, o) : r) && /^data:image\/svg\+xml/i.test(t)) : /^data:/i.test(t));
        var r, o
    }
      , Lm = function(e, t, n) {
            ...
            for (var t, i, n, d, r, o, a, m, u, s, c, l, g, p, h, v, y, b, C, w = f.html, x = 0, S = [], N = 0, E = fi.decode, k = At.makeMap("src,href,data,background,action,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, A = "html" === e ? 0 : 1, R = function(e) {
                ...
                i = t[7])
                    ...
                    if (!U || (s = K.getElementRule(i))) {
                        ...
                        (g = t[9]) ? ((m = -1 !== g.indexOf("data-mce-type")) && z && (c = !1),
                        (d = []).map = {},
                        g.replace(L, function(e, t, n, r, o) {
                            return B(i, t, n, r, o),
                            ""
                        })) : (d = []).map = {},
                        U && !m) {
    ...
    var Mm = function(e, t) {
      ...
      , Um = function(e, t, n, r) {
        ...
        o = "raw" === t.format ? At.trim(Fm(e.serializer, r.innerHTML)) : "text" === t.format ? e.dom.isEmpty(r) ? "" : ho(r.innerText || r.textContent) : "tree" === t.format ? e.serializer.serialize(r, t) : (a = (i = e).serializer.serialize(r, t),
        u = fc(i),
        s = new RegExp("^(<" + u + "[^>]*>(&nbsp;|&#160;|\\s|\xa0|<br \\/>|)<\\/" + u + ">[\r\n]*|<br \\/>[\r\n]*)$"),
        a.replace(s, "")),
        M(["text", "tree"], t.format) || lo(Tt.fromDom(r)) ? t.content = o : t.content = At.trim(o),
    ...
    var Wm, Km, Xm = ["font", "text-decoration", "text-emphasis"], Ym = function(e, t) {
    ...
    }, Zm = k(Qm, !0, Jl), eg = k(Qm, !1, Jl), tg = function(e) {
        var t = e.container();
        ...
        var t
    }, ig = ng(!0, rg), ag = ng(!1, rg), ug = ng(!0, Kn), sg = ng(!1, Kn), cg = ng(!0, Ln), lg = ng(!1, Ln), fg = ng(!0, og), dg = ng(!1, og), mg = function(e) {
        var t = $u(e, "br")
          , n = H(function(e) {
            for (var t = [], n = e.dom; n; )
                t.push(Tt.fromDom(n)),
        ...
        pn(e),
        mn(e, Tt.fromHtml('<br data-mce-bogus="1">'))
    }, pg = function(n) {
    ...
    }, Sg = k(xg, !1), Ng = k(xg, !0), Eg = k(wg, !1), kg = k(wg, !0), _g = function(e) {
        ...
        return n = t,
        U.from(n.getNode(!0)).map(Tt.fromDom).exists(oo) || Ag(!1, e, t).isSome();
        var n
    }, Dg = k(Ag, !1), Og = k(Ag, !0), Bg = function(e) {
        ...
        return sl(e).bind(function(e) {
            ...
            return t = nr(e, "white-space"),
            M(["pre", "pre-wrap"], t);
            var t
        })
    }, Fg = function(e, t) {
        return r = t,
        Ll(e.dom, r).isNone() || (n = t,
        Pl(e.dom, n).isNone()) || Sg(e, t) || Ng(e, t) || Tg(e, t) || Rg(e, t);
        var n, r
    }, Ug = function(e, t) {
        ...
        return Ug(e, t) || zg(e, (r = (n = t).container(),
        o = n.offset(),
        Fn(r) && o < r.data.length ? Ms(r, o + 1) : n));
        var n, r, o
    }, Hg = function(e, t) {
        ...
        return U.some(e).filter(Vg).bind(function(e) {
            ...
            u = (a = c).data,
            s = Ms(a, 0),
            !(!Hg(u, 0) || jg(i, s) || (a.data = " " + u.slice(1),
            0)) || qg(c) || (t = l,
            r = (n = c).data,
            o = Ms(n, r.length - 1),
            !(!Hg(r, r.length - 1) || jg(t, o) || (n.data = r.slice(0, -1) + " ",
            0)))) ? U.some(e) : U.none()
        })
    }, Wg = function(t) {
        ...
        a = t + n >= e.data.length && zg(o, Ms(e, e.data.length)),
        u = 0 === t && Ug(o, Ms(e, 0)),
        ...
        return Mo(e.previousSibling) ? U.some((t = e.previousSibling,
        Fn(t) ? Ms(t, t.data.length) : Ms.after(t))) : e.previousSibling ? Ml(e.previousSibling) : U.none();
        var t
    }, Zg = function(e) {
        return Mo(e.nextSibling) ? U.some((t = e.nextSibling,
        Fn(t) ? Ms(t, 0) : Ms.before(t))) : e.nextSibling ? Il(e.nextSibling) : U.none();
        var t
    }, ep = function(r, o) {
        ...
        return Zg(r).orThunk(function() {
            ...
            return t = r,
            Pl(e = n, Ms.after(t)).fold(function() {
        ...
        if (Ko(e)) {
            ...
            return pn(e),
            mn(e, t),
            U.some(Ms.before(t.dom))
        }
        return U.none()
    }, ap = function(e, t, a) {
        var n, r, o, i, u = Xt(e).filter(jt), s = Yt(e).filter(jt);
        return hn(e),
        r = s,
        o = t,
        i = function(e, t, n) {
        ...
        void 0 === r && (r = !0);
        var o, i, a = np(n, t.getBody(), e.dom), u = Dr(e, k(op, t), (o = t.getBody(),
        function(e) {
            return e.dom === o
        }
        )), s = ap(e, a, (i = e,
        ve(t.schema.getTextInlineElements(), Mt(i))));
        t.dom.isEmpty(t.getBody()) ? (t.setContent(""),
        t.selection.setCursorLocation()) : u.bind(ip).fold(function() {
            r && rp(t, n, s)
        }, function(e) {
            r && rp(t, n, U.some(e))
        })
        ...
        return e.collapsed ? U.none() : us(t, n, sp).fold(function() {
            ...
            return hp(r, e) ? U.none() : (n = r,
            fp((t = e).start, n).bind(function(e) {
                return oe(gp(e)).map(function(e) {
                    return sp(t.start, e)
                })
            }));
        ...
        return e.filter(function(e) {
            return n = o,
            !dp(t = e) && mp(t, n).exists(function(e) {
                var t = e.dom.rows;
        ...
        i = lp((r = t).startContainer, o),
        a = lp(r.endContainer, o),
        us(i, a, sp));
        ...
        t.deleteContents();
        var r, o, i = xp(n).getOr(n), a = Tt.fromDom(e.dom.getParent(i.dom, e.dom.isBlock));
        return Ko(a) && (gg(a),
        e.selection.setCursorLocation(a.dom, 0)),
        Pt(n, a) || (r = Kt(a).is(n) ? [] : Kt(o = a).map(Qt).map(function(e) {
            return H(e, function(e) {
                return !Pt(o, e)
            })
        }).getOr([]),
        Y(r.concat(Qt(n)), function(e) {
            Pt(e, a) || It(e, a) || hn(e)
        })),
        !0
    }, Ep = function(e, t) {
        ...
        return _p(a, e).bind(function(e) {
            return Ko(e) ? Rp(o, e) : (t = a,
            n = e,
            r = u,
            Dl(i, o.getBody(), r).bind(function(e) {
        ...
        return Ap(s, r).fold(function() {
            return Dp(a, u, s, r) || (e = a,
            t = u,
            n = Ms.fromRangeStart(e.selection.getRng()),
            Op(t, n) || Tl(t, e.getBody(), n).exists(function(e) {
                return Op(t, e)
            }));
            var e, t, n
        }, function(e) {
            ...
            (Ko(o) ? Rp(t, o) : Tp(t, r, n, o, i)).getOr(!1);
            var t, n, r, o, i
        })
    }, Pp = function(e, t) {
        var n, r, o, i, a, u = Tt.fromDom(e.selection.getStart(!0)), s = Mf(e);
        return e.selection.isCollapsed() && 0 === s.length ? Bp(e, t, u) : (n = e,
        r = u,
        o = Tt.fromDom(n.getBody()),
        i = n.selection.getRng(),
        0 !== (a = Mf(n)).length ? Sp(n, a) : kp(n, o, i, r))
    }, Lp = function(a) {
        var u = Ms.fromRangeStart(a)
          , s = Ms.fromRangeEnd(a)
          , c = a.commonAncestorContainer;
        return Tl(!1, c, s).map(function(e) {
            return !Zc(u, s, c) && Zc(u, e, c) ? (t = u.container(),
            n = u.offset(),
            r = e.container(),
            o = e.offset(),
        ...
        o = n,
        i = Ms.before(r),
        (a = El(o).next(i)) ? a.toRange() : null
    }, qp = function(e, o, i, t) {
        var n, r, a, u, s, c, l, f, d, m, g, p, h, v, y, b, C, w, x, S, N = (n = o,
        r = t,
        c = e.serialize(r),
        ...
        a), E = jp(o, i.startContainer), k = zp((f = N.firstChild,
        At.grep(f.childNodes, function(e) {
        ...
        (S = p.parentNode).insertBefore(x[0], p),
        At.each(h, function(e) {
            S.insertBefore(e, p)
        }),
        S.insertBefore(x[1], p),
        S.removeChild(p),
        Hp(h[h.length - 1], v))
    }, $p = Wn, Wp = function(e) {
        var t = e.dom
        ...
        r = t,
        o = n,
        null !== (i = a) && i === r.getParent(o.endContainer, $p) && zf(Tt.fromDom(i), o) ? Np(e, n, Tt.fromDom(a)) : e.getDoc().execCommand("Delete", !1, null)
    }, Kp = function(e, t, n) {
        var r, o, i, a, u, s, c, l, f, d = e.selection, m = e.dom;
        /^ | $/.test(t) && (s = m,
        c = d.getRng(),
        l = t,
        f = Tt.fromDom(s.getRoot()),
        l = Ug(f, Ms.fromRangeStart(c)) ? l.replace(/^ /, "&nbsp;") : l.replace(/^&nbsp;/, " "),
        t = l = zg(f, Ms.fromRangeEnd(c)) ? l.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : l.replace(/&nbsp;(<br( \/)?>)?$/, " "));
        var g = e.parser
          , p = n.merge
          , h = qm({
        ...
        if ((y = e.fire("BeforeSetContent", y)).isDefaultPrevented())
            ...
            if (!0 === n.paste && Fp(e.schema, F) && jp(m, r))
                return a = qp(h, m, d.getRng(), F),
                d.setRng(a),
            ...
            M.invalid) {
                ...
                t = h.serialize(g.parse(t.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function() {
            ...
            R && (T = A.getBody(),
            D = jm(B),
            At.each(B.select("*[data-mce-fragment]"), function(e) {
            ...
            function(n, e) {
                ...
                if (e) {
                    ...
                    St.ie || (r = e.nextSibling) && 3 === r.nodeType && (s.appendData(r.data),
                    ...
                    u.setStart(c, 0),
                    u.setEnd(c, 0),
                    $p(c) || c.getAttribute("data-mce-fragment") || !(t = function(e) {
                        var t = Ms.fromRangeStart(e);
                        if (t = El(n.getBody()).next(t))
                            return t.toRange()
            ...
            P = e.getBody(),
            At.each(P.getElementsByTagName("*"), function(e) {
                e.removeAttribute("data-mce-fragment")
            }),
            L = m,
            I = d.getStart(),
            U.from(L.getParent(I, "td,th")).map(Tt.fromDom).each(pg),
            e.fire("SetContent", y),
            e.addVisual()
        }
    }, Xp = function(e, t) {
        t(e),
        e.firstChild && Xp(e.firstChild, t),
        e.next && Xp(e.next, t)
    }, Yp = function(e, t, n) {
        ...
        bm(r = e) && Il(r.getBody()).each(function(e) {
            var t = e.getNode()
        ...
        U.from(u.getBody()).fold(E(s), function(e) {
            return Gp(s) ? function(e, t, n, r) {
                ...
                return r.content = lo(Tt.fromDom(t)) ? o : At.trim(o),
                Jp(e, r.content),
            ...
            r = (i = fc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? (r = a,
            t.dom.createHTML(i, dc(t), r)) : r || '<br data-mce-bogus="1">',
            Jp(t, r),
            t.fire("SetContent", o)) : ("raw" !== o.format && (r = qm({
                validate: t.validate
            }, t.schema).serialize(t.parser.parse(r, {
                isRootContent: !0,
                insert: !0
            }))),
            o.content = lo(Tt.fromDom(n)) ? r : At.trim(r),
            Jp(t, o.content),
        ...
        return r = t,
        ((o = (n = e).dom).parentNode ? Br(Tt.fromDom(o.parentNode), function(e) {
            return !Pt(n, e) && r(e)
        }) : U.none()).isSome();
        var n, r, o
    }, eh = function(e) {
            ...
            if ("undefined" == typeof c.length) {
                for (a in c)
                    if (c.hasOwnProperty(a)) {
                        if (u = "attributes" === r ? e.getAttrib(t, a) : cf(e, t, a),
                        o && !u && !n.exact)
                            return;
                        if ((!o || n.exact) && !nh(u, sf(e, af(c[a], i), a)))
                            return
                    }
            } else
                for (s = 0; s < c.length; s++)
                    if ("attributes" === r ? e.getAttrib(t, c[s]) : cf(e, t, c[s]))
                        return n;
        return n
        ...
        if (c && t)
            for (a = 0; a < c.length; a++)
                if (i = c[a],
                ih(e.dom, t, i) && ah(l, t, i, "attributes", o, r) && ah(l, t, i, "styles", o, r)) {
                    if (s = i.classes)
                        for (u = 0; u < s.length; u++)
                            if (!e.dom.hasClass(t, af(s[u], r)))
                                return;
                    return i
                }
    }, sh = function(e, t, n, r) {
    ...
    }, fh = go, dh = "_mce_caret", mh = function(e) {
        return 0 < function(e) {
            for (var t = []; e; ) {
                if (3 === e.nodeType && e.nodeValue !== fh || 1 < e.childNodes.length)
                    return [];
        ...
        e && mn(t, Tt.fromText(fh)),
        t
    }, hh = function(e, t, n) {
        void 0 === n && (n = !0);
        var r, o, i, a, u, s, c, l, f = e.dom, d = e.selection;
        mh(t) ? up(e, !1, Tt.fromDom(t), n) : (r = d.getRng(),
        o = f.getParent(t, f.isBlock),
        i = r.startContainer,
        a = r.startOffset,
        u = r.endContainer,
        s = r.endOffset,
        (l = gh(t)) && l.nodeValue.charAt(0) === fh && l.deleteData(0, 1),
        c = l,
        f.remove(t, !0),
        i === c && 0 < a && r.setStart(c, a - 1),
        u === c && 0 < s && r.setEnd(c, s - 1),
        o && f.isEmpty(o) && gg(Tt.fromDom(o)),
        d.setRng(r))
    }, vh = function(e, t, n) {
        void 0 === n && (n = !0);
        var r = e.dom
        ...
        var o, i, a, u, s, c, l, f, d, m, g, p, h, v = e.dom, y = e.selection, b = [], C = y.getRng(), w = C.startContainer, x = C.startOffset, S = w;
        ...
        i && (o ? (a = y.getBookmark(),
        C.collapse(!0),
        u = Df(e, C, e.formatter.get(t), !0),
        u = pd(u),
        e.formatter.remove(t, n, u, r),
        y.moveToBookmark(a)) : (s = zl(e.getBody(), i),
        c = ph(!1).dom,
        m = c,
        g = null !== s ? s : i,
        p = (d = e).dom,
        (h = p.getParent(g, k(nf, d))) && p.isEmpty(h) ? g.parentNode.replaceChild(m, g) : (mg(Tt.fromDom(g)),
        p.isEmpty(g) ? g.parentNode.replaceChild(m, g) : p.insertAfter(m, g)),
        ...
        i.on("mouseup keydown", function(e) {
            ...
            o = t.getBody(),
            vh(t, null, !1),
            8 !== n && 46 !== n || !r.isCollapsed() || r.getStart().innerHTML !== fh || vh(t, zl(o, r.getStart())),
            37 !== n && 39 !== n || vh(t, zl(o, r.getStart()))
        })
    }, xh = function(e, t) {
        return e.schema.getTextInlineElements().hasOwnProperty(Mt(t)) && !Ul(t.dom) && !Pn(t.dom)
    }, Sh = {}, Nh = xe, Eh = Ce;
    Km = function(e) {
        var t, n = e.selection.getRng(), r = Dn(["pre"]);
        n.collapsed || (t = e.selection.getSelectedBlocks(),
        Eh(Nh(Nh(t, r), function(e) {
    ...
    var kh = At.each
      ...
      , Th = function(e, t, n, r) {
        var o;
        r && !1 !== t.merge_siblings && (o = Rh(e, tf(r), r),
        Rh(e, o, tf(o, !0)))
    }
      , Dh = function(e, t, n) {
        kh(e.childNodes, function(e) {
            _h(e) && (t(e) && n(e),
            e.hasChildNodes() && Dh(e, t, n))
        })
    }
      , Oh = function(t, n) {
        return function(e) {
      ...
      , Uh = function(e, t, n) {
        ...
        return Tn(o) && (r = o.childNodes.length - 1,
        !n && i && i--,
        o = o.childNodes[r < i ? r : i]),
        Fn(o) && n && i >= o.nodeValue.length && (o = new Gr(o,e.getBody()).next() || o),
        Fn(o) && !n && 0 === i && (o = new Gr(o,e.getBody()).prev() || o),
        o
    }
      , zh = function(e, t) {
      ...
      , qh = function(e, r, o, t, i) {
        ...
        if (u = l,
        !(Mh(s = t, (c = r).inline) || Mh(s, c.block) || c.selector && (Tn(s) && u.is(s, c.selector)) || (a = t,
        ...
        if ("all" !== r.remove) {
            Ih(r.styles, function(e, t) {
                ...
                N(t) && (t = e,
                i = null),
                !r.remove_similar && i && !Mh(cf(l, i, t), e) || l.setStyle(y, t, ""),
                n = !0
            }),
            n && "" === l.getAttrib(y, "style") && (y.removeAttribute("style"),
            y.removeAttribute("data-mce-style")),
            Ih(r.attributes, function(e, t) {
                var n;
                if (e = af(e, o),
                N(t) && (t = e,
                i = null),
                r.remove_similar || !i || Mh(l.getAttrib(i, t), e)) {
                    ...
                    if (Lh.test(t) && y.removeAttribute("data-mce-" + t),
                    "style" === t && Dn(["li"])(y) && "none" === l.getStyle(y, "list-style-type"))
                        return y.removeAttribute(t),
                        void l.setStyle(y, "list-style-type", "none");
        ...
        h = f.dom,
        v = fc(f),
        m.block && (v ? p === h.getRoot() && (m.list_block && Mh(d, m.list_block) || Y(ie(d.childNodes), function(e) {
            rf(f, v, e.nodeName.toLowerCase()) ? g ? g.appendChild(e) : (g = jh(h, e, v),
            h.setAttribs(g, f.settings.forced_root_block_attrs)) : g = 0
        })) : h.isBlock(d) && !h.isBlock(p) && (Vh(h, d, !1) || Vh(h, d.firstChild, !0, !0) || d.insertBefore(h.create("br"), d.firstChild),
        Vh(h, d, !0) || Vh(h, d.lastChild, !1, !0) || d.appendChild(h.create("br")))),
        m.selector && m.inline && !Mh(m.inline, d) || h.remove(d, !0),
        Ph.removed()) : Ph.keep()
    }
      ...
      , Kh = function(s, c, l, e, f) {
        var t, d = s.formatter.get(c), m = d[0], a = !0, u = s.dom, n = s.selection, g = function(e) {
            var n, t, r, o, i, a, u = (t = e,
            r = c,
            o = l,
            i = f,
            Y(ff((n = s).dom, t.parentNode).reverse(), function(e) {
                var t;
            ...
            Fn(e) && hf(u, r) && $h(s, m, l, r, r),
            Tn(e) && u.getContentEditable(e) && (t = a,
            ...
            return Yl(t = r) && Tn(t) && ("_start" === t.id || "_end" === t.id) && (r = r[e ? "firstChild" : "lastChild"]),
            Fn(r) && 0 === r.data.length && (r = e ? n.previousSibling || n.nextSibling : n.nextSibling || n.previousSibling),
            u.remove(n, !0),
            r
        }, r = function(e) {
            ...
            if (m.split) {
                ...
                r.startOffset = u.nodeIndex(t),
                r.endContainer = n.parentNode ? n.parentNode : n,
                r.endOffset = u.nodeIndex(n) + 1
            }
            Bf(u, r, function(e) {
                Y(e, function(t) {
                    p(t);
        ...
        if (e)
            Zl(e) ? ((t = u.createRng()).setStartBefore(e),
            t.setEndAfter(e),
            r(t)) : r(e);
        else if ("false" !== u.getContentEditable(n.getNode()))
            n.isCollapsed() && m.inline && !Mf(s).length ? Ch(s, c, l, f) : (qf(n, !0, function() {
                Vf(s, r)
            }),
            m.inline && sh(s, c, l, n.getStart()) && ef(u, n, n.getRng()),
            s.nodeChanged());
        else {
            e = n.getNode();
        ...
        var e, t, n, o, A = E.formatter.get(k), R = A[0], i = !r && E.selection.isCollapsed(), a = E.dom, u = E.selection, T = function(n, e) {
            ...
            return !!gf(R) && (Gh(e, function(e) {
                if (!("collapsed"in e && e.collapsed !== i))
                    return a.is(t, e.selector) && !Ul(t) ? (T(t, e),
                    !(n = !0)) : void 0
            }),
            n)
        }, s = function(S, e, t, c) {
            ...
            Bf(S, e, function(e) {
                var u, s = function(e) {
                    ...
                    if (Tn(e) && S.getContentEditable(e) && (n = l,
                    l = "true" === S.getContentEditable(e),
                    t = !0),
                    Hn(e) && !function(e, t, n, r) {
                        ...
                        return u = null,
                        void (mf(R) && S.remove(e));
                    if (R.wrapper && uh(E, e, k, _))
                        u = null;
                    else {
                        ...
                        if (gf(R)) {
                            var a = m(A, e);
                            if (Fn(e) && hf(S, e.parentNode) && m(A, e.parentNode),
                            !Jh(R, "inline") || a)
                                return void (u = null)
                        }
                        !l || t || !rf(E, f, r) || !rf(E, o, f) || !c && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || Ul(e) || Jh(R, "inline") && S.isBlock(e) ? (u = null,
                        Gh(At.grep(e.childNodes), s),
                        t && (l = n),
            ...
            Gh(N, function(e) {
                var n, t, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, y, b, C, w = function(e) {
                    ...
                    return Gh(e.childNodes, function(e) {
                        if ((t = e) && 1 === t.nodeType && !Yl(t) && !Ul(t) && !Pn(t))
                            return n = e,
                            !1;
                        var t
                    }),
                ...
                Gh(e.childNodes, function(e) {
                    var t;
                    V(t = e) && Fn(t) && 0 === t.length || Yl(e) || n++
                }),
                n);
                !(1 < N.length) && S.isBlock(e) || 0 !== x ? (pf(R) || R.wrapper) && (R.exact || 1 !== x || ((C = w(y = e)) && !Yl(C) && ih(S, C, R) && (b = S.clone(C, !1),
                T(b),
                S.replace(b, y, !0),
                S.remove(C, !0)),
                e = b || y),
                ...
                p = k,
                h = _,
                uh(m = E, (v = e).parentNode, p, h) && $h(m, g, h, v) || g.merge_with_parents && m.dom.getParent(v.parentNode, function(e) {
                    if (uh(m, e, p, h))
                        return $h(m, g, h, v),
                        !0
                }),
                ...
                f = _,
                d = e,
                (l = R).styles && l.styles.backgroundColor && Dh(d, Oh(c, "fontSize"), Bh(c, "backgroundColor", af(l.styles.backgroundColor, f))),
                i = S,
                u = e,
                s = function(e) {
                    var t;
                    1 === e.nodeType && e.parentNode && 1 === e.parentNode.nodeType && (t = lf(i, e.parentNode),
                    i.getStyle(e, "color") && t ? i.setStyle(e, "text-decoration", t) : i.getStyle(e, "text-decoration") === t && i.setStyle(e, "text-decoration", null))
                }
                ,
                (a = R).styles && (a.styles.color || a.styles.textDecoration) && (At.walk(u, s, "childNodes"),
                s(u)),
                t = S,
                o = e,
                "sub" !== (r = R).inline && "sup" !== r.inline || (Dh(o, Oh(t, "fontSize"), Bh(t, "fontSize", "")),
                t.remove(t.select("sup" === r.inline ? "sub" : "sup", o), !0)),
                Th(S, R, 0, e)) : S.remove(e, !0)
            })
        };
        if ("false" !== a.getContentEditable(u.getNode())) {
            R && (r ? Zl(r) ? m(A, r) || ((e = a.createRng()).setStartBefore(r),
            e.setEndAfter(r),
            s(a, Df(E, e, A), 0, !0)) : s(a, r, 0, !0) : i && pf(R) && !Mf(E).length ? function(e, t, n) {
                var r, o = e.selection, i = o.getRng(), a = i.startOffset, u = i.startContainer.nodeValue, s = zl(e.getBody(), o.getStart());
                s && (r = gh(s));
                var c, l, f, d, m = /[^\s\u00a0\u00ad\u200b\ufeff]/;
                u && 0 < a && a < u.length && m.test(u.charAt(a)) && m.test(u.charAt(a - 1)) ? (c = o.getBookmark(),
                i.collapse(!0),
                l = Df(e, i, e.formatter.get(t)),
                l = pd(l),
                e.formatter.apply(t, n, l),
                o.moveToBookmark(c)) : (s && r.nodeValue === fh || (f = e.getDoc(),
                d = ph(!0).dom,
            ...
            n = A[0],
            E.settings.forced_root_block || !n.defaultBlock || a.getParent(t, a.isBlock) || Qh(E, n.defaultBlock),
            u.setRng(Ip(u.getRng())),
            qf(u, !0, function(e) {
                Vf(E, function(e, t) {
                    var n = t ? e : Df(E, e, A);
                    s(a, n)
            ...
            for (var c = 0, l = A.length; c < l; c++) {
                var f = A[c];
                if (f.ceFalseOverride && gf(f) && a.is(r, f.selector))
                    return void T(r, f)
            }
        }
    }
      ...
      , fv = function(l, e, t) {
        return uv(l, e).bind(function(c) {
            return uv(l, t).map(function(e) {
                ...
                a = r.x,
                u = r.y,
                s = i < u ? sv(t, o, i, a, u) : sv(t, o, u, a, i),
                rv(t.element, av(s), s);
                var t, n, r, o, i, a, u, s
            })
        })
      ...
      , mv = function(e, t) {
        var n, r = Tt.fromDom(t.commonAncestorContainer), o = yg(r, e), i = H(o, function(e) {
            return ro(e) || to(e)
        }), a = dv(o, t), u = i.concat(a.length ? a : uo(n = r) ? Kt(n).filter(ao).fold(E([]), function(e) {
            return [n, e]
        }) : ao(n) ? [n] : []);
        return z(u, rs)
    }
      ...
      , pv = function(e, t) {
        return n = Tt.fromDom(t.cloneContents()),
        r = mv(e, t),
        o = $(r, function(e, t) {
            return mn(t, e),
            t
      ...
      , hv = function(e, o) {
        return t = e,
        n = o[0],
        Pr(n, "table", k(Pt, t)).bind(function(e) {
            var t = o[0]
              , n = o[o.length - 1]
              , r = cv(e);
      ...
      , vv = function(e, t) {
        var n, r, o = If(t, e);
        return 0 < o.length ? hv(e, o) : (n = e,
        0 < (r = t).length && r[0].collapsed ? gv() : pv(n, r[0]))
    }
      , yv = function(e, t) {
      ...
      , wv = function(e, t, n) {
        ...
        s = km(r, Pf(u)),
        (c = o.contextual ? vv(Tt.fromDom(r.getBody()), s).dom : i.cloneContents()) && a.appendChild(c),
      ...
      , _v = function(n) {
        var e, t = (e = n.getBody(),
        H(z(ie(e.childNodes), xv), function(e) {
            return 0 < e.length
        })), r = J(t, function(e) {
      ...
      , Tv = function(e) {
        var t = Tt.fromTag("body", kv.get().getOrThunk(function() {
            ...
            return kv.set(U.some(e)),
            e
        }));
        return ts(t, Rv(e)),
        Y($u(t, "*[data-mce-bogus]"), vn),
        t.dom.innerHTML
    }
      , Dv = function(e, t) {
        return !(!e || !t) && (r = t,
        ...
        return {
            undoManager: {
                beforeChange: function(e, t) {
                    return n = f,
                    r = t,
                    void (Ov(e) && r.set(U.some(uc(n.selection))));
                    var n, r
                },
                ...
                hasUndo: function(e, t) {
                    return n = f,
                    r = e,
                    0 < t.get() || r.typing && r.data[0] && !Dv(_v(n), r.data[0]);
                    var n, r
                },
            ...
            formatter: {
                ...
                toggle: function(e, t, n) {
                    ...
                    void (!sh(r, o, i, a) || "toggle"in u[0] && !u[0].toggle ? Qh : Kh)(r, o, i, a);
                    var r, o, i, a, u
                },
            ...
            editor: {
                getContent: function(e, t) {
                    ...
                    r = e,
                    o = t,
                    U.from(n.getBody()).fold(E("tree" === r.format ? new Tm("body",11) : ""), function(e) {
                        return Um(n, r, o, e)
                    });
                    var n, r, o
                },
                ...
                addVisual: function(e) {
                    ...
                    a = (i = f).dom,
                    n = V(t) ? t : i.getBody(),
                    d(i.hasVisual) && (i.hasVisual = i.getParam("visual", !0, "boolean")),
      ...
      , Mv = function(e) {
        ...
        return he(e.plugins, "rtc").bind(function(e) {
            ...
            return U.some(e().then(function(e) {
                ...
                ,
                n = b("Unimplemented feature for rtc"),
                i = (t = e).undoManager,
                a = t.formatter,
                r = t.editor,
                u = t.selection,
      ...
      , zv = function(e, t) {
        ...
        return n = o,
        r = t,
        Uv(e).selection.getContent(n, r)
    }
      , jv = function(e) {
        return 0 === e.dom.length ? (hn(e),
        U.none()) : U.some(e)
    }
      , Hv = function(e, t, s, c) {
        e.bind(function(u) {
            return (c ? Yg : Xg)(u.dom, c ? u.dom.length : 0),
            t.filter(jt).map(function(e) {
                return t = e,
                n = s,
                r = c,
                o = u.dom,
    ...
    var $v, Wv, Kv = function(e) {
        ...
        var l, f, i, n, a, d, r = function(e, t) {
            ...
            n.on("NodeChange", function(e) {
                ...
                At.each(a, function(e, n) {
                    At.each(r, function(t) {
                        if (i.is(t, n))
                            return d[n] || (At.each(e, function(e) {
                                e(!0, {
                                    node: t,
                                    selector: n,
                                    parents: r
            ...
            try {
                (e = m()) && !Rn(e.anchorNode) && (t = 0 < e.rangeCount ? e.getRangeAt(0) : e.createRange ? e.createRange() : o.createRange(),
                t = km(c, [t])[0])
            } catch (a) {}
            ...
            if ((r = e) && (Kv(r) || Xv(r.startContainer) && Xv(r.endContainer))) {
                ...
                if (o) {
                    ...
                    e.collapsed || e.startContainer !== e.endContainer || !i.setBaseAndExtent || St.ie || e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && (n = e.startContainer.childNodes[e.startOffset]) && "IMG" === n.tagName && (i.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset),
            ...
            getNode: function() {
                return function(e, t) {
                    ...
                    3 === n.nodeType && 3 === r.nodeType && (n = n.length === o ? Em(n.nextSibling, !0) : n.parentNode,
                    r = 0 === i ? Em(r.previousSibling, !1) : r.parentNode,
            ...
            getSelectedBlocks: function(e, t) {
                return function(e, t, n, r) {
                    var o, i = [], a = e.getRoot();
                    if (n = e.getParent(n || Sm(a, t, t.collapsed), e.isBlock),
                    r = e.getParent(r || Nm(a, t, t.collapsed), e.isBlock),
                    n && n !== a && i.push(n),
                    n && r && n !== r)
                        for (var u = new Gr(o = n,a); (o = u.next()) && o !== r; )
        ...
        var n, r = Si();
        t.convert_fonts_to_spans && Gv(e, r, At.explode(t.font_size_legacy_values)),
        n = r,
        ...
        var e, n, a, u, s;
        0 !== o.src.indexOf("blob:") ? (n = (e = Qv(o.src)).data,
        a = e.type,
        u = n,
        (s = r.getByData(u, a)) ? i({
            image: o,
        ...
        p.remove_trailing_brs && e.addNodeFilter("br", function(e, t, n) {
            var r, o, i, a, u, s, c, l, f = e.length, d = At.extend({}, h.getBlockElements()), m = h.getNonEmptyElements(), g = h.getWhiteSpaceElements();
            for (d.body = 1,
            r = 0; r < f; r++)
                if (i = (o = e[r]).parent,
                d[o.parent.name] && o === i.lastChild) {
                    ...
                    o && (o.remove(),
                    uy(h, m, g, i) && (c = h.getElementRule(i.name)) && (c.removeEmpty ? i.remove() : c.paddEmpty && iy(p, n, d, i)))
                } else {
                    for (a = o; i && i.firstChild === a && i.lastChild === a && !d[(a = i).name]; )
                        i = i.parent;
                    a === i && !0 !== p.padd_empty_with_br && ((l = new Tm("#text",3)).value = mo,
                    o.replace(l))
                }
        }),
        ...
        p.fix_list_elements && e.addNodeFilter("ul,ol", function(e) {
            for (var t, n, r, o = e.length; o--; ) {
                "ul" !== (r = (n = e[o]).parent).name && "ol" !== r.name || (n.prev && "li" === n.prev.name ? n.prev.append(n) : ((t = new Tm("li",1)).attr("style", "list-style-type: none"),
                n.wrap(t)))
            }
        }),
        ...
        sy(e, p)
    }, ly = At.makeMap, fy = At.each, dy = At.explode, my = At.extend, gy = function(A, R) {
        void 0 === R && (R = wi());
        var T = {}
          , D = []
          , O = {}
        ...
        var e, t, P = function(e) {
            ...
            parse: function(e, u) {
                ...
                O = {},
                B = {};
                var f, d = my(ly("script,style,head,html,body,title,meta,param"), R.getBlockElements()), m = R.getNonEmptyElements(), g = R.children, p = A.validate, h = "forced_root_block"in u ? u.forced_root_block : A.forced_root_block, v = !1 === (f = h) ? "" : !0 === f ? "p" : f, y = R.getWhiteSpaceElements(), b = /^[ \t\r\n]+/, C = /[ \t\r\n]+$/, w = /[ \t\r\n]+/g, x = /^[ \t\r\n]+$/, S = y.hasOwnProperty(u.context) || y.hasOwnProperty(A.root_name), N = function(e, t) {
                    var n, r = new Tm(e,t);
                    ...
                    start: function(e, t, n) {
                        ...
                        if (u) {
                            ...
                            r.shortEnded = n,
                            c.append(r),
                            (a = g[c.name]) && g[r.name] && !a[r.name] && l.push(r),
                            o = D.length; o--; )
                        ...
                        if (a) {
                            ...
                            if (S && y[e] && (S = !1),
                            a.removeEmpty && uy(R, m, y, c))
                                return o = c.parent,
                                d[c.name] ? c.empty().remove() : c.unwrap(),
                                void (c = o);
                            a.paddEmpty && (ay(i = c, "#text") && i.firstChild.value === mo || uy(R, m, y, c)) && iy(A, u, d, c),
                            c = c.parent
                        }
                    }
                }, R), _ = c = new Tm(u.context || A.root_name,11);
                if (k.parse(e, u.format),
                p && l.length && (u.context ? u.invalid = !0 : function(e) {
                        ...
                        if ((t = e[h]).parent && !t.fixed)
                            if (g[t.name] && "li" === t.parent.name) {
                                ...
                                if (n && 1 < r.length) {
                                    ...
                                    uy(R, d, m, o) ? n.insert(t, r[0], !0) : (n.insert(o, r[0], !0),
                                    n.insert(t, o)),
                                    n = r[0],
                                    (uy(R, d, m, n) || ay(n, "br")) && n.empty().remove()
                                } else if (t.parent) {
                                    if ("li" === t.name) {
        ...
        (r = e) && r.hasEventListeners("PreProcess") && !o.no_events ? function(e, t, n) {
            ...
            At.each("BODY" === t.nodeName ? t.childNodes : [t], function(e) {
        ...
        t.addNodeFilter("noscript", function(e) {
            for (var t, n = e.length; n--; )
                (t = e[n].firstChild) && (t.value = fi.decode(t.value))
        }),
        ...
        return {
            ...
            serialize: function(e, t) {
                ...
                r = p,
                i = ho((o = g).getInner ? r.innerHTML : n.getOuterHTML(r)),
                o.selection || lo(Tt.fromDom(r)) ? i : At.trim(i)), v = (a = x,
                u = h,
                d = (s = g).selection ? _e({
                    forced_root_block: !1
                }, s) : s,
        ...
        return n = t,
        r = o,
        Fv(e).editor.getContent(n, r)
    }, wy = function(e, t, n) {
        return void 0 === n && (n = {}),
        r = t,
        o = n,
        Fv(e).editor.setContent(r, o);
        var r, o
    }, xy = Su.DOM, Sy = function(e) {
        ...
        e.hasHiddenInput && o && xy.remove(o.nextSibling),
        e.fire("remove"),
        e.editorManager.remove(e),
        !e.inline && r && (i = e,
        xy.setStyle(i.id, "display", i.orgDisplay)),
        e.fire("detach"),
        xy.remove(e.getContainer()),
        Sy(t),
        Sy(n),
        e.destroy())
    }, Ey = function(e, t) {
        ...
        xy.unbind(r, "submit reset", n.formEventDelegate)),
    ...
    }, ky = Object.prototype.hasOwnProperty, _y = ($v = function(e, t) {
    ...
    function() {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
            var o = e[r];
            for (var i in o)
                ky.call(o, i) && (n[i] = $v(n[i], o[i]))
        }
        return n
    }
    ), Ay = gt().deviceType, Ry = Ay.isTouch(), Ty = Ay.isPhone(), Dy = Ay.isTablet(), Oy = ["lists", "autolink", "autosave"], By = {
        table_grid: !1,
        object_resizing: !1,
        resize: !1
    }, Py = function(e) {
        ...
        return e && (a = i = "mobile",
        u = (o = t).sections(),
        Iy(o, i) && u[i].theme === a) ? H(r, k(M, Oy)) : e && Iy(t, "mobile") ? r : n;
        var o, i, a, u
    }, Uy = function(e, t, n, r) {
        var o, i, a, u = Py(n.forced_plugins), s = Py(r.plugins), c = Iy(o = t, i = "mobile") ? o.sections()[i] : {}, l = c.plugins ? Py(c.plugins) : s, f = Fy(e, t, s, l), d = (a = f,
        [].concat(Py(u)).concat(Py(a)));
        if (St.browser.isIE() && M(d, "rtc"))
        ...
        } : {}, m = Ly(["mobile"], _y(d, o)), g = At.extend(n, r, m.settings(), (f = m,
        e && Iy(f, "mobile") ? function(e, t, n) {
            void 0 === n && (n = {});
            var r = e.sections()
            ...
            s && s.external_plugins ? At.extend({}, s.external_plugins, l) : l)
        });
        return Uy(e, m, r, g)
        ...
        return "hash" === r ? (a = {},
        "string" == typeof (i = u) ? Y(0 < i.indexOf("=") ? i.split(/[;,](?![^=;,]*(?:[;,]|$))/) : i.split(","), function(e) {
            var t = e.split("=");
            1 < t.length ? a[At.trim(t[0])] = At.trim(t[1]) : a[At.trim(t[0])] = At.trim(t[0])
        }) : a = i,
        a) : "string" === r ? Hy(K, e, t).getOr(n) : "number" === r ? Hy(N, e, t).getOr(n) : "boolean" === r ? Hy(f, e, t).getOr(n) : "object" === r ? Hy(w, e, t).getOr(n) : "array" === r ? Hy(S, e, t).getOr(n) : "string[]" === r ? Hy((o = K,
        function(e) {
            return S(e) && Q(e, o)
        }
    ...
    }, qy = (Wv = {},
    {
    ...
    }, Ky = k($y, "clientWidth"), Xy = k($y, "clientHeight"), Yy = k(Wy, "margin-top"), Gy = k(Wy, "margin-left"), Jy = function(e, t, n) {
        var r, o, i, a, u, s, c, l, f, d, m, g = Tt.fromDom(e.getBody()), p = e.inline ? g : (r = g,
        Tt.fromDom($t(r).dom.documentElement)), h = (o = e.inline,
        a = t,
        u = n,
        ...
        return t = n,
        U.from(t).map(Tt.fromDom).map(yn).getOr(!1)
    }, Zy = function(n) {
        var t, o = [], i = function() {
            var e, t = n.theme;
    ...
    }, eb = Pu.PluginManager, tb = Pu.ThemeManager;
    var nb, rb, ob = function(n) {
        ...
        return db(e, (n = (t = e).getParam("content_css"),
        K(n) ? z(n.split(","), We) : S(n) ? n : !1 === n || t.inline ? [] : ["default"]));
        var t, n
    }, db = function(t, e) {
        ...
        ,
        {
                ...
                return r.upload(e, yb(s)).then(f(function(e) {
                    var a = []
                      , t = z(e, function(e, t) {
                        ...
                        return e.status && s.getParam("images_replace_blob_uris", !0, "boolean") ? (c.removeByUri(i.src),
                        p(i, e.url)) : e.error && (e.error.options.remove && (g(i.getAttribute("src"), St.transparentSrc),
                        a.push(i)),
                        n = s,
                        r = e.error.message,
                        ab(n, Bu.translate(["Failed to upload image: {0}", r]))),
                        {
                            element: i,
                            status: e.status,
                            uploadUri: e.url,
                    ...
                    return 0 < t.length && l.fireIfChanged(),
                    0 < a.length && (Iv(s) ? console.error("Removing images on failed uploads is currently unsupported for RTC") : s.undoManager.transact(function() {
                        Y(a, function(e) {
                            s.dom.remove(e),
                            c.removeByUri(e.src)
                        })
            ...
            return (o = o || oy(a, c)).findAll(s.getBody(), y).then(f(function(e) {
                ...
                Y(e, function(e) {
                    g(e.image.src, e.blobInfo.blobUri()),
    ...
    }, xb = At.each, Sb = Su.DOM, Nb = function(e, t) {
        var n, o, r, m = t && t.schema || wi({}), g = function(e) {
            o = "string" == typeof e ? {
                name: e,
                classes: [],
                attrs: {}
            ...
            !(!(c = s && s.parentsRequired) || !c.length) && (a && -1 !== At.inArray(c, a) ? a : c[0]));
            if (d)
                f === d ? (o = e[0],
                e = e.slice(1)) : o = d;
            else if (l)
        ...
        n = g(o),
        (r = Sb.create("div")).appendChild(p(n, e.slice(1), o.siblings)),
        r) : ""
    }, Eb = function(e) {
        var t, a = {
            classes: [],
        ...
        wh(s),
        {
            ...
            toggle: function(e, t, n) {
                ...
                o = t,
                i = n,
                Uv(s).formatter.toggle(r, o, i)
            },
            match: function(e, t, n) {
                return r = e,
                o = t,
                i = n,
                Uv(s).formatter.match(r, o, i);
                var r, o, i
            },
            closest: function(e) {
                return t = e,
                Uv(s).formatter.closest(t);
                var t
            },
            matchAll: function(e, t) {
                return n = e,
                r = t,
                Uv(s).formatter.matchAll(n, r);
                var n, r
            },
            matchNode: function(e, t, n, r) {
                return o = e,
                ...
                a = n,
                u = r,
                Uv(s).formatter.matchNode(o, i, a, u);
                var o, i, a, u
            },
            canApply: function(e) {
                return t = e,
                Uv(s).formatter.canApply(t);
                var t
            },
            formatChanged: function(e, t, n) {
                ...
                i = t,
                void 0 === (a = n) && (a = !1),
                Uv(s).formatter.formatChanged(r, o, i, a);
                var r, o, i, a
            },
            getCssText: k(kb, s)
        }
        ...
        n.on("BeforeExecCommand", function(e) {
            ...
            "undo" !== t && "redo" !== t && "mcerepaint" !== t && (Pv(r, o),
            r.beforeChange())
        }),
        ...
        n.on("keyup", function(e) {
            ...
            i.get() && r.typing && !1 === Dv(_v(n), r.data[0]) && (!1 === n.isDirty() && (n.setDirty(!0),
            n.fire("change", {
                level: r.data[0],
                lastLevel: null
            })),
        ...
        var e, c = Ru(U.none()), l = Ru(0), f = Ru(0), d = {
            data: [],
            typing: !1,
            beforeChange: function() {
                ...
                e = l,
                t = c,
                Uv(s).undoManager.beforeChange(e, t)
            },
            add: function(e, t) {
                return n = d,
                r = f,
                ...
                a = e,
                u = t,
                Uv(s).undoManager.addUndoLevel(n, r, o, i, a, u);
                var n, r, o, i, a, u
            },
            undo: function() {
                return e = d,
            ...
            clear: function() {
                ...
                e = d,
                t = f,
                Uv(s).undoManager.clear(e, t)
            },
            reset: function() {
                var e;
                e = d,
                Uv(s).undoManager.reset(e)
            },
            hasUndo: function() {
                return e = d,
                t = f,
                Uv(s).undoManager.hasUndo(e, t);
                var e, t
            },
            hasRedo: function() {
                return e = d,
                t = f,
                Uv(s).undoManager.hasRedo(e, t);
                var e, t
            },
            transact: function(e) {
                return t = d,
                n = l,
                r = e,
                Uv(s).undoManager.transact(t, n, r);
                var t, n, r
            },
            ignore: function(e) {
                var t, n;
            ...
            extra: function(e, t) {
                ...
                o = e,
                i = t,
                Uv(s).undoManager.extra(n, r, o, i)
            }
        };
        return Iv(s) || Ab(s, d, l),
        (e = s).addShortcut("meta+z", "", "Undo"),
        e.addShortcut("meta+y,meta+shift+z", "", "Redo"),
        d
    }, Tb = [9, 27, nd.HOME, nd.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, nd.DOWN, nd.UP, nd.LEFT, nd.RIGHT].concat(St.browser.isFirefox() ? [224] : []), Db = "data-mce-placeholder", Ob = function(e) {
        return "keydown" === e.type || "keyup" === e.type
    }, Bb = function(e) {
        var t = e.keyCode;
        return t === nd.BACKSPACE || t === nd.DELETE
    }, Pb = function(a) {
        var e, u = a.dom, s = fc(a), c = (e = a).getParam("placeholder", sc.getAttrib(e.getElement(), "placeholder"), "string"), l = function(e, t) {
            var n, r, o, i;
            !function(e) {
                if (Ob(e)) {
                    var t = e.keyCode;
        ...
        return "rtl" === Su.DOM.getStyle(e, "direction", !0) || (t = e.textContent,
        Lb.test(t));
        var t
    }, Fb = function(e, t, n) {
        var r, o, i, a = (r = e,
        o = t,
        i = n,
        H(Su.DOM.getParents(i.container(), "*", o), r));
    ...
    }, zb = k(Ub, !0), jb = k(Ub, !1), Hb = function(e, t) {
          ...
          , n = t.bind(function(e) {
            return Tl(i, o, e.position).bind(function(e) {
                return $b(o, e).map(function(e) {
                    return t = o,
                    n = i,
                    Hn((r = e).position.getNode()) && !1 === Ko(r.block) ? Bl(!1, r.block.dom).bind(function(e) {
        ...
        return Qb(!0, t),
        Qb(!1, n),
        Jb(t, n).fold(k(Gb, e, t, n), k(Yb, e, t, n))
    }, eC = function(e, t, n, r) {
        return t ? Zb(e, r, n) : Zb(e, n, r)
    }, tC = function(t, n) {
        var e, r, o, i = Tt.fromDom(t.getBody()), a = (e = i.dom,
        r = n,
        ...
        var n, r, o = Ll(e.dom, Ms.fromRangeStart(t)).isNone(), i = Pl(e.dom, Ms.fromRangeEnd(t)).isNone();
        return !(nC(n = e, (r = t).startContainer) || nC(n, r.endContainer)) && o && i
    }, oC = function(e) {
        var n, r, o, t, i = Tt.fromDom(e.getBody()), a = e.selection.getRng();
        return rC(i, a) ? ((t = e).setContent(""),
        t.selection.setCursorLocation(),
        !0) : (n = i,
        r = e.selection,
        o = r.getRng(),
        us(Hb(n, Tt.fromDom(o.startContainer)), Hb(n, Tt.fromDom(o.endContainer)), function(e, t) {
            return !1 === Pt(e, t) && (o.deleteContents(),
    ...
    }, aC = qn, uC = $n, sC = function(e, t, n, r, o) {
        ...
        a = n.dom,
        Fn(u = e) && 0 === u.data.length && a.remove(u),
        !0
    }, pC = function(e, t) {
        var n = e.selection.getRng();
        if (!Fn(n.commonAncestorContainer))
            return !1;
        ...
        return Tl(s, u, c).bind(function(e) {
            return a = e.getNode(),
            co(Tt.fromDom(a)) || uo(Tt.fromDom(a)) ? U.none() : (t = u,
            o = e,
            i = function(e) {
        ...
        a = o.getNode(!1 === i),
        u = i ? "after" : "before",
        Tn(a) && a.getAttribute("data-mce-caret") === u ? (t = e,
        n = o.getNode(!1 === e),
        (t && $n(n.nextSibling) ? U.some(hC.moveToElement(n.nextSibling)) : !1 === t && $n(n.previousSibling) ? U.some(hC.moveToElement(n.previousSibling)) : U.none()).fold(function() {
            return yC(r, e, o)
        ...
        return CC(a, e).filter($n).fold(function() {
            ...
            o = Ms.fromRangeStart(r),
            i = Tt.fromDom(e),
            (!1 === t && dg(o) ? U.some(hC.remove(o.getNode(!0))) : t && fg(o) ? U.some(hC.remove(o.getNode())) : !1 === t && fg(o) && Tg(i, o) ? Dg(i, o).map(function(e) {
        ...
        return !!$n(e) && CC(t, e.parentNode).filter($n).fold(function() {
            var e;
            return e = Tt.fromDom(t.getBody()),
            Y($u(e, ".mce-offscreen-selection"), hn),
            up(t, n, Tt.fromDom(t.selection.getNode())),
            Vb(t),
            !0
        }, R)
    }, SC = function(e) {
        var t, n = e.dom, r = e.selection, o = Zf(e.getBody(), r.getNode());
        return qn(o) && n.isBlock(o) && n.isEmpty(o) && (t = n.create("br", {
            "data-mce-bogus": "1"
        }),
        n.setHTML(o, ""),
        o.appendChild(t),
        r.setRng(Ms.before(t).toRange())),
        !0
    }, NC = function(e, t) {
        ...
        Tl(r, n.getBody(), o).filter(function(e) {
            return (r ? ig : ag)(e)
        }).bind(function(e) {
        ...
        return (e ? function(e) {
            if (kC(e.previousSibling))
                return AC(e.previousSibling) || e.previousSibling.appendData(go),
                e.previousSibling;
            if (kC(e))
                return _C(e) || e.insertData(0, go),
                e;
            var t = RC(e);
        ...
        : function(e) {
            if (kC(e.nextSibling))
                return _C(e.nextSibling) || e.nextSibling.insertData(0, go),
                e.nextSibling;
            if (kC(e))
                return AC(e) || e.appendData(go),
                e;
            var t = RC(e);
    ...
    }, DC = k(TC, !0), OC = k(TC, !1), BC = function(e, t) {
        ...
        return WC(a, u, t).bind(k(ZC, e)).orThunk(function() {
            ...
            o = c,
            i = Ub(t = e, s),
            Tl(t, r, i).map(k(Ub, t)).fold(function() {
                return o.map(YC)
            }, function(e) {
    ...
    var rw, ow, iw = function(e, t) {
        ...
        for (var o, i, a, u, s, c, l = El(n), f = r, d = []; f && (s = l,
        c = f,
        o = t === Fs.Forwards ? s.next(c) : s.prev(c)); ) {
            ...
            if (o.isVisible()) {
                if (e(f, o)) {
                    var m = (i = t,
                    a = f,
                    Hn((u = o).getNode(i === Fs.Forwards)) ? nb.Br : !1 === Zc(a, u) ? nb.Block : nb.Wrap);
                    return {
                        positions: iw(t, d),
                        breakType: m,
                        breakAt: U.some(o)
    ...
    }, lw = k(aw, Ms.isAbove, -1), fw = k(aw, Ms.isBelow, 1), dw = k(uw, -1, lw), mw = k(uw, 1, fw), gw = function(t) {
        var e = function(e) {
            return z(e, function(e) {
                return (e = cs(e)).node = t,
                e
            })
        };
        if (Tn(t))
    ...
    var hw = function(o, i, a, e, u, t) {
      ...
      , Rw = function(e, t, n) {
        var r, o, i = pw(H(ie(e.getElementsByTagName("*")), Hc)), a = H(i, k(kw, n));
        if (u = _w(a, t)) {
            ...
            if ((u = _w(function(e, r, t) {
                ...
                return o.push(r),
                Aw(rw.Up, e, k(n, ds), r.node, t),
                Aw(rw.Down, e, k(n, ms), r.node, t),
                o
            }(e, u, s), t)) && Hc(u.node))
                return o = t,
                {
      ...
      , Ow = function(e, t, n, r, o, i) {
        ...
        if (!n.collapsed) {
            var l = ps(n);
            if (i(l))
                return sC(t, e, l, t === Fs.Backwards, !1)
        }
      ...
      , Bw = function(t, e, n, r, o, i) {
        ...
        if (!u)
            return U.none();
        var c, l = (s ? yw : vw)(t.getBody(), bw(1), a), f = H(l, Cw(1)), d = u.left, m = _w(f, d);
        if (m && i(m.node)) {
        ...
        if (c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : ps(n)) {
            var h = function(e, t, n, r) {
                var o, i, a, u, s = El(t), c = [], l = 0, f = function(e) {
              ...
              , v = _w(H(h, Cw(1)), d);
            if (v)
                return Dw(t, v.position.toRange(), !1);
            if (v = ke(H(h, Cw(0))))
                return Dw(t, v.position.toRange(), !1)
        }
      ...
      , Uw = function(e, t) {
        var n, r;
        e.selection.isCollapsed() && !0 !== e.composing && t.get() && (n = Ms.fromRangeStart(e.selection.getRng()),
        Ms.isTextPosition(n) && !1 === (So(r = n) || No(r)) && (Iw(e, Oc(t.get(), n)),
        t.set(null)))
    }
      , zw = function(e, t, n) {
        return !!xc(e) && (o = t,
        i = n,
        a = (r = e).getBody(),
        u = Ms.fromRangeStart(r.selection.getRng()),
        s = k(Ib, r),
      ...
      , Hw = function(d) {
        ...
        return d.on("NodeChange", function(e) {
            ...
            !xc(d) || St.browser.isIE() && e.initial || (a = g,
            u = d.dom,
            s = e.parents,
            c = z($u(Tt.fromDom(u.getRoot()), '*[data-mce-selected="inline-boundary"]'), function(e) {
                return e.dom
            }),
            l = H(c, a),
            f = H(s, a),
      ...
      , Kw = function(r, o, i, a) {
        ...
        r.undoManager.ignore(function() {
            ...
            WC(s, u, Ms.fromRangeStart(r.selection.getRng())).map(GC).map(Ww(r, o))
        }),
        r.nodeChanged()
    }
      , Xw = function(n, r, i, o) {
            ...
            return us(s, e, function() {
                ...
                return e.bind(function(e) {
                    return t.map(function(e) {
                        return i ? Kw(n, r, o, e) : Kw(n, r, e, o),
                        !0
                    })
                })
            }).getOr(!1)
      ...
      , Jw = function(e, t, n, r) {
        var o, i, a, u, s, c = k(xh, t), l = z(H(r, c), function(e) {
            return e.dom
        });
        0 === l.length ? up(t, e, n) : (i = n.dom,
        a = l,
        u = ph(!1),
        s = bh(a, u.dom),
        ln(Tt.fromDom(i), u),
      ...
      , Qw = function(r, o) {
        var t, e = Tt.fromDom(r.getBody()), n = Tt.fromDom(r.selection.getStart()), s = H((t = yg(n, e),
        G(t, no).fold(E(t), function(e) {
            return t.slice(0, e)
        })), Gw);
        return oe(s).exists(function(e) {
            ...
            }).getOr(!0) || Ul((t = e).dom) && mh(t.dom)) && (Jw(o, r, e, s),
            !0)
        })
    }
      , Zw = function(e, t) {
      ...
      , tx = function(e, t) {
        ...
        u = (a = t) ? ug : sg,
        s = a ? Fs.Forwards : Fs.Backwards,
        c = ul(s, i.getBody(), i.selection.getRng()),
        u(c) ? ex(i, a, c.getNode(!a)) : U.from(Ub(a, c)).filter(function(e) {
            return u(e) && ll(c, e)
        }).exists(function(e) {
      ...
      , ux = function(e, c) {
        ...
        Y(ax(e), function(e) {
            ...
            a = e.dom,
            s = rx(r, Tt.fromDom(a)),
            "outdent" === n ? (u = Math.max(0, nx(a.style[s]) - o),
            t.setStyle(a, s, u ? u + i : "")) : (u = nx(a.style[s]) + o + i,
            t.setStyle(a, s, u))
        })
    }
      , sx = function(e, t) {
      ...
      , lx = function(n, r) {
        n.addCommand("delete", function() {
            var e, t;
            t = r,
            sx(e = n) || NC(e, !1) || pC(e, !1) || Yw(e, t, !1) || tC(e, !1) || Pp(e) || EC(e, !1) || tx(e, !1) || iC(e) || Zw(e, !1) || (cx(e, "Delete"),
            Vb(e))
        }),
        n.addCommand("forwardDelete", function() {
            var e, t;
            t = r,
            NC(e = n, !0) || pC(e, !0) || Yw(e, t, !0) || tC(e, !0) || Pp(e) || EC(e, !0) || tx(e, !0) || iC(e) || Zw(e, !0) || cx(e, "ForwardDelete")
        })
    }
      , fx = function(e) {
      ...
      , gx = function(e) {
        var t, n, r, o = e.dom, i = e.selection, a = e.schema, u = a.getBlockElements(), s = i.getStart(), c = e.getBody(), l = fc(e);
        if (s && Tn(s) && l) {
            var f = c.nodeName.toLowerCase();
            if (a.isValidChild(f, l.toLowerCase()) && (d = u,
            m = c,
            g = s,
            !F(vg(Tt.fromDom(g), Tt.fromDom(m)), function(e) {
                return mx(d, e.dom)
            }))) {
                for (var d, m, g, p, h, v = i.getRng(), y = v.startContainer, b = v.startOffset, C = v.endContainer, w = v.endOffset, x = bm(e), s = c.firstChild; s; )
                    if (p = u,
                    Fn(h = s) || Tn(h) && !mx(p, h) && !Yl(h)) {
                        if (function(e, t) {
                            if (Fn(t)) {
                                if (0 === t.nodeValue.length)
                                    return !0;
                                if (/^\s+$/.test(t.nodeValue) && (!t.nextSibling || mx(e, t.nextSibling)))
                                    return !0
                            }
                            return !1
                        }(u, s)) {
      ...
      , px = function(e, t) {
        var n;
        t.hasAttribute("data-mce-caret") && (Ao(t),
        (n = e).selection.setRng(n.selection.getRng()),
        e.selection.scrollIntoView(t))
    }
      , hx = function(e, t) {
        var n, r = (n = e,
        Lr(Tt.fromDom(n.getBody()), "*[data-mce-caret]").fold(E(null), function(e) {
            return e.dom
        }));
        if (r)
            return "compositionstart" === t.type ? (t.preventDefault(),
            t.stopPropagation(),
            void px(e, r)) : void (xo(r) && (px(e, r),
            e.undoManager.add()))
    }
      , vx = $n
      , yx = function(e, t, n) {
        var r, o, i = El(e.getBody()), a = k(cl, 1 === t ? i.next : i.prev);
        if (n.collapsed && "" !== fc(e)) {
            var u, s = e.dom.getParent(n.startContainer, "PRE");
            if (!s)
                return;
            a(Ms.fromRangeStart(n)) || (o = (r = e).dom.create(fc(r)),
            (!St.ie || 11 <= St.ie) && (o.innerHTML = '<br data-mce-bogus="1">'),
            u = o,
      ...
      , Ax = function(e, t, n) {
        return t ? (o = e.dom,
        fw(o, n).breakAt.isNone()) : (r = e.dom,
        lw(r, n).breakAt.isNone());
        var r, o
    }
      , Rx = function(t, n) {
        var e, r, o = Tt.fromDom(t.getBody()), i = Ms.fromRangeStart(t.selection.getRng()), a = fc(t), u = dc(t);
        return e = i,
        r = k(Pt, o),
        Or(Tt.fromDom(e.container()), no, r).filter(Nx).exists(function() {
            if (Ax(o, n, i)) {
                var e = _x(o, a, u, n);
      ...
      , Mx = function(o, e) {
        return J(e, function(e) {
            var t, n, r = (t = cs(e.getBoundingClientRect()),
            n = -1,
            {
                left: t.left - n,
                top: t.top - n,
      ...
      , Vx = function(e, t, n) {
        var r, o, i, a, u = e(t, n);
        return (a = u).breakType === nb.Wrap && 0 === a.positions.length || !Hn(n.getNode()) && ((i = u).breakType === nb.Br && 1 === i.positions.length) ? (r = e,
        o = t,
      ...
      , Xx = function(u, s, c) {
        ...
        e.fold(function() {
            ...
            return Bl(t, u.getBody()).filter(function(e) {
                ...
                o = a,
                t = c,
                void ((i = fc(r = u)) ? r.undoManager.transact(function() {
                    var e = Tt.fromTag(i);
                    Jn(e, dc(r)),
                    mn(e, Tt.fromTag("br")),
                    (n ? fn : ln)(Tt.fromDom(o), e);
      ...
      , tS = function(e, t) {
        ...
        if (t) {
            ...
            t.hasChildNodes()) {
                ...
                Hn(t) ? t.nextSibling && i.isBlock(t.nextSibling) ? (u.setStartBefore(t),
      ...
      , aS = function(e, t, n) {
        for (var r = e[n ? "firstChild" : "lastChild"]; r && !Tn(r); )
            r = r[n ? "nextSibling" : "previousSibling"];
        return r === t
    }
      , uS = function(e, t, n, r, o) {
        var i, a, u, s, c, l, f, d, m, g = e.dom, p = e.selection.getRng();
        n !== e.getBody() && (oS(i = n) && oS(i.parentNode) && (o = "LI"),
        a = o ? t(o) : g.create("BR"),
        aS(n, r, !0) && aS(n, r, !1) ? rS(n, "LI") ? (u = iS(n),
        g.insertAfter(a, u),
        (null === (m = (d = n).parentNode) || void 0 === m ? void 0 : m.firstChild) === d ? g.remove(u) : g.remove(n)) : g.replace(a, n) : (aS(n, r, !0) ? rS(n, "LI") ? (g.insertAfter(a, iS(n)),
        a.appendChild(g.doc.createTextNode(" ")),
        a.appendChild(n)) : n.parentNode.insertBefore(a, n) : aS(n, r, !1) ? g.insertAfter(a, iS(n)) : (n = iS(n),
        (s = p.cloneRange()).setStartAfter(r),
        s.setEndAfter(n),
        c = s.extractContents(),
        "LI" === o && (f = "LI",
        (l = c).firstChild && l.firstChild.nodeName === f) ? (a = c.firstChild,
        g.insertAfter(c, n)) : (g.insertAfter(c, n),
        g.insertAfter(a, n))),
        g.remove(r)),
        tS(e, a))
    }
      ...
      , gS = function(a, e) {
        var t, u, i, s, n, r, o, c, l, f = a.dom, d = a.schema, m = d.getNonEmptyElements(), g = a.selection.getRng(), p = function(e) {
            ...
            var t, n, r = fS(e, u, i);
            if (Fn(u) && (e ? 0 < r : r < u.nodeValue.length))
                return !1;
            if (u.parentNode === s && l && !e)
                return !0;
            if (e && Tn(u) && u === s.firstChild)
                return !0;
            if (cS(u, "TABLE") || cS(u, "HR"))
                return l && !e || !l && e;
            var o = new Gr(u,s);
            for (Fn(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next()); t = o.current(); ) {
                if (Tn(t)) {
                    ...
                    m[n] && "br" !== n))
                        return !1
                } else if (Fn(t) && !jo(t.nodeValue))
                    return !1;
                e ? o.prev() : o.next()
            }
            return !0
        }, v = function() {
            n = /^(H[1-6]|PRE|FIGURE)$/.test(c) && "HGROUP" !== C ? p(N) : p(),
            a.getParam("end_container_on_empty_block", !1) && lS(f, o) && f.isEmpty(s) ? n = f.split(o, s) : f.insertAfter(n, s),
            tS(a, n)
        };
        ...
        var y = !(!e || !e.shiftKey)
          , b = !(!e || !e.ctrlKey);
        Tn(u) && u.hasChildNodes() && (l = i > u.childNodes.length - 1,
        u = u.childNodes[Math.min(i, u.childNodes.length - 1)] || u,
        i = l && Fn(u) ? u.nodeValue.length : 0);
        var C, w, x, S, N, E = dS(f, u);
        E && ((N && !y || !N && y) && (u = function(e, t, n, r, o) {
            var i, a, u, s, c, l, f = t || "P", d = e.dom, m = dS(d, r), g = d.getParent(r, d.isBlock);
            if (!g || !lS(d, g)) {
                if (c = (g = g || m) === e.getBody() || (l = g) && /^(TD|TH|CAPTION)$/.test(l.nodeName) ? g.nodeName.toLowerCase() : g.parentNode.nodeName.toLowerCase(),
                !g.hasChildNodes())
                    return i = d.create(f),
                    mS(e, i),
                    g.appendChild(i),
        ...
        c = C),
        /^(LI|DT|DD)$/.test(c) && f.isEmpty(s) ? uS(a, p, o, s, N) : N && s === a.getBody() || (N = N || "P",
        bo(s) ? (n = Ao(s),
        f.isEmpty(s) && sS(s),
        mS(a, n),
        tS(a, n)) : h() ? v() : h(!0) ? (n = s.parentNode.insertBefore(p(), s),
        tS(a, cS(s, "HR") ? n : s)) : ((S = (x = g).cloneRange()).setStart(x.startContainer, fS(!0, x.startContainer, x.startOffset)),
        S.setEnd(x.endContainer, fS(!1, x.endContainer, x.endOffset)),
        (t = S.cloneRange()).setEndAfter(s),
        r = t.extractContents(),
        w = r,
        Y(qu(Tt.fromDom(w), jt), function(e) {
            var t = e.dom;
      ...
      , bS = function(e, t) {
        return n = Ms.after(t),
        !!Hn(n.getNode()) || Pl(e, Ms.after(t)).map(function(e) {
            return Hn(e.getNode())
        }).getOr(!1);
        var n
    }
      ...
      , $S = function(e, t, n) {
        n && !e.get() ? t.on("NodeChange", VS, !0) : !n && e.get() && t.off("NodeChange", VS),
        e.set(n)
    }
      , WS = function(o, i) {
        var a;
      ...
      , KS = function(n, r) {
        var e = r.container()
          , t = r.offset();
        return Fn(e) ? (e.insertData(t, n),
        U.some(Ms(e, t + n.length))) : sl(r).map(function(e) {
            var t = Tt.fromText(n);
            return (r.isAtEnd() ? fn : ln)(e, t),
            Ms(t.dom, n.length)
        })
    }
      , XS = k(KS, mo)
      ...
      , GS = function(r, o) {
        return function(e) {
            return t = r,
            (!Mg(n = e) && (Fg(t, n) || Lg(t, n) || Ig(t, n)) ? XS : YS)(o);
            var t, n
        }
    }
      , JS = function(e) {
        var t, n, r = Ms.fromRangeStart(e.selection.getRng()), o = Tt.fromDom(e.getBody());
      ...
      , ZS = function(e) {
        var t, n = Hw(e);
        return (t = e).on("keyup compositionstart", k(hx, t)),
        Zx(e, n),
        eS(e, n),
        FS(e),
        QS(e),
    ...
    function tN(r) {
        ...
        "onselectionchange"in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function(e) {
            ...
            "nodechange" !== e.type && ud(n, o) || r.fire("SelectionChange"),
            o = n
        }),
    ...
    var nN = function(e) {
      ...
      , oN = function(a) {
        a.on("click", function(e) {
            ...
            o = Ms.fromRangeStart(r),
            i = Ms.fromRangeEnd(r),
            Ms.isElementPosition(o) && (n = o.container(),
            rN(n) && Il(n).each(function(e) {
                return r.setStart(e.container(), e.offset())
            })),
            Ms.isElementPosition(i) && (n = o.container(),
            rN(n) && Ml(n).each(function(e) {
      ...
      , aN = function(e, t) {
        ...
        },
        {
            pageX: (o = function(e, t) {
                ...
                var n, r, o, i, a, u = iN(e.getContentAreaContainer()), s = (r = (n = e).getBody(),
      ...
      , dN = function(e, l) {
        return function(c) {
            e.on(function(e) {
                ...
                a = e.element,
                i === a || o.dom.isChildOf(i, a) || uN(i) || (n = e.element,
      ...
      , gN = function(e) {
        ...
        }), i = Su.DOM, a = document, u = lN(o, e), s = fN(o, e), c = dN(o, e), l = (n = o,
        function() {
            n.on(function(e) {
      ...
      , pN = function(e) {
        ...
        e.getParam("block_unsupported_drop", !0, "boolean") && (a = function(e) {
            var t;
            e.isDefaultPrevented() || (t = e.dataTransfer) && (M(t.types, "Files") || 0 < t.files.length) && (e.preventDefault(),
            "drop" === e.type && ab(i, "Dropped file type is not supported"))
        }
        ,
        u = function(e) {
            fm(i, e.target) && a(e)
      ...
      , bN = function(u) {
        var s, c = u.selection, l = u.dom, f = l.isBlock, d = u.getBody(), m = Uc(u, d, f, function() {
            return bm(u)
        }), g = "sel-" + l.uniqueId(), i = "data-mce-selected", p = function(e) {
            ...
            var t = u.schema.getShortEndedElements()
              ...
              , i = e.endContainer
              , a = e.endOffset;
            return ve(t, r.nodeName.toLowerCase()) ? 0 === o ? n.setStartBefore(r) : n.setStartAfter(r) : n.setStart(r, o),
            ve(t, i.nodeName.toLowerCase()) ? 0 === a ? n.setEndBefore(i) : n.setEndAfter(i) : n.setEnd(i, a),
            n
        }, C = function(e) {
            var t = e.cloneNode(!0)
            ...
            var r = function(e, t, n) {
                ...
                var i = l.createRng();
                t === n && St.ie ? (o.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(t),
                i.setStartAfter(o[0].firstChild.firstChild),
                i.setEndAfter(t)) : (o.empty().append(mo).append(t).append(mo),
            ...
            var a = e.startContainer
              , u = e.startOffset
              , s = e.endOffset;
            if (3 === a.nodeType && 0 === u && vN(a.parentNode) && (a = a.parentNode,
            u = l.nodeIndex(a),
            a = a.parentNode),
            1 !== a.nodeType)
                return null;
            ...
            Lr(Tt.fromDom(u.getBody()), "#" + g).each(hn),
            s = null
        }, S = function() {
            m.hide()
        };
        return St.ceFalse && !Iv(u) && function() {
            ...
            u.on("click", function(e) {
                var t = yN(u, e.target);
                t && (vN(t) && (e.preventDefault(),
                u.focus()),
                hN(t) && l.isChildOf(t, c.getNode()) && x())
            }),
            ...
            var a = function(e) {
                ...
                if (!e.firstChild)
                    return !1;
                var n, r = Ms.before(e.firstChild), o = t.next(r);
                return o && !(fg(n = o) || dg(n) || ug(n) || sg(n))
            }
              , i = function(e, t) {
                var n, r, o = l.getParent(e, f), i = l.getParent(t, f);
                return !(!o || e === i || !l.isChildOf(o, i) || !1 !== vN(yN(u, o))) || o && (n = o,
                r = i,
            ...
            u.on("tap", function(e) {
                var t = e.target
                  , n = yN(u, t);
                vN(n) ? (e.preventDefault(),
                cC(u, n).each(w)) : p(t) && cC(u, t).each(w)
            }, !0),
            u.on("mousedown", function(e) {
                var t, n, r, o = e.target;
                o !== d && "HTML" !== o.nodeName && !l.isChildOf(o, d) || !1 === Jy(u, e.clientX, e.clientY) || ((t = yN(u, o)) ? vN(t) ? (e.preventDefault(),
                cC(u, t).each(w)) : (x(),
                hN(t) && e.shiftKey || ed(e.clientX, e.clientY, c.getRng()) || (S(),
                c.placeCaretAt(e.clientX, e.clientY))) : p(o) ? cC(u, o).each(w) : !1 === Hc(o) && (x(),
                S(),
                (n = Rw(d, e.clientX, e.clientY)) && (i(o, n.node) || (e.preventDefault(),
            ...
            u.on("copy", function(e) {
                ...
                e.isDefaultPrevented() || !e.clipboardData || St.ie || (t = (n = l.get(g)) ? n.getElementsByTagName("*")[0] : n) && (e.preventDefault(),
                r.clearData(),
        ...
        }(),
        {
            ...
            showBlockCaretContainer: function(e) {
                e.hasAttribute("data-mce-caret") && (Ao(e),
                h(r()),
                c.scrollIntoView(e))
            },
            hideFakeCaret: S,
      ...
      , CN = function(s) {
        var n, r, o = At.each, c = nd.BACKSPACE, l = nd.DELETE, f = s.dom, d = s.selection, e = s.parser, t = St.gecko, i = St.ie, a = St.webkit, u = "data:text/mce-internal,", m = i ? "Text" : "URL", g = function(e, t) {
            try {
            ...
            s.on("keydown", function(e) {
                ...
                if (!p(e) && (a === l || a === c)) {
                    if (t = s.selection.isCollapsed(),
                    n = s.getBody(),
                    t && !f.isEmpty(n))
                        return;
                    if (!t && (r = s.selection.getRng(),
                    o = u(r),
                    (i = f.createRng()).selectNode(s.getBody()),
                    o !== u(i)))
                        return;
                    e.preventDefault(),
                    s.setContent(""),
                    n.firstChild && f.isBlock(n.firstChild) ? s.selection.setCursorLocation(n.firstChild, 0) : s.selection.setCursorLocation(n, 0),
                    s.nodeChanged()
                }
            })
        }, v = function() {
            ...
            Range.prototype.getClientRects || s.on("mousedown", function(e) {
                var t;
                p(e) || "HTML" !== e.target.nodeName || ((t = s.getBody()).blur(),
                Kr.setEditorTimeout(s, function() {
                    t.focus()
                }))
            })
        }, b = function() {
            ...
            s.inline || (s.contentStyles.push("body {min-height: 150px}"),
            s.on("click", function(e) {
                var t;
                if ("HTML" === e.target.nodeName) {
                    if (11 < St.ie)
                        return void s.getBody().focus();
            ...
            St.mac && s.on("keydown", function(e) {
                !nd.metaKeyPressed(e) || e.shiftKey || 37 !== e.keyCode && 39 !== e.keyCode || (e.preventDefault(),
                s.selection.getSel().modify("move", 37 === e.keyCode ? "backward" : "forward", "lineboundary"))
            })
        }, _ = function() {
            s.on("click", function(e) {
                var t = e.target;
            ...
            s.on("dragstart", function(e) {
                var t, n, r;
                (t = e).dataTransfer && (s.selection.isCollapsed() && "IMG" === t.target.tagName && d.select(t.target),
                0 < (n = s.selection.getContent()).length && (r = u + escape(s.id) + "," + escape(n),
            ...
            s.on("drop", function(e) {
                ...
                p(e) || (t = (i = e).dataTransfer && (a = i.dataTransfer.getData(m)) && 0 <= a.indexOf(u) ? (a = a.substr(u.length).split(","),
                {
                    id: unescape(a[0]),
                    html: unescape(a[1])
                }) : null) && t.id !== s.id && (e.preventDefault(),
                n = ad(e.x, e.y, s.getDoc()),
                d.setRng(n),
                r = t.html,
                o = !0,
            ...
            if (!p(e) && e.keyCode === nd.BACKSPACE) {
                ...
                if (t.collapsed && 0 === r) {
                    for (; i && i.parentNode && i.parentNode.firstChild === i && i.parentNode !== o; )
                        i = i.parentNode;
                    "BLOCKQUOTE" === i.tagName && (s.formatter.toggle("blockquote", null, i),
        ...
        h(),
        St.windowsPhone || s.on("keyup focusin mouseup", function(e) {
            nd.modifierPressed(e) || d.normalize()
        }, !0),
        a && (s.inline || f.bind(s.getDoc(), "mousedown mouseup", function(e) {
            var t;
            if (e.target === s.getDoc().documentElement)
                if (t = d.getRng(),
                s.getBody().focus(),
                "mousedown" === e.type) {
                    if (wo(t.startContainer))
                        return;
        ...
        n = function() {
            ...
            return function() {
                var t = d.getStart();
                t !== s.getBody() && (f.setAttrib(t, "style", null),
                o(e, function(e) {
        ...
        s.on("keypress", function(e) {
            var t;
            if (!p(e) && (8 === e.keyCode || 46 === e.keyCode) && r())
                return t = n(),
      ...
      , NN = function(u) {
        ...
        u.inline || Hf(u) && u.selection.getStart(!0) !== e || Il(e).each(function(e) {
            var t, n, r, o, i = e.getNode(), a = Ln(i) ? Il(i).getOr(e) : e;
            St.browser.isIE() ? (t = u,
            n = a.toRange(),
            r = Tt.fromDom(t.getBody()),
            o = (tm(t) ? U.from(n) : U.none()).map(nm).filter(em(r)),
      ...
      , EN = function(e) {
        ...
        (t = e).settings.auto_focus && Kr.setEditorTimeout(t, function() {
      ...
      , _N = function(e, t) {
        var n, r, o, i, a = kN(e), u = yc(e), s = function() {
            a.unloadAll(t),
            e.inline || e.ui.styleSheetLoader.unloadAll(u)
        }, c = function() {
      ...
      , AN = function(t) {
        ...
        wN.setAttrib(r, "spellcheck", "false")),
        t.quirks = CN(t),
        t.fire("PostRender");
        ...
        0 < t.contentStyles.length && (o = "",
        At.each(t.contentStyles, function(e) {
            o += e + "\r\n"
        }),
        t.dom.addStyle(o)),
        _N(t, t.contentCSS),
      ...
      , RN = function(t, e) {
        ...
        o.close()),
        t.inline && (wN.addClass(r, "mce-content-body"),
        ...
        t.readonly || (t.inline && "static" === wN.getStyle(c, "position", !0) && (c.style.position = "relative"),
        ...
        i),
        t.serializer = by((s = (a = t).settings,
        _e(_e({}, SN(a)), xN({
        ...
        t.selection = Yv(t.dom, t.getWin(), t.serializer, t),
        t.annotator = Jf(t),
        t.formatter = _b(t),
        t.undoManager = Rb(t),
        t._nodeChangeDispatcher = new eN(t),
        t._selectionOverrides = bN(t),
        dx(t),
        nN(t),
        Iv(t) || oN(t);
        var l, f, d = Iv(l = t) ? Ru(null) : ZS(l);
        lx(t, d),
        fc(f = t) && f.on("NodeChange", k(gx, f)),
        Pb(t),
        t.fire("PreInit"),
        Mv(t).fold(function() {
            AN(t)
      ...
      , DN = function(e) {
        ...
        var n = cc(e, "body_id", "tinymce")
          , r = cc(e, "body_class", "");
        return lc(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + lc(e) + '" />'),
      ...
      , FN = function(e) {
        ...
        K(wc(e)) ? e.theme.renderUI() : m(wc(e)) ? (n = (t = e).getElement(),
        (r = wc(t)(t, n)).editorContainer.nodeType && (r.editorContainer.id = r.editorContainer.id || t.id + "_parent"),
      ...
      , UN = function(e) {
        ...
        o = _e(_e({}, qy.get("default").icons), qy.get(t).icons),
        se(o, function(e, t) {
            ve(r, t) || n.ui.registry.addIcon(t, e)
        }),
        u = wc(i = e),
        K(u) ? (i.settings.theme = LN(u),
        a = tb.get(u),
        i.theme = new a(i,tb.urls[u]),
        i.theme.init && i.theme.init(i, tb.urls[u] || i.documentBaseUrl.replace(/\/$/, ""), i.$)) : i.theme = {},
        s = e,
        c = [],
        At.each(Sc(s).split(/[ ,]/), function(e) {
            PN(s, c, LN(e))
        });
        var l, f, d, m = FN(e);
        l = e,
        ...
        return e.editorContainer = v.editorContainer ? v.editorContainer : null,
        mb(e),
        e.inline ? RN(e) : (h = ON(g = e, p = v),
        p.editorContainer && (TN.get(p.editorContainer).style.display = g.orgDisplay,
        g.hidden = TN.isHidden(p.editorContainer)),
        g.getElement().style.display = "none",
        TN.setAttrib(g.id, "aria-hidden", "true"),
        void (h || RN(g)))
    }
      , zN = Su.DOM
      , jN = function(e) {
      ...
      , HN = function(e, t) {
        var n, r = hc(t), o = t.getParam("language_url", "", "string");
        !1 === Bu.hasCode(r) && "en" !== r && (n = "" !== o ? o : t.editorManager.baseURL + "/langs/" + r + ".js",
      ...
      , qN = function(e, o, t) {
        ...
        Y(function(e) {
            ...
            e.add(r.url, te, undefined, function() {
                ...
                ub(e, "IconsLoadError", sb("icons", t, n))
            })
        })
    }
      , $N = function(e, t) {
        ...
        i = function() {
            ...
            r = e,
            o = t,
            At.each(r.getParam("external_plugins"), function(e, t) {
            ...
            At.each(Sc(r).split(/[ ,]/), function(e) {
                var t, n;
                (e = At.trim(e)) && !eb.urls[e] && (jN(e) ? (e = e.substr(1, e.length),
                t = eb.dependencies(e),
                At.each(t, function(e) {
                    var t = {
                        prefix: "plugins/",
        ...
        ,
        u = wc(r = e),
        K(u) ? (jN(u) || tb.urls.hasOwnProperty(u) || ((a = r.getParam("theme_url")) ? tb.load(u, r.documentBaseURI.toAbsolute(a)) : tb.load(u, "themes/" + u + "/theme" + o + ".js")),
      ...
      , WN = function(t) {
        ...
        var n, r, o, i, a, u = function() {
            zN.unbind(window, "ready", u),
            t.render()
        };
        Di.Event.domLoaded ? t.getElement() && St.contentEditable && (n = Tt.fromDom(t.getElement()),
        r = $(n.dom.attributes, function(e, t) {
        ...
        (a = t.getElement().form || zN.getParent(e, "form")) && (t.formElement = a,
        t.getParam("hidden_input") && !Mn(t.getElement()) && (zN.insertAfter(zN.create("input", {
            type: "hidden",
            name: e
        }), e),
        t.hasHiddenInput = !0),
        ...
        ,
        zN.bind(a, "submit reset", t.formEventDelegate),
        t.on("reset", function() {
            t.resetContent()
        }),
        ...
        t.windowManager = ob(t),
        t.notificationManager = Zy(t),
        ...
        $N(t, t.suffix)) : zN.bind(window, "ready", u)
    }
      , KN = function(e, t) {
        return n = t,
        Uv(e).editor.addVisual(n);
        var n
    }
      , XN = {
        "font-size": "size",
      ...
      , GN = function(o) {
        return function(r, e) {
            return U.from(e).map(Tt.fromDom).filter(zt).bind(function(e) {
                return YN(o, r, e.dom).or((t = o,
                n = e.dom,
                U.from(Su.DOM.getStyle(n, t, !0))));
                var t, n
            }).getOr("")
        }
    }
      ...
      , tE = function(e, t) {
        if (/^[0-9.]+$/.test(t)) {
            ...
            if (1 <= n && n <= 7) {
                var r = (a = e,
                At.explode(a.getParam("font_size_style_values", "xx-small,x-small,small,medium,large,x-large,xx-large")))
                  , o = (i = e,
                At.explode(i.getParam("font_size_classes", "")));
    ...
    sE.prototype.setupCommands = function(i) {
        ...
        this.addCommands({
            ...
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function(e) {
                var t = e.substring(7);
                "full" === t && (t = "justify"),
                oE("left,center,right,justify".split(","), function(e) {
            ...
            LineHeight: function(e, t, n) {
                var r, o;
                o = n,
                (r = i).formatter.toggle("lineheight", {
                    value: String(o)
                }),
                r.nodeChanged()
            },
    ...
    var cE = "data-mce-contenteditable"
      , lE = function(e, t, n) {
        var r, o;
        Vu(e, t) && !1 === n ? (o = t,
        Fu(r = e) ? r.dom.classList.remove(o) : zu(r, o),
        Hu(r)) : n && ju(e, t)
    }
      , fE = function(e, t, n) {
        try {
      ...
      , mE = function(e, t) {
        ...
        e.readonly = !0,
        dE(i, !1),
        Y($u(i, '*[contenteditable="true"]'), function(e) {
            Gn(e, cE, "true"),
            dE(e, !1)
        })) : (e.readonly = !1,
        dE(i, !0),
        Y($u(i, "*[" + cE + '="true"]'), function(e) {
            er(e, cE),
            dE(e, !0)
        }),
        fE(e, "StyleWithCSS", !1),
      ...
      , hE = function(a, u) {
        var e, t;
        "click" !== u.type || nd.metaKeyPressed(u) || (e = Tt.fromDom(u.target),
        t = a,
        Ir(e, "a", function(e) {
            ...
            var t, n, r, o, i;
            u.preventDefault(),
            /^#/.test(e) ? (t = a.dom.select(e + ',[name="' + (qe(n = e, r = "#") ? (o = n,
            i = r.length,
        ...
        if (e)
            for (var r = e.toLowerCase().split(" "), o = r.length; o--; ) {
                var i = r[o]
                  , a = this.bindings[i];
                if (!i)
                    return se(this.bindings, function(e, t) {
                        n.toggleEvent(t, !1),
                        delete n.bindings[t]
                    }),
                    this;
    ...
    function bE(e) {
        ...
        this.toggleEvent = this.settings.toggleEvent || A
    }
    var CE, wE = function(n) {
        ...
        var n = Cc(e);
        return n ? (e.eventRoot || (e.eventRoot = SE.select(n)[0]),
        ...
        toggleNativeEvent: function(e, t) {
            var n = this;
            "focus" !== e && "blur" !== e && (t ? n.initialized ? kE(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [e] : n.initialized && (n.dom.unbind(NE(n, e), e, n.delegates[e]),
    ...
    }), AE = ["design", "readonly"], RE = function(e, t, n, r) {
        ...
        i.deactivate(),
        i.editorReadOnly !== a.editorReadOnly && mE(e, a.editorReadOnly),
        t.set(r),
        o = r,
        e.fire("SwitchMode", {
            mode: o
        ...
        f11: 122,
        f12: 123
    }, PE = At.makeMap("alt,ctrl,shift,meta,access"), LE = function(e) {
        var t, n = {};
        DE(OE(e.toLowerCase(), "+"), function(e) {
            e in PE ? n[e] = !0 : /^[0-9]{2,}$/.test(e) ? n.keyCode = parseInt(e, 10) : (n.charCode = e.charCodeAt(0),
            n.keyCode = BE[e] || e.toUpperCase().charCodeAt(0))
        });
        var r = [n.keyCode];
        for (t in PE)
            n[t] ? r.push(t) : n[t] = !1;
        return n.id = r.join(","),
        n.access && (n.alt = !0,
        St.mac ? n.ctrl = !0 : n.shift = !0),
        n.meta && (St.mac ? n.meta = !0 : (n.ctrl = !0,
        n.meta = !1)),
        n
    ...
    function qE(e, t) {
        ...
        /^[\w\-]*:?\/\//.test(e) || (r = this.settings.base_uri ? this.settings.base_uri.path : new qE(document.location.href).directory,
    ...
    JE.prototype.execCallback = function(e) {
        ...
        if (o)
            ...
            r = r.scope),
            "string" == typeof o && (r = (r = o.replace(/\.\w+$/, "")) ? XE(r) : 0,
            o = XE(o),
    ...
    JE.prototype.show = function() {
        ...
        this.inline ? this.getBody().contentEditable = "true" : ($E.show(this.getContainer()),
        $E.hide(this.id)),
        this.load(),
        this.fire("show"))
    }
    ...
    JE.prototype.hide = function() {
        var e = this
          , t = e.getDoc();
        e.hidden || (YE && t && !e.inline && t.execCommand("SelectAll"),
        e.save(),
        ...
        $E.setStyle(e.id, "display", e.orgDisplay)),
        e.hidden = !0,
        e.fire("hide"))
    }
    ,
    ...
    JE.prototype.save = function(e) {
        ...
        if (o && r.initialized && !r.removed)
            ...
            t = e.content,
            Mn(o) ? o.value = t : (!e.is_removing && r.inline || (o.innerHTML = t),
            (n = $E.getParent(r.id, "form")) && KE(n.elements, function(e) {
                if (e.name === r.id)
                    return e.value = t,
                    !1
            })),
    ...
    JE.prototype.getContainer = function() {
        return this.container || (this.container = $E.get(this.editorContainer || this.id + "_parent")),
        this.container
    }
    ,
    ...
    JE.prototype.getElement = function() {
        return this.targetElm || (this.targetElm = $E.get(this.id)),
        this.targetElm
    }
    ,
    ...
    function JE(e, t, n) {
        ...
        WE(this, _E),
        this.settings = jy(this, e, this.documentBaseUrl, n.defaultSettings, t),
        ...
        this.settings.referrer_policy && (_u.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
        Su.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
        Pu.languageLoad = this.settings.language_load,
        Pu.baseURL = n.baseURL,
        this.id = e,
        this.setDirty(!1),
        this.documentBaseURI = new VE(this.settings.document_base_url,{
            base_uri: this.baseUri
        }),
        this.baseURI = this.baseUri,
        this.inline = !!this.settings.inline,
        this.shortcuts = new IE(this),
        this.editorCommands = new uE(this),
        this.settings.cache_suffix && (St.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, "")),
        this.ui = {
            registry: FE(),
    ...
    var QE, ZE = Su.DOM, ek = At.explode, tk = At.each, nk = At.extend, rk = 0, ok = !1, ik = [], ak = [], uk = function(t) {
        var n = t.type;
        ...
        e !== ok && (e ? hu(window).on("resize scroll", uk) : hu(window).off("resize scroll", uk),
        ok = e)
    }, ck = function(t) {
        var e = ak;
        delete ik[t.id];
        ...
        fk.activeEditor === t && (fk.activeEditor = 0 < ak.length ? ak[0] : null),
        fk.focusedEditor === t && (fk.focusedEditor = null),
        e.length !== ak.length
    }, lk = "CSS1Compat" !== document.compatMode, fk = _e(_e({}, xE), {
        baseURI: null,
        baseURL: null,
        defaultSettings: {},
        ...
        settings: {},
        setup: function() {
            var e, t = "", n = VE.getDocumentBaseUrl(document.location);
            ...
            this.baseURL = new VE(n).toAbsolute(e),
            this.documentBaseURL = n,
            this.baseURI = new VE(this.baseURL),
            this.suffix = t,
            (r = this).on("AddEditor", k(dm, r)),
            r.on("RemoveEditor", k(mm, r))
        },
        ...
        init: function(r) {
            var n, u = this, s = At.makeMap("area base basefont br col frame hr img input isindex link meta param embed source wbr track colgroup option table tbody tfoot thead tr th td script noscript style textarea video audio iframe object menu", " "), c = function(e) {
                var t = e.id;
                ...
                o = hu.unique(function(t) {
                    var n = [];
                    if (St.browser.isIE() && St.browser.version.major < 11)
                        return lb("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tinymce.com/docs/get-started/system-requirements/"),
                        [];
                    if (lk)
                        return lb("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."),
                        [];
                    if (t.types)
                        return tk(t.types, function(e) {
                            n = n.concat(ZE.select(e.selector))
                        }),
                        n;
                    if (t.selector)
                        return ZE.select(t.selector);
                    if (t.target)
                        return [t.target];
                    switch (t.mode) {
                    case "exact":
                ...
                r.types ? tk(r.types, function(t) {
                    At.each(o, function(e) {
                        return !ZE.is(e, t.selector) || (n(c(e), nk({}, r, t), e),
                        !1)
                    })
                }) : (At.each(o, function(e) {
                    var t;
                    (t = u.get(e.id)) && t.initialized && !(t.getContainer() || t.getBody()).parentNode && (ck(t),
                ...
                0 === (o = At.grep(o, function(e) {
                    ...
                    var t;
                    t = e,
                    r.inline && t.tagName.toLowerCase()in s ? lb("Could not initialize inline editor on invalid inline target element", e) : n(c(e), r, e)
                }))
            };
            return u.settings = r,
        ...
        add: function(e) {
            var n = this;
            return ik[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (ik[e.id] = e),
            ik.push(e),
            ak.push(e)),
            sk(!0),
            n.activeEditor = e,
        ...
        remove: function(e) {
            ...
            if (e) {
                if (!K(e))
                    return n = e,
                    a(r.get(n.id)) ? null : (ck(n) && r.fire("RemoveEditor", {
                        editor: n
                    }),
                    0 === ak.length && window.removeEventListener("beforeunload", QE),
                    n.remove(),
                    sk(0 < ak.length),
                    n);
        ...
        execCommand: function(e, t, n) {
            ...
            switch (e) {
            case "mceAddEditor":
                return this.get(n) || new GE(n,this.settings,this).render(),
                !0;
            ...
            case "mceToggleEditor":
                ...
                !0) : (this.execCommand("mceAddEditor", !1, n),
                !0)
            }
        ...
        _setBaseUrl: function(e) {
            this.baseURL = new VE(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, "")),
            this.baseURI = new VE(this.baseURL)
        }
    });
    fk.setup();
    var dk, mk, gk, pk, hk = Math.min, vk = Math.max, yk = Math.round, bk = function(e, t, n) {
        var r = t.x
          , o = t.y
          , i = e.w
          , a = e.h
        ...
        findBestRelativePosition: function(e, t, n, r) {
            for (var o, i = 0; i < r.length; i++)
                if ((o = bk(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y)
                    return r[i];
            return null
        },
    ...
    mk = {},
    {
        load: function(r, o) {
            ...
            var e = new Mr(function(e, t) {
                ...
                mk[r] = n.resolve,
                _u.ScriptLoader.loadScript(o, function() {
                    return n.start(a)
                }, function() {
                    return n.reject(i)
                })
        ...
        add: function(e, t) {
            mk[e] !== undefined && (mk[e](t),
            delete mk[e]),
            dk[e] = Mr.resolve(t)
        }
    }), Sk = At.each, Nk = At.extend, Ek = function() {};
    Ek.extend = gk = function(n) {
        var o = this.prototype
          , r = function() {
            var e, t, n;
            if (!pk && (this.init && this.init.apply(this, arguments),
            t = this.Mixins))
                for (e = t.length; e--; )
        ...
        var i = new this;
        return pk = !1,
        n.Mixins && (Sk(n.Mixins, function(e) {
            for (var t in e)
                "init" !== t && (n[t] = e[t])
        }),
        o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
        n.Methods && Sk(n.Methods.split(","), function(e) {
            n[e] = t
        }),
        ...
        n.Defaults && o.Defaults && (n.Defaults = Nk({}, o.Defaults, n.Defaults)),
        se(n, function(e, t) {
            var n, r;
    ...
    var kk = Math.min
      ...
      , Dk = _e(_e({}, xE), {
        send: function(e) {
            ...
            e.requestheaders && At.each(e.requestheaders, function(e) {
                t.setRequestHeader(e.key, e.value)
            }),
            t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            (t = Dk.fire("beforeSend", {
                xhr: t,
                settings: e
            }).xhr).send(e.data),
            !e.async)
    ...
    try {
        ...
        (Lk = window.localStorage).setItem(Ik, Ik),
        Lk.removeItem(Ik)
    } catch (zk) {
        Lk = function() {
            return n = {},
