...
!function(t, e) {
            ...
            if (null != i) {
                ...
                try {
                    ...
                    0 === e) {
                        ...
                        for (; !(l = (n = r.call(i)).done) && (s.push(n.value),
                        s.length !== e); l = !0)
                            ;
                } catch (t) {
                    c = !0,
    ...
    }, P = v, I = Function.prototype, A = I.call, $ = P && I.bind.bind(A, A), R = P ? $ : function(t) {
        return function() {
            return A.apply(t, arguments)
        }
    }
    , E = R, j = E({}.toString), _ = E("".slice), F = function(t) {
        return _(j(t), 8, -1)
    ...
    : V, H = function(t) {
        return null == t
    }, M = H, U = TypeError, z = function(t) {
        if (M(t))
            throw U("Can't call method on " + t);
        return t
    }, q = L, W = z, G = function(t) {
        return q(W(t))
    }, K = "object" == typeof document && document.all, Y = {
        all: K,
        IS_HTMLDDA: void 0 === K && void 0 !== K
    }, J = Y.all, X = Y.IS_HTMLDDA ? function(t) {
        return "function" == typeof t || t === J
    }
    : function(t) {
        return "function" == typeof t
    }
    , Q = X, Z = Y.all, tt = Y.IS_HTMLDDA ? function(t) {
        return "object" == typeof t ? null !== t : Q(t) || t === Z
    }
    : function(t) {
        return "object" == typeof t ? null !== t : Q(t)
    }
    , et = d, it = X, nt = function(t) {
    ...
    dt && (C = (k = dt.split("."))[0] > 0 && k[0] < 4 ? 1 : +(k[0] + k[1])),
    !C && lt && (!(k = lt.match(/Edge\/(\d+)/)) || k[1] >= 74) && (k = lt.match(/Chrome\/(\d+)/)) && (C = +k[1]);
    var pt = C
      , ft = pt
      , gt = f
    ...
    var qt = z
      ...
      , he = function(t) {
        return ne(le, t) || (le[t] = re && ne(se, t) ? se[t] : ce("Symbol." + t)),
        le[t]
    }
      , ue = y
      , de = tt
      ...
      , ge = function(t, e) {
        var i, n;
        if ("string" === e && jt(i = t.toString) && !_t(n = Et(i, t)))
            return n;
        if (jt(i = t.valueOf) && !_t(n = Et(i, t)))
            return n;
        if ("string" !== e && jt(i = t.toString) && !_t(n = Et(i, t)))
            return n;
    ...
    De.f = Ue ? qe ? function(t, e, i) {
        ...
        e = Ge(e),
        We(i),
        "function" == typeof t && "prototype" === e && "value"in i && Ze in i && !i.writable) {
            var n = Je(t, e);
    ...
    var fi, gi, vi, bi = di.inspectSource, mi = X, yi = d.WeakMap, wi = mi(yi) && /native code/.test(String(yi)), Si = ee, xi = Nt("keys"), Oi = function(t) {
    ...
    var Vi = {
        ...
        getterFor: function(t) {
            return function(e) {
                var i;
                if (!Pi(e) || (i = gi(e)).type !== t)
                    throw _i("Incompatible receiver, " + t + " required");
                return i
            }
        }
    }
      ...
      , en = oi.exports = function(t, e, i) {
        ...
        i && i.getter && (e = "get " + e),
        i && i.setter && (e = "set " + e),
        (!Mi(t, "name") || zi && t.name !== e) && (Ui ? Yi(t, "name", {
            value: e,
            configurable: !0
        }) : t.name = e),
        Zi && i && Mi(i, "arity") && t.length !== i.arity && Yi(t, "length", {
            value: i.arity
        });
        try {
        ...
        var n = Wi(t);
        return Mi(n, "source") || (n.source = Qi(tn, "string" == typeof e ? e : "")),
        t
    }
    ;
    ...
    var nn = X
      ...
      , En = function(t, e) {
        var i, n = In(t), o = 0, r = [];
        for (i in n)
            !Pn($n, i) && Pn(n, i) && Rn(r, i);
        for (; e.length > o; )
            Pn(n, i = e[o++]) && (~An(r, i) || Rn(r, i));
        return r
    }
    ...
    var Dn = ot
      ...
      , lo = eo
      , co = function(t, e) {
        var i, n, o, r, a, s = t.target, l = t.global, c = t.stat;
        if (i = l ? io : c ? io[s] || ao(s, {}) : (io[s] || {}).prototype)
            for (n in e) {
                if (r = e[n],
                o = t.dontCallGetSet ? (a = no(i, n)) && a.value : i[n],
                !lo(l ? n : s + (c ? "." : "#") + n, t.forced) && void 0 !== o) {
                    if (typeof r == typeof o)
                        continue;
                    so(r, o)
                }
                (t.sham || o && o.sham) && oo(r, "sham", !0),
                ro(i, n, r, t)
            }
    }
      , ho = En
      ...
      , To = !Oo || bo((function() {
        ...
        for (var i = So(t), n = arguments.length, o = 1, r = yo.f, a = wo.f; n > o; )
            for (var s, l = xo(arguments[o++]), c = r ? Co(mo(l), r(l)) : mo(l), h = c.length, u = 0; h > u; )
                s = c[u++],
                fo && !vo(a, l, s) || (i[s] = l[s]);
        return i
    }
    ...
    pr.f = fr && !gr ? Object.defineProperties : function(t, e) {
        br(t);
        for (var i, n = mr(e), o = yr(e), r = o.length, a = 0; r > a; )
            vr.f(t, i = o[a++], n[i]);
        return t
    }
    ;
    var wr, Sr = ot("document", "documentElement"), xr = Me, Or = pr, kr = jn, Cr = ki, Tr = Sr, Pr = Ce, Ir = Oi("IE_PROTO"), Ar = function() {}, $r = function(t) {
        ...
        var t, e;
        Er = "undefined" != typeof document ? document.domain && wr ? Rr(wr) : ((e = Pr("iframe")).style.display = "none",
        Tr.appendChild(e),
        ...
        for (var i = kr.length; i--; )
            delete Er.prototype[kr[i]];
        return Er()
    };
    Cr[Ir] = !0;
    var jr = Object.create || function(t, e) {
        var i;
        return null !== t ? (Ar.prototype = xr(t),
        i = new Ar,
        Ar.prototype = null,
        i[Ir] = t) : i = Er(),
        void 0 === e ? i : Or.f(i, e)
    ...
    (ia || oa || na || Gr || Kr) && (Xr = function(t) {
        var e, i, n, o, r, a, s, l = this, c = Wr(l), h = Mr(t), u = c.raw;
        if (u)
        ...
        -1 === Zr(f, "g") && (f += "g"),
        b = ea(h, l.lastIndex),
        l.lastIndex > 0 && (!l.multiline || l.multiline && "\n" !== Qr(h, l.lastIndex - 1)) && (g = "(?: " + g + ")",
        b = " " + b,
        v++),
        i = new RegExp("^(?:" + g + ")",f)),
        oa && (i = new RegExp("^" + g + "$(?!\\s)",f)),
        ia && (n = l.lastIndex),
        o = Lr(Jr, p ? i : l, b),
        p ? o ? (o.input = ea(o.input, v),
        o[0] = ea(o[0], v),
        o.index = l.lastIndex,
        l.lastIndex += o[0].length) : l.lastIndex = 0 : ia && o && (l.lastIndex = l.global ? o.index + o[0].length : n),
        oa && o && o.length > 1 && Lr(Yr, o[0], i, (function() {
            for (r = 1; r < arguments.length - 2; r++)
                void 0 === arguments[r] && (o[r] = void 0)
        }
        )),
        o && d)
            for (o.groups = a = qr(null),
            r = 0; r < d.length; r++)
                a[(s = d[r])[0]] = o[s[1]];
        return o
    }
    ...
    var La = !_a || Ia((function() {
      ...
      , es = function(t) {
        return function(e, i) {
            var n, o, r = Ja(Xa(e)), a = Ya(i), s = r.length;
      ...
      , ds = Math.max
      , ps = function(t, e, i) {
        for (var n = cs(t), o = ls(e, n), r = ls(void 0 === i ? n : i, n), a = us(ds(r - o, 0)), s = 0; o < r; o++,
        s++)
            hs(a, s, t[o]);
        return a.length = s,
        a
    ...
    ks("split", (function(t, e, i) {
        ...
        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, i) {
            ...
            if (!Ps(t))
                return xs(e, n, t, o);
            for (var r, a, s, l = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), h = 0, u = new RegExp(t.source,c + "g"); (r = xs(Ns, u, n)) && !((a = u.lastIndex) > h && (Us(l, zs(n, h, r.index)),
            r.length > 1 && r.index < n.length && Ss(Hs, l, _s(r, 1)),
            s = r[0].length,
            h = a,
            l.length >= o)); )
                u.lastIndex === r.index && u.lastIndex++;
            return h === n.length ? !s && Ms(u, "") || Us(l, "") : Us(l, zs(n, h)),
            l.length > o ? _s(l, 0, o) : l
        }
        ...
        , function(t, o) {
            ...
            if (0 === d)
                return [];
            if (0 === a.length)
                return null === Fs(u, a) ? [a] : [];
            for (var p = 0, f = 0, g = []; f < a.length; ) {
                u.lastIndex = Vs ? 0 : f;
                var v, b = Fs(u, Vs ? zs(a, f) : a);
                if (null === b || (v = Ls(Rs(u.lastIndex + (Vs ? f : 0)), a.length)) === p)
                    f = $s(a, f, c);
                else {
                    if (Us(g, zs(a, p, f)),
                    g.length === d)
    ...
    var Ws = g
      ...
      , Qs = function(t) {
        return function(e) {
            for (var i, n = Ys(e), o = Ks(n), r = o.length, a = 0, s = []; r > a; )
                i = o[a++],
                Ws && !Js(n, i) || Xs(s, t ? [i, n[i]] : n[i]);
            return s
        }
    }
      , Zs = {
    ...
    var ll = F
      ...
      , bl = function(t) {
        var e;
        return dl(t) && (e = t.constructor,
        (pl(e) && (e === vl || dl(e.prototype)) || fl(e) && null === (e = e[gl])) && (e = void 0)),
        void 0 === e ? vl : e
    }
      , ml = function(t, e) {
    ...
    Ol({
        ...
        concat: function(t) {
            var e, i, n, o, r, a = Pl(this), s = Rl(a, 0), l = 0;
            for (e = -1,
    ...
    var Hc = kt
      ...
      , Uc = function(t, e) {
        if (!delete t[e])
            throw Mc("Cannot delete property " + Hc(e) + " of " + Hc(t))
    }
      , zc = ps
      , qc = Math.floor
      , Wc = function(t, e) {
      ...
      , Kc = function(t, e, i, n) {
        for (var o = e.length, r = i.length, a = 0, s = 0; a < o || s < r; )
            t[a + s] = a < o && s < r ? n(e[a], i[s]) <= 0 ? e[a++] : i[s++] : a < o ? e[a++] : i[s++];
        return t
    }
      , Yc = Wc
    ...
    jh("replace", (function(t, e, i) {
        ...
        , function(t, o) {
            ...
            for (var p, f = "", g = 0, v = 0; v < u.length; v++) {
                for (var b = Lh((d = u[v])[0]), m = Gh(Kh(Vh(d.index), a.length), 0), y = [], w = 1; w < d.length; w++)
                    Jh(y, void 0 === (p = d[w]) ? p : String(p));
                var S = d.groups;
                if (l) {
                    var x = Yh([b], y, m, a);
                    void 0 !== S && Jh(x, S);
    ...
    xa("search", (function(t, e, i) {
        ...
        , function(t) {
            ...
            var s = hu(n, o);
            return su(n.lastIndex, a) || (n.lastIndex = a),
            null === s ? -1 : s.index
        }
        ]
    }
    ...
    var Au = R
      ...
      , Du = Object.setPrototypeOf || ("__proto__"in {} ? function() {
        var t, e = !1, i = {};
        try {
            (t = _u(Object.prototype, "__proto__", "set"))(i, []),
      ...
      , Hu = function(t, e, i) {
        var n, o;
        return Lu && Vu(n = e.constructor) && n !== i && Bu(o = n.prototype) && o !== i.prototype && Lu(t, o),
        t
    }
      , Mu = y
      , Uu = Jt
      ...
      , Nd = ed && (!jd || _d || yd || wd || gd((function() {
        return Ed[Sd] = !1,
        xd(Rd) != Rd || xd(Ed) == Ed || "/a/i" != xd(Rd, "i")
    }
    )));
    if (od("RegExp", Nd)) {
        for (var Dd = function(t, e) {
            var i, n, o, r, a, s, l = ld(Od, this), c = cd(t), h = void 0 === e, u = [], d = t;
            if (!l && c && h && t.constructor === Dd)
                return t;
            if ((c || ld(Od, t)) && (t = t.source,
            h && (e = ud(d))),
            t = void 0 === t ? "" : hd(t),
            e = void 0 === e ? "" : hd(e),
            d = t,
            yd && "dotAll"in Rd && (n = !!e && Id(e, "s") > -1) && (e = Pd(e, /s/g, "")),
            i = e,
            _d && "sticky"in Rd && (o = !!e && Id(e, "y") > -1) && Fd && (e = Pd(e, /y/g, "")),
            wd && (r = function(t) {
            ...
            t = r[0],
            u = r[1]),
            a = rd(xd(t, e), l ? this : Od, Dd),
            (n || o || u.length) && (s = bd(a),
            n && (s.dotAll = !0,
            s.raw = Dd(function(t) {
                for (var e, i = t.length, n = 0, o = "", r = !1; n <= i; n++)
                    "\\" !== (e = Td(t, n)) ? r || "." !== e ? ("[" === e ? r = !0 : "]" === e && (r = !1),
                    o += e) : o += "[\\s\\S]" : o += e + Td(t, ++n);
                return o
            }(t), i)),
            o && (s.sticky = !0),
            u.length && (s.groups = u)),
    ...
    Xd({
        ...
        slice: function(t, e) {
            var i, n, o, r = np(this), a = ip(r), s = ep(t, a), l = ep(void 0 === e ? a : e, a);
            if (Qd(r) && (i = r.constructor,
            (Zd(i) && (i === cp || Qd(i.prototype)) || tp(i) && null === (i = i[lp])) && (i = void 0),
            i === cp || void 0 === i))
                return ap(r, s, l);
            for (n = new (void 0 === i ? cp : i)(hp(l - s, 0)),
            o = 0; s < l; s++,
            o++)
                s in r && op(n, o, r[s]);
            return n.length = o,
    ...
    )), vp = Jt, bp = X, mp = Gt, yp = gp, wp = Oi("IE_PROTO"), Sp = Object, xp = Sp.prototype, Op = yp ? Sp.getPrototypeOf : function(t) {
        var e = mp(t);
        if (vp(e, wp))
            return e[wp];
        var i = e.constructor;
    ...
    , kp = f, Cp = X, Tp = tt, Pp = Op, Ip = sn, Ap = he("iterator"), $p = !1;
    ...
    var Ep = {
      ...
      , ff = function(t, e, i, n, o, r, a) {
        ...
        }, u = e + " Iterator", d = !1, p = t.prototype, f = p[of] || p["@@iterator"] || o && p[o], g = !nf && f || h(o), v = "Array" == e && p.entries || f;
        if (v && (s = Gp(v.call(new t))) !== Object.prototype && s.next && (Gp(s) !== ef && (Kp ? Kp(s, ef) : qp(s[of]) || Xp(s, of, lf)),
        Yp(s, u, !0)),
        Zp && o == af && f && f.name !== af && (tf ? Jp(p, "name", af) : (d = !0,
        g = function() {
            return zp(f, this)
        }
        )),
      ...
      , wf = ff(Array, "Array", (function(t, e) {
        ...
        gf(void 0, !0)) : gf("keys" == i ? n : "values" == i ? e[n] : [n, e[n]], !1)
    }
    ), "values")
    ...
    Vf({
        ...
        splice: function(t, e) {
            var i, n, o, r, a, s, l = Bf(this), c = Mf(l), h = Lf(t, c), u = arguments.length;
            for (0 === u ? i = n = 0 : 1 === u ? (i = 0,
            n = c - h) : (i = u - 2,
            n = Jf(Yf(Hf(e), 0), c - h)),
            zf(c + i - n),
            o = qf(l, n),
            r = 0; r < n; r++)
                (a = h + r)in l && Wf(o, r, l[a]);
            if (o.length = n,
            i < n) {
                for (r = h; r < c - n; r++)
                    s = r + i,
                    (a = r + n)in l ? l[s] = l[a] : Gf(l, s);
                for (r = c; r > c - n + i; r--)
                    Gf(l, r - 1)
            } else if (i > n)
                for (r = c - n; r > h; r--)
                    s = r + i - 1,
                    (a = r + n - 1)in l ? l[s] = l[a] : Gf(l, s);
            for (r = 0; r < i; r++)
                l[r + h] = arguments[r + 2];
            return Uf(l, c - n + i),
            o
    ...
    kg && function(t, e) {
        for (var i, n = tg ? ug(e) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,isFinite,isInteger,isNaN,isSafeInteger,parseFloat,parseInt,fromString,range".split(","), o = 0; n.length > o; o++)
            rg(e, i = n[o]) && !rg(t, i) && pg(t, i, dg(e, i))
    }(ig.Number, bg);
    var Pg = co
      , Ig = cl
      , Ag = R([].reverse)
    ...
    Pg({
        ...
        reverse: function() {
            return Ig(this) && (this.length = this.length),
            Ag(this)
        }
    });
    var Rg = Gt
    ...
    xa("match", (function(t, e, i) {
        ...
        , function(t) {
            ...
            for (var s, l = [], c = 0; null !== (s = Mg(n, o)); ) {
                var h = Vg(s[0]);
                l[c] = h,
                "" === h && (n.lastIndex = Hg(o, Dg(n.lastIndex), a)),
                c++
            }
            return 0 === c ? null : l
        }
    ...
    zg({
        target: "String",
        proto: !0,
        forced: !!(ev || (Ug = Wg(String.prototype, "startsWith"),
        !Ug || Ug.writable)) && !ev
    }, {
    ...
    var gv = {
        ...
        extend: function() {
            for (var t = this, i = arguments.length, n = new Array(i), o = 0; o < i; o++)
                n[o] = arguments[o];
            var r, a = n[0] || {}, s = 1, l = !1;
            for ("boolean" == typeof a && (l = a,
            a = n[s] || {},
            s++),
            "object" !== e(a) && "function" != typeof a && (a = {}); s < n.length; s++) {
                var c = n[s];
                if (null != c)
                    for (var h in c) {
                        var u = c[h];
                        if ("__proto__" !== h && a !== u) {
                            ...
                            if (l && u && (this.isObject(u) || d)) {
                                ...
                                r = d && !Array.isArray(p) ? [] : d || this.isObject(p) ? p : {},
                                a[h] = this.extend(l, r, u)
                            } else
                                void 0 !== u && (a[h] = u)
                        }
                    }
            ...
            for (var s = 0; s < t.length; s++) {
                ...
                try {
                    for (h.s(); !(l = h.n()).done; ) {
                        ...
                        u.colspanIndex = f,
                        1 === p ? (u.fieldIndex = f,
                        void 0 === u.field && (u.field = f)) : u.colspanGroup = u.colspan;
                        for (var g = 0; g < d; g++)
                            for (var v = 0; v < p; v++)
                                n[s + g][f + v] = !0
                    }
        ...
        updateFieldGroup: function(t, e) {
            var i, n, o = (i = []).concat.apply(i, a(t)), r = c(t);
            try {
                for (r.s(); !(n = r.n()).done; ) {
                    var s, l = c(n.value);
                    try {
                        for (l.s(); !(s = l.n()).done; ) {
                            ...
                            if (h.colspanGroup > 1) {
                                ...
                                }, p = h.colspanIndex; p < h.colspanIndex + h.colspanGroup; p++)
                                    d(p);
                                h.colspan = u,
                                h.visible = u > 0
                            }
        ...
        getItemField: function(t, e, i) {
            var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : void 0
              , o = t;
            if (void 0 !== n && (i = n),
            "string" != typeof e || t.hasOwnProperty(e))
                return i ? this.escapeHTML(t[e]) : t[e];
            var r, a = e.split("."), s = c(a);
            try {
                for (s.s(); !(r = s.n()).done; ) {
                    var l = r.value;
                    o = o && o[l]
        ...
        sort: function(t, e, i, n, o, r) {
            ...
            return t === e ? 0 : ("string" != typeof t && (t = t.toString()),
            -1 === t.localeCompare(e) ? -1 * i : i)
        },
        getEventName: function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
            return e = e || "".concat(+new Date).concat(~~(1e6 * Math.random())),
            "".concat(t, "-").concat(e)
        },
            ...
            try {
                for (i.s(); !(e = i.n()).done; )
                    for (var n = e.value, o = 0, r = Object.keys(n); o < r.length; o++) {
                        var a = r[o];
                        if (a.startsWith("_") && (a.endsWith("_rowspan") || a.endsWith("_colspan")))
                            return !0
                    }
            } catch (t) {
                i.e(t)
    ...
    var Sv = {
      ...
      , xv = function() {
        function t(e) {
            ...
            this.lastCluster = 0;
            var o = function() {
                n.lastCluster !== (n.lastCluster = n.getNum()) && (n.initDOM(n.rows),
                n.callback(n.startIndex, n.endIndex))
            };
        ...
        return o(t, [{
            key: "initDOM",
            value: function(t, e) {
                void 0 === this.clusterHeight && (this.cache.scrollTop = this.scrollEl.scrollTop,
                ...
                var i = this.initData(t, this.getNum(e))
                  ...
                  , s = [];
                o && r ? (i.topOffset && s.push(this.getExtra("top", i.topOffset)),
                s.push(n),
            ...
            key: "getNum",
            value: function(t) {
                return this.scrollTop = t ? this.cache.scrollTop : this.scrollEl.scrollTop,
            ...
            value: function(t, e) {
                ...
                return i.className = "virtual-scroll-".concat(t),
      ...
      , Ov = function() {
        ...
        return o(n, [{
            ...
            value: function() {
                var i = this.options;
                this.constants = Sv.CONSTANTS,
                this.constants.theme = t.fn.bootstrapTable.theme,
                this.constants.dataToggle = this.constants.html.dataToggle || "data-toggle";
                var n = gv.getIconsPrefix(t.fn.bootstrapTable.theme)
                  , o = gv.getIcons(n);
                "string" == typeof i.icons && (i.icons = gv.calculateObjectValue(null, i.icons)),
                i.iconsPrefix = i.iconsPrefix || t.fn.bootstrapTable.defaults.iconsPrefix || n,
                i.icons = Object.assign(o, t.fn.bootstrapTable.defaults.icons, i.icons);
                var r = i.buttonsPrefix ? "".concat(i.buttonsPrefix, "-") : "";
                this.constants.buttonsClass = [i.buttonsPrefix, r + i.buttonsClass, gv.sprintf("".concat(r, "%s"), i.iconSize)].join(" ").trim(),
                this.buttons = gv.calculateObjectValue(this, i.buttons, [], {}),
                "object" !== e(this.buttons) && (this.buttons = {})
            }
        }, {
            key: "initLocale",
            value: function() {
            ...
            value: function() {
                ...
                this.options.buttonsToolbar ? this.$toolbar = t("body").find(this.options.buttonsToolbar) : this.$toolbar = this.$container.find(".fixed-table-toolbar"),
            ...
            value: function() {
                ...
                this.$header.find("tr").each((function(n, o) {
                    var r = t(o)
                      , a = [];
                    r.find("th").each((function(e, i) {
                        ...
                        for (var r in o)
                            t.fn.bootstrapTable.columnDefaults.hasOwnProperty(r) && delete o[r];
                        a.push(gv.extend({}, {
                    ...
                    i.push(a),
                    r.attr("class") && e._headerTrClasses.push(r.attr("class")),
                    r.attr("style") && e._headerTrStyles.push(r.attr("style"))
                }
                )),
                Array.isArray(this.options.columns[0]) || (this.options.columns = [this.options.columns]),
                this.options.columns = gv.extend(!0, [], i, this.options.columns),
                this.columns = [],
                this.fieldsColumnsIndex = [],
                gv.setFieldIndex(this.options.columns),
                this.options.columns.forEach((function(t, i) {
                    t.forEach((function(t, o) {
                        var r = gv.extend({}, n.COLUMN_DEFAULTS, t, {
                            passed: t
                        });
                        void 0 !== r.fieldIndex && (e.columns[r.fieldIndex] = r,
                        e.fieldsColumnsIndex[r.field] = r.fieldIndex),
                        e.options.columns[i][o] = r
                    }
                    ))
                }
                )),
                !this.options.data.length) {
                    ...
                    o.length && (this.options.data = o,
                    this.fromHtml = !0)
                }
                this.options.pagination && "server" !== this.options.sidePagination || (this.footerData = gv.trToData(this.columns, this.$el.find(">tfoot>tr"))),
            ...
            value: function() {
                ...
                gv.updateFieldGroup(this.options.columns, this.columns),
                this.options.columns.forEach((function(t, a) {
                    var s = [];
                    ...
                    l && "right" !== i.options.detailViewAlign && s.push(l),
                    t.forEach((function(t, o) {
                        ...
                        if (f += gv.sprintf("width: %s; ", !t.checkbox && !t.radio || h ? h ? h + c : void 0 : t.showSelectTitle ? void 0 : "36px"),
                        void 0 !== t.fieldIndex || t.visible) {
                            ...
                            if (g && g.classes && (m = gv.sprintf(' class="%s"', t.class ? [t.class, g.classes].join(" ") : g.classes)),
                            void 0 !== t.fieldIndex) {
                                if (i.header.fields[t.fieldIndex] = t.field,
                                i.header.styles[t.fieldIndex] = p + f,
                                i.header.classes[t.fieldIndex] = l,
                                i.header.formatters[t.fieldIndex] = t.formatter,
                                i.header.detailFormatters[t.fieldIndex] = t.detailFormatter,
                                i.header.events[t.fieldIndex] = t.events,
                                i.header.sorters[t.fieldIndex] = t.sorter,
                                i.header.sortNames[t.fieldIndex] = t.sortName,
                                i.header.cellStyles[t.fieldIndex] = t.cellStyle,
                                i.header.searchables[t.fieldIndex] = t.searchable,
                                !t.visible)
                                    return;
                                if (i.options.cardView && !t.cardVisible)
                                    return;
                                n[t.field] = t
                            }
                            ...
                            s.push("<th".concat(gv.sprintf(' title="%s"', t.titleTooltip)), t.checkbox || t.radio ? gv.sprintf(' class="bs-checkbox %s"', t.class || "") : m || l, gv.sprintf(' style="%s"', d + f + v.join("; ")), gv.sprintf(' rowspan="%s"', t.rowspan), gv.sprintf(' colspan="%s"', t.colspan), gv.sprintf(' data-field="%s"', t.field), 0 === o && a > 0 ? " data-not-first-th" : "", b.length > 0 ? b.join(" ") : "", ">"),
                            s.push(gv.sprintf('<div class="th-inner %s">', i.options.sortable && t.sortable ? "sortable".concat("center" === u ? " sortable-center" : "", " both") : ""));
                            var A = i.options.escape && i.options.escapeTitle ? gv.escapeHTML(t.title) : t.title
                              , $ = A;
                            t.checkbox && (A = "",
                            !i.options.singleSelect && i.options.checkboxHeader && (A = '<label><input name="btSelectAll" type="checkbox" /><span></span></label>'),
                            i.header.stateField = t.field),
                            t.radio && (A = "",
                            i.header.stateField = t.field),
                ...
                this.$container.off("click", ".th-inner").on("click", ".th-inner", (function(e) {
                    ...
                    if (i.options.detailView && !n.parent().hasClass("bs-checkbox") && n.closest(".bootstrap-table")[0] !== i.$container[0])
                        return !1;
            ...
            key: "initData",
            value: function(t, e) {
                "append" === e ? this.options.data = this.options.data.concat(t) : "prepend" === e ? this.options.data = [].concat(t).concat(this.options.data) : (t = t || gv.deepCopy(this.options.data),
                this.options.data = Array.isArray(t) ? t : t[this.options.dataField]),
                this.data = a(this.options.data),
                this.options.sortReset && (this.unsortedData = a(this.data)),
            ...
            value: function() {
                ...
                void 0 !== this.options.sortClass && (clearTimeout(o),
            ...
            value: function(e) {
                ...
                if (this.$header.add(this.$header_).find("span.order").remove(),
                this.options.sortName === o.data("field")) {
                    ...
                    void 0 === a ? this.options.sortOrder = "asc" : "asc" === a ? this.options.sortOrder = this.options.sortReset ? "asc" === s ? "desc" : void 0 : "desc" : "desc" === this.options.sortOrder && (this.options.sortOrder = this.options.sortReset ? "desc" === s ? "asc" : void 0 : "asc"),
                    void 0 === this.options.sortOrder && (this.options.sortName = void 0)
                } else
                    this.options.sortName = o.data("field"),
                    this.options.rememberOrder ? this.options.sortOrder = "asc" === o.data("order") ? "desc" : "asc" : this.options.sortOrder = this.columns[this.fieldsColumnsIndex[o.data("field")]].sortOrder || this.columns[this.fieldsColumnsIndex[o.data("field")]].order;
            ...
            key: "_sort",
            value: function() {
                if (this.trigger("sort", this.options.sortName, this.options.sortOrder),
                "server" === this.options.sidePagination && this.options.serverSort)
                    return this.options.pageNumber = 1,
                    void this.initServer(this.options.silentSort);
                this.options.pagination && this.options.sortResetPage && (this.options.pageNumber = 1,
                this.initPagination()),
                this.initSort(),
                this.initBody()
            }
            ...
            key: "initToolbar",
            value: function() {
                var i, n = this, o = this.options, a = [], s = 0, l = 0;
                this.$toolbar.find(".bs-bars").children().length && t("body").append(t(o.toolbar)),
                this.$toolbar.html(""),
                "string" != typeof o.toolbar && "object" !== e(o.toolbar) || t(gv.sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, o.toolbarAlign)).appendTo(this.$toolbar).append(t(o.toolbar)),
                a = ['<div class="'.concat(["columns", "columns-".concat(o.buttonsAlign), this.constants.classes.buttonsGroup, "".concat(this.constants.classes.pull, "-").concat(o.buttonsAlign)].join(" "), '">')],
                "string" == typeof o.buttonsOrder && (o.buttonsOrder = o.buttonsOrder.replace(/\[|\]| |'/g, "").split(",")),
                this.buttons = Object.assign(this.buttons, {
                    ...
                    columns: {
                        ...
                        html: function() {
                            ...
                            o.showColumnsSearch && (t.push(gv.sprintf(n.constants.html.toolbarDropdownItem, gv.sprintf('<input type="text" class="%s" name="columnsSearch" placeholder="%s" autocomplete="off">', n.constants.classes.input, o.formatSearch()))),
                            ...
                            o.showColumnsToggleAll) {
                                ...
                                t.push(gv.sprintf(n.constants.html.toolbarDropdownItem, gv.sprintf('<input type="checkbox" class="toggle-all" %s> <span>%s</span>', e ? 'checked="checked"' : "", o.formatColumnsToggleAll()))),
                                t.push(n.constants.html.toolbarDropdownSeparator)
                            }
                            var i = 0;
                            ...
                            n.columns.forEach((function(e, r) {
                                if (!n.isSelectionColumn(e) && (!o.cardView || e.cardVisible)) {
                                    ...
                                    e.switchable && (t.push(gv.sprintf(n.constants.html.toolbarDropdownItem, gv.sprintf('<input type="checkbox" data-field="%s" value="%s"%s%s> <span>%s</span>', e.field, r, a, s, e.switchableLabel ? e.switchableLabel : e.title))),
                                    l++)
                                }
                            }
                            )),
                ...
                for (var h = {}, u = 0, d = Object.entries(this.buttons); u < d.length; u++) {
                    ...
                    if (g.hasOwnProperty("html"))
                        ...
                        if (g.hasOwnProperty("attributes") && g.attributes.class && (b += " ".concat(g.attributes.class)),
                        ...
                        v += ">",
                        o.showButtonIcons && g.hasOwnProperty("icon") && (v += "".concat(gv.sprintf(this.constants.html.icon, o.iconsPrefix, g.icon), " ")),
                    ...
                    var O = "show".concat(f.charAt(0).toUpperCase()).concat(f.substring(1))
                      , k = o[O];
                    !(!g.hasOwnProperty("render") || g.hasOwnProperty("render") && g.render) || void 0 !== k && !0 !== k || (o[O] = !0),
                ...
                for (var I = 0, A = Object.entries(this.buttons); I < A.length; I++) {
                    ...
                    if (E.hasOwnProperty("event")) {
                        ...
                        }, _ = 0, F = Object.entries(E.event); _ < F.length; _++)
                            j()
                    }
                }
                if (o.showColumns) {
                    ...
                    if (l <= o.minimumCountColumns && i.find("input").prop("disabled", !0),
                    i.find("li, label").off("click").on("click", (function(t) {
                    ...
                    N.off("click").on("click", (function(e) {
                        ...
                        D.prop("checked", N.filter(":checked").length === n.columns.filter((function(t) {
                            return !n.isSelectionColumn(t)
                        }
                        )).length)
                    }
                ...
                var L = function(t) {
                    ...
                    t.off(e).on(e, (function(t) {
                        o.searchOnEnterKey && 13 !== t.keyCode || [37, 38, 39, 40].includes(t.keyCode) || (clearTimeout(s),
            ...
            value: function() {
                ...
                if (void 0 !== i && t(i).length && o) {
                    var r = t(i).val().trim();
                    if (this.options.trimOnSearch && t(i).val() !== r && t(i).val(r),
                    this.searchText === r)
                        return;
                    var a = gv.getSearchInput(this)
                      , s = i instanceof jQuery ? i : t(i);
                    (s.is(a) || s.hasClass("search-input")) && (this.searchText = r,
            ...
            value: function() {
                ...
                "server" !== this.options.sidePagination) {
                    if (this.options.customSearch)
                        return this.data = gv.calculateObjectValue(this.options, this.options.customSearch, [this.options.data, this.searchText, this.filterColumns]),
                        this.options.sortReset && (this.unsortedData = a(this.data)),
                        void this.initSort();
                    ...
                    this.options.searchAccentNeutralise && (i = gv.normalizeAccent(i)),
                    "function" == typeof this.filterOptions.filterAlgorithm ? this.data = this.options.data.filter((function(e) {
                        ...
                        if ("and" === i) {
                            for (var o in n)
                                if (Array.isArray(n[o]) && !n[o].includes(e[o]) || !Array.isArray(n[o]) && e[o] !== n[o])
                                    return !1
                        } else if ("or" === i) {
                            var r = !1;
                            for (var a in n)
                                (Array.isArray(n[a]) && n[a].includes(e[a]) || !Array.isArray(n[a]) && e[a] === n[a]) && (r = !0);
                            return r
                        }
                        return !0
                    }
                        ...
                        for (var a = 0; a < t.header.fields.length; a++)
                            if (t.header.searchables[a] && (!t.options.visibleSearch || -1 !== o.indexOf(t.header.fields[a]))) {
                                ...
                                if ("string" == typeof s) {
                                    ...
                                    c = n[s];
                                if (t.options.searchAccentNeutralise && (c = gv.normalizeAccent(c)),
                                l && l.searchFormatter && (c = gv.calculateObjectValue(l, t.header.formatters[a], [c, n, r, l.field], c)),
                                "string" == typeof c || "number" == typeof c) {
                                    if (t.options.strictSearch && "".concat(c).toLowerCase() === i || t.options.regexSearch && gv.regexCompare(c, e))
                                        return !0;
                                    ...
                                    if (p || "".concat(c).toLowerCase().includes(i))
                                        return !0
                                }
                            }
                        return !1
            ...
            value: function() {
                ...
                if (e.pagination) {
                    ...
                    var i, n, o, r, a, s, l, c = [], h = !1, u = this.getData({
                        includeHiddenRows: !1
                    }), d = e.pageList;
                    if ("string" == typeof d && (d = d.replace(/\[|\]| /g, "").toLowerCase().split(",")),
                    d = d.map((function(t) {
                    ...
                    this.totalPages = 0,
                    e.totalRows && (e.pageSize === e.formatAllRows() && (e.pageSize = e.totalRows,
                    h = !0),
                    ...
                    if (this.paginationParts.includes("pageSize")) {
                        ...
                        d.forEach((function(i, n) {
                            var o;
                            (!e.smartDisplay || 0 === n || d[n - 1] < e.totalRows || i === e.formatAllRows()) && (o = h ? i === e.formatAllRows() ? t.constants.classes.dropdownActive : "" : i === e.pageSize ? t.constants.classes.dropdownActive : "",
                            f.push(gv.sprintf(t.constants.html.pageDropdownItem, o, i)))
                        }
                        )),
                        f.push("".concat(this.constants.html.pageDropdown[1], "</div>")),
                        c.push(e.formatRecordsPerPage(f.join("")))
                    }
                    if ((this.paginationParts.includes("pageInfo") || this.paginationParts.includes("pageInfoShort") || this.paginationParts.includes("pageSize")) && c.push("</div></div>"),
                    this.paginationParts.includes("pageList")) {
                        c.push('<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationHAlign, ' pagination">'), gv.sprintf(this.constants.html.pagination[0], gv.sprintf(" pagination-%s", e.iconSize)), gv.sprintf(this.constants.html.paginationItem, " page-pre", e.formatSRPaginationPreText(), e.paginationPreText)),
                        this.totalPages < e.paginationSuccessivelySize ? (n = 1,
                        o = this.totalPages) : o = (n = e.pageNumber - e.paginationPagesBySide) + 2 * e.paginationPagesBySide,
                        e.pageNumber < e.paginationSuccessivelySize - 1 && (o = e.paginationSuccessivelySize),
                        e.paginationSuccessivelySize > this.totalPages - n && (n = n - (e.paginationSuccessivelySize - (this.totalPages - n)) + 1),
                        n < 1 && (n = 1),
                        ...
                        if (n > 1) {
                            ...
                            i = 1; i <= b; i++)
                                c.push(v(i));
                            n - 1 === b + 1 ? (i = n - 1,
                            c.push(v(i))) : n - 1 > b && (n - 2 * e.paginationPagesBySide > e.paginationPagesBySide && e.paginationUseIntermediate ? (i = Math.round((n - g) / 2 + g),
                            c.push(v(i, " page-intermediate"))) : c.push(gv.sprintf(this.constants.html.paginationItem, " page-first-separator disabled", "", "...")))
                        }
                        for (i = n; i <= o; i++)
                            c.push(v(i));
                        if (this.totalPages > o) {
                            ...
                            for (o >= m && (m = o + 1),
                            o + 1 === m - 1 ? (i = o + 1,
                            c.push(v(i))) : m > o + 1 && (this.totalPages - o > 2 * e.paginationPagesBySide && e.paginationUseIntermediate ? (i = Math.round((this.totalPages - g - o) / 2 + o),
                            c.push(v(i, " page-intermediate"))) : c.push(gv.sprintf(this.constants.html.paginationItem, " page-last-separator disabled", "", "..."))),
                            i = m; i <= this.totalPages; i++)
                                c.push(v(i))
                        }
                        c.push(gv.sprintf(this.constants.html.paginationItem, " page-next", e.formatSRPaginationNextText(), e.paginationNextText)),
                    ...
                    e.onlyInfoPagination || (r = this.$pagination.find(".page-list a"),
                    ...
                    e.smartDisplay && (d.length < 2 || e.totalRows <= d[0]) && this.$pagination.find("div.page-list").hide(),
                    this.$pagination[this.getData().length ? "show" : "hide"](),
                    e.paginationLoop || (1 === e.pageNumber && a.addClass("disabled"),
            ...
            value: function(e) {
                ...
                return i.parent().addClass(this.constants.classes.dropdownActive).siblings().removeClass(this.constants.classes.dropdownActive),
                this.options.pageSize = i.text().toUpperCase() === this.options.formatAllRows().toUpperCase() ? this.options.formatAllRows() : +i.text(),
                ...
                if (!(gv.findIndex(this.hiddenRows, t) > -1)) {
                    ...
                    this.header.fields.forEach((function(e, n) {
                        ...
                        if ((!a.fromHtml && !a.autoMergeCells || void 0 !== h || o.checkbox || o.radio) && o.visible && (!a.options.cardView || o.cardVisible)) {
                            if (c.concat([a.header.styles[n]]).length && (b += "".concat(c.concat([a.header.styles[n]]).join("; "))),
                            t["_".concat(e, "_style")] && (b += "".concat(t["_".concat(e, "_style")])),
                            b && (v = ' style="'.concat(b, '"')),
                            t["_".concat(e, "_id")] && (f = gv.sprintf(' id="%s"', t["_".concat(e, "_id")])),
                            t["_".concat(e, "_class")] && (g = gv.sprintf(' class="%s"', t["_".concat(e, "_class")])),
                            t["_".concat(e, "_rowspan")] && (y = gv.sprintf(' rowspan="%s"', t["_".concat(e, "_rowspan")])),
                            t["_".concat(e, "_colspan")] && (w = gv.sprintf(' colspan="%s"', t["_".concat(e, "_colspan")])),
                            t["_".concat(e, "_title")] && (S = gv.sprintf(' title="%s"', t["_".concat(e, "_title")])),
                            (p = gv.calculateObjectValue(a.header, a.header.cellStyles[n], [h, t, i, e], p)).classes && (g = ' class="'.concat(p.classes, '"')),
                            p.css) {
                            ...
                            if (u = gv.calculateObjectValue(o, a.header.formatters[n], [h, t, i, e], h),
                            o.checkbox || o.radio || (u = null == u ? a.options.undefinedText : u),
                            o.searchable && a.searchText && a.options.searchHighlight && !o.checkbox && !o.radio) {
                                var I = ""
                            ...
                            if (o.checkbox || o.radio) {
                                ...
                                l = '<div class="card-view">'.concat(U, '<span class="card-view-value ').concat(p.classes || "", '"').concat(v, ">").concat(u, "</span></div>"),
                                a.options.smartDisplay && "" === u && (l = '<div class="card-view"></div>')
                            } else
                                l = "<td".concat(f).concat(g).concat(v).concat(m).concat(y).concat(w).concat(S, ">").concat(u, "</td>");
                            s.push(l)
                        }
                    }
                    )),
            ...
            value: function(e, i) {
                ...
                for (var c = this.pageFrom - 1; c < this.pageTo; c++) {
                    ...
                    u && "string" == typeof u) {
                        ...
                        if (d && h.hasOwnProperty(d)) {
                            ...
                            f.is("tr.detail-view") && (l.push(c),
                            i && p === i || (u += f[0].outerHTML))
                        }
                        this.options.virtualScroll ? r.push(u) : a.append(u)
                    }
                }
                s ? this.options.virtualScroll ? (this.virtualScroll && this.virtualScroll.destroy(),
                this.virtualScroll = new xv({
                    rows: r,
                    fixedScroll: e,
                ...
                })) : this.$body.html(a) : this.$body.html('<tr class="no-records-found">'.concat(gv.sprintf('<td colspan="%s">%s</td>', this.getVisibleFields().length + gv.getDetailViewIndexOffset(this.options), this.options.formatNoMatches()), "</tr>")),
            ...
            value: function() {
                ...
                this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", (function(i) {
                    ...
                    if (!(n.find(".detail-icon").length || n.index() - gv.getDetailViewIndexOffset(e.options) < 0)) {
                        ...
                        if (e.trigger("click" === i.type ? "click-cell" : "dbl-click-cell", h, d, l, n),
                        e.trigger("click" === i.type ? "click-row" : "dbl-click-row", l, o, h),
                        "click" === i.type && e.options.clickToSelect && u.clickToSelect && !gv.calculateObjectValue(e.options, e.options.ignoreClickToSelectOn, [i.target])) {
                ...
                this.$body.find("> tr[data-index] > td > .detail-icon").off("click").on("click", (function(i) {
                    ...
                    e.toggleDetailView(t(i.currentTarget).parent().parent().data("index")),
                    !1
                }
                )),
                this.$selectItem = this.$body.find(gv.sprintf('[name="%s"]', this.options.selectItemName)),
                ...
                this.header.events.forEach((function(i, n) {
                    var o = i;
                    if (o) {
                        if ("string" == typeof o && (o = gv.calculateObjectValue(null, o)),
                        !o)
            ...
            value: function(e, i, n) {
                ...
                if (this.header.sortNames[a] && (s.sortName = this.header.sortNames[a]),
                this.options.pagination && "server" === this.options.sidePagination && (s.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize,
                ...
                n || this.options.url || this.options.ajax) {
                    ...
                    this.options.pagination && "server" === this.options.sidePagination && (s.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1),
                    s.limit = this.options.pageSize,
                    0 !== s.limit && this.options.pageSize !== this.options.formatAllRows() || delete s.limit)),
                    this.options.search && "server" === this.options.sidePagination && this.options.searchable && this.columns.filter((function(t) {
                        return t.searchable
                    }
                    )).length) {
                        s.searchable = [];
                    ...
                    if (gv.isEmptyObject(this.filterColumnsPartial) || (s.filter = JSON.stringify(this.filterColumnsPartial, null)),
                    gv.extend(s, i || {}),
                    !1 !== (r = gv.calculateObjectValue(this.options, this.options.queryParams, [s], r))) {
                        e || this.showLoading();
                        var d = gv.extend({}, gv.calculateObjectValue(null, this.options.ajaxOptions), {
                            ...
                            success: function(t, i, n) {
                                ...
                                e || o.hideLoading(),
                                "server" === o.options.sidePagination && o.options.pageNumber > 1 && r[o.options.totalField] > 0 && !r[o.options.dataField].length && o.updatePagination()
                            },
                            error: function(t) {
                                if (t && 0 === t.status && o._xhrAbort)
                                    o._xhrAbort = !1;
                                else {
                                    var i = [];
                                    "server" === o.options.sidePagination && ((i = {})[o.options.totalField] = 0,
                        ...
                        return this.options.ajax ? gv.calculateObjectValue(this, this.options.ajax, [d], null) : (this._xhr && 4 !== this._xhr.readyState && (this._xhrAbort = !0,
                        this._xhr.abort()),
                        this._xhr = t.ajax(d)),
                        r
                    }
            ...
            key: "trigger",
            value: function(e) {
                for (var i, o, r = "".concat(e, ".bs.table"), a = arguments.length, s = new Array(a > 1 ? a - 1 : 0), l = 1; l < a; l++)
                    s[l - 1] = arguments[l];
                (i = this.options)[n.EVENTS[r]].apply(i, [].concat(s, [this])),
                this.$el.trigger(t.Event(r, {
                    sender: this
                }), s),
                (o = this.options).onAll.apply(o, [r].concat([].concat(s, [this]))),
                this.$el.trigger(t.Event("all.bs.table", {
                    sender: this
                }), [r, s])
            }
        }, {
            ...
            value: function() {
                ...
                if (this.$el.is(":hidden"))
                    ...
                    this.$tableHeader.css("margin-right", n).find("table").css("width", this.$el.outerWidth()).html("").attr("class", this.$el.attr("class")).append(this.$header_),
            ...
            value: function() {
                if (this.options.showFooter && !this.options.cardView) {
                    var t = this.getData()
                      , e = []
                      , i = "";
                    gv.hasDetailViewIcon(this.options) && (i = '<th class="detail"><div class="th-inner"></div><div class="fht-cell"></div></th>'),
                    i && "right" !== this.options.detailViewAlign && e.push(i);
                    var n, o = c(this.columns);
                    try {
                        for (o.s(); !(n = o.n()).done; ) {
                            var a, s, l = n.value, h = [], u = {}, d = gv.sprintf(' class="%s"', l.class);
                            if (!(!l.visible || this.footerData && this.footerData.length > 0 && !(l.field in this.footerData[0]))) {
                                if (this.options.cardView && !l.cardVisible)
                                    return;
                                if (a = gv.sprintf("text-align: %s; ", l.falign ? l.falign : l.align),
                                s = gv.sprintf("vertical-align: %s; ", l.valign),
                                (u = gv.calculateObjectValue(null, this.options.footerStyle, [l])) && u.css)
                                ...
                                u && u.classes && (d = gv.sprintf(' class="%s"', l.class ? [l.class, u.classes].join(" ") : u.classes)),
                                e.push("<th", d, gv.sprintf(' style="%s"', a + s + h.concat().join("; ")));
                                var m = 0;
                                this.footerData && this.footerData.length > 0 && (m = this.footerData[0]["_".concat(l.field, "_colspan")] || 0),
                                m && e.push(' colspan="'.concat(m, '" ')),
                                e.push(">"),
                                e.push('<div class="th-inner">');
                                var y = "";
                                this.footerData && this.footerData.length > 0 && (y = this.footerData[0][l.field] || ""),
                                e.push(gv.calculateObjectValue(l, l.footerFormatter, [t, y], y)),
                                e.push("</div>"),
                    ...
                    i && "right" === this.options.detailViewAlign && e.push(i),
                    this.options.height || this.$tableFooter.length || (this.$el.append("<tfoot><tr></tr></tfoot>"),
                    this.$tableFooter = this.$el.find("tfoot")),
                    this.$tableFooter.find("tr").length || this.$tableFooter.html("<table><thead><tr></tr></thead></table>"),
            ...
            value: function() {
                var t, e = [], i = c(this.header.fields);
                try {
                    for (i.s(); !(t = i.n()).done; ) {
                        var n = t.value
            ...
            key: "refreshOptions",
            value: function(t) {
                gv.compareObjects(this.options, t, !0) || (this.options = gv.extend(this.options, t),
            ...
            value: function(t) {
                var e = this
                  , i = this.options.data;
                if (!(this.searchText || this.options.customSearch || void 0 !== this.options.sortName || this.enableCustomSort) && gv.isEmptyObject(this.filterColumns) && "function" != typeof this.options.filterOptions.filterAlgorithm && gv.isEmptyObject(this.filterColumnsPartial) || t && t.unfiltered || (i = this.data),
                ...
                return t && t.useCurrentPage && (i = i.slice(this.pageFrom - 1, this.pageTo)),
            ...
            value: function(t) {
                var e, i = t;
                this.options.pagination && "server" === this.options.sidePagination && (this.options.totalRows = i[this.options.totalField],
            ...
            value: function(t) {
                for (var e = 0, i = this.options.data.length - 1; i >= 0; i--) {
                    ...
                    void 0 === o && "$index" !== t.field || (!n.hasOwnProperty(t.field) && "$index" === t.field && t.values.includes(i) || t.values.includes(o)) && (e++,
                    this.options.data.splice(i, 1))
                }
                e && ("server" === this.options.sidePagination && (this.options.totalRows -= e,
                this.data = a(this.options.data)),
                this.initSearch(),
                this.initPagination(),
                this.initSort(),
            ...
            key: "insertRow",
            value: function(t) {
                t.hasOwnProperty("index") && t.hasOwnProperty("row") && (this.options.data.splice(t.index, 0, t.row),
                this.initSearch(),
                this.initPagination(),
                this.initSort(),
                this.initBody(!0))
            ...
            value: function(t) {
                var e, i, n = this.options.uniqueId, o = t, r = null;
                for (e = this.options.data.length - 1; e >= 0; e--) {
                    i = this.options.data[e];
                    var a = gv.getItemField(i, n, this.options.escape, i.escape);
                    if (void 0 !== a && ("string" == typeof a ? o = o.toString() : "number" == typeof a && (Number(a) === a && a % 1 == 0 ? o = parseInt(o, 10) : a === Number(a) && 0 !== a && (o = parseFloat(o))),
                    a === o)) {
                        r = i;
                        break
                    }
            ...
            value: function(t) {
                var e, i = null, n = c(Array.isArray(t) ? t : [t]);
                try {
                    for (n.s(); !(e = n.n()).done; ) {
                        var o = e.value;
                        if (o.hasOwnProperty("id") && o.hasOwnProperty("row")) {
                            var r = this.options.data.indexOf(this.getRowByUniqueId(o.id));
                            -1 !== r && (o.hasOwnProperty("replace") && o.replace ? this.options.data[r] = o.row : gv.extend(this.options.data[r], o.row),
                            i = o.id)
                        }
                    }
                } catch (t) {
            ...
            value: function(t) {
                ...
                e !== this.options.data.length && ("server" === this.options.sidePagination && (this.options.totalRows -= 1,
                this.data = a(this.options.data)),
                this.initSearch(),
                this.initPagination(),
                this.initBody(!0))
            ...
            value: function(e, i) {
                ...
                -1 !== o && (o += gv.getDetailViewIndexOffset(this.options),
                this.$body.find(">tr[data-index=".concat(i, "]")).find(">td:eq(".concat(o, ")")).replaceWith(t(n).find(">td:eq(".concat(o, ")"))),
                this.initBodyEvent(),
                this.initFooter(),
                this.resetView(),
                this.updateSelected())
            ...
            key: "updateCell",
            value: function(t) {
                t.hasOwnProperty("index") && t.hasOwnProperty("field") && t.hasOwnProperty("value") && (this.options.data[t.index][t.field] = t.value,
                !1 !== t.reinit ? (this.initSort(),
                this.initBody(!0)) : this._updateCellOnly(t.field, t.index))
            }
        }, {
            ...
            value: function(t) {
                ...
                !1 !== t.reinit ? (this.initSort(),
                this.initBody(!0)) : this._updateCellOnly(t.field, this.options.data.indexOf(this.getRowByUniqueId(t.id)))
            }
        }, {
            key: "showRow",
            value: function(t) {
            ...
            value: function(t, e) {
                var i;
                if (t.hasOwnProperty("index") ? i = this.getData()[t.index] : t.hasOwnProperty("uniqueId") && (i = this.getRowByUniqueId(t.uniqueId)),
                i) {
            ...
            value: function(t, e, i) {
                if (-1 !== t && this.columns[t].visible !== e && (this.columns[t].visible = e,
                this.initHeader(),
                this.initSearch(),
                this.initPagination(),
                this.initBody(),
                this.options.showColumns)) {
                    ...
                    i && n.filter(gv.sprintf('[value="%s"]', t)).prop("checked", e),
            ...
            value: function(e) {
                var i, n = this, o = c(this.columns.slice().reverse());
                try {
                    for (o.s(); !(i = o.n()).done; ) {
                        var r = i.value;
                        if (r.switchable) {
            ...
            key: "mergeCells",
            value: function(t) {
                var e, i, n = t.index, o = this.getVisibleFields().indexOf(t.field), r = t.rowspan || 1, a = t.colspan || 1, s = this.$body.find(">tr[data-index]");
            ...
            value: function(t, e) {
                ...
                if (n[this.header.stateField] = t,
                this.options.multipleSelectRow) {
                    if (this.multipleSelectRowShiftKey && this.multipleSelectRowLastSelectedIndex >= 0)
                        for (var s = r(this.multipleSelectRowLastSelectedIndex < e ? [this.multipleSelectRowLastSelectedIndex, e] : [e, this.multipleSelectRowLastSelectedIndex], 2), l = s[0], h = s[1], u = l + 1; u < h; u++)
                ...
                if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                    ...
                    this.data.forEach((function(o, r) {
                        ...
                        if (e.values.includes(o[e.field])) {
                            ...
                            if (!(a = t ? a.not(":checked") : a.filter(":checked")).length && s)
                                return;
                            a.prop("checked", t),
            ...
            value: function(t) {
                var e = 0;
                if (t && t.height && (this.options.height = t.height),
                this.$tableContainer.toggleClass("has-card-view", this.options.cardView),
                this.options.height) {
                    var i = this.$tableBody.get(0);
                    this.hasScrollBar = i.scrollWidth > i.clientWidth
                }
                if (!this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(),
                this.resetHeader(),
                e += this.$header.outerHeight(!0) + 1) : (this.$tableHeader.hide(),
                this.trigger("post-header")),
                ...
                this.$container.hasClass("fullscreen"))
                    ...
                    this.$tableBorder && (this.$tableBorder.css("width", ""),
                    ...
                    var n = this.$toolbar.outerHeight(!0)
                      ...
                      , s = a.outerHeight();
                    if (this.$tableContainer.css("height", "".concat(r, "px")),
                    this.$tableBorder && a.is(":visible")) {
                        var l = r - s - 2;
                        this.hasScrollBar && (l -= gv.getScrollBarWidth()),
            ...
            value: function() {
                ...
                "auto" === this.options.loadingFontSize && (t = .04 * this.$tableLoading.width(),
                t = Math.max(12, t),
                t = Math.min(32, t),
                t = "".concat(t, "px")),
            ...
            value: function() {
                ...
                this.$toolbar.find('button[name="paginationSwitch"]').html("".concat(gv.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(e)),
            ...
            value: function() {
                ...
                this.$toolbar.find('button[name="toggle"]').html("".concat(gv.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(e)).attr("aria-label", e).attr("title", e),
                this.initBody(),
            ...
            key: "filterBy",
            value: function(t, e) {
                this.filterOptions = gv.isEmptyObject(e) ? this.options.filterOptions : gv.extend(this.options.filterOptions, e),
                this.filterColumns = gv.isEmptyObject(t) ? {} : t,
            ...
            key: "selectPage",
            value: function(t) {
                t > 0 && t <= this.options.totalPages && (this.options.pageNumber = t,
                this.updatePagination())
            }
        }, {
            key: "prevPage",
            ...
            value: function(t, e) {
                this.$body.find(gv.sprintf('> tr[data-index="%s"]', t)).next().is("tr.detail-view") ? this.collapseRow(t) : this.expandRow(t, e),
                this.resetView()
            }
        }, {
            key: "expandRow",
            value: function(t, e) {
                ...
                if (this.options.detailViewIcon && n.find("a.detail-icon").html(gv.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailClose)),
            ...
            value: function(t) {
                ...
                i.next().is("tr.detail-view") && (this.options.detailViewIcon && i.find("a.detail-icon").html(gv.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen)),
            ...
            value: function(e) {
                e.hasOwnProperty("field") && e.hasOwnProperty("title") && (this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape && this.options.escapeTitle ? gv.escapeHTML(e.title) : e.title,
                this.columns[this.fieldsColumnsIndex[e.field]].visible && (this.$header.find("th[data-field]").each((function(i, n) {
                    if (t(n).data("field") === e.field)
                        return t(t(n).find(".th-inner")[0]).text(e.title),
                        !1
                }
                )),
                this.resetView()))
    ...
    return Ov.VERSION = Sv.VERSION,
    Ov.DEFAULTS = Sv.DEFAULTS,
    Ov.LOCALES = Sv.LOCALES,
    Ov.COLUMN_DEFAULTS = Sv.COLUMN_DEFAULTS,
    Ov.METHODS = Sv.METHODS,
    Ov.EVENTS = Sv.EVENTS,
    t.BootstrapTable = Ov,
    t.fn.bootstrapTable = function(i) {
        ...
        return this.each((function(n, r) {
            ...
            if ("string" == typeof i) {
                var l;
                if (!Sv.METHODS.includes(i))
                    throw new Error("Unknown method: ".concat(i));
                if (!s)
                    return;
                return a = (l = s)[i].apply(l, o),
                void ("destroy" === i && t(r).removeData("bootstrap.table"))
            }
            if (s)
                console.warn("You cannot initialize the table more than once!");
            else {
                var c = gv.extend(!0, {}, Ov.DEFAULTS, t(r).data(), "object" === e(i) && i);
                s = new t.BootstrapTable(r,c),
                t(r).data("bootstrap.table", s),
                s.init()
            }
        }
        )),
    ...
    ,
    t.fn.bootstrapTable.Constructor = Ov,
    t.fn.bootstrapTable.theme = Sv.THEME,
    t.fn.bootstrapTable.VERSION = Sv.VERSION,
    t.fn.bootstrapTable.defaults = Ov.DEFAULTS,
    t.fn.bootstrapTable.columnDefaults = Ov.COLUMN_DEFAULTS,
    t.fn.bootstrapTable.events = Ov.EVENTS,
    t.fn.bootstrapTable.locales = Ov.LOCALES,
    t.fn.bootstrapTable.methods = Ov.METHODS,
    t.fn.bootstrapTable.utils = gv,
    t((function() {
