...
!function(t, e) {
    ...
    function i(t, e, o) {
        return s.extend(!0, {}, t, function(t, e) {
            var o = t.length;
            let a = {};
            if (o < 1 || 2 < o)
    ...
    function d(t, e, a, r) {
        ...
        };
        {
            ...
            f(t.buttons, function(t) {
                if (o[t] === c)
                    throw new Error('button key "' + t + '" is not allowed (options are ' + n.join(' ') + ')')
            }),
            t
        }
    }
    ...
    return r.locales = function(t) {
        return t ? l[t] : l
    }
    ,
    r.addLocale = function(t, o) {
        return s.each(['OK', 'CANCEL', 'CONFIRM'], function(t, e) {
            if (!o[e])
    ...
    r.dialog = function(e) {
        ...
        e = function(a) {
            ...
            f(r, function(t, e, o) {
                ...
                !e.className) {
                    ...
                    n <= 2 && t ? e.className = 'btn-primary' : e.className = 'btn-secondary btn-default'
                }
            }),
            a
        }(e),
        s.fn.modal.Constructor.VERSION ? (e.fullBootstrapVersion = s.fn.modal.Constructor.VERSION,
        i = e.fullBootstrapVersion.indexOf('.'),
        e.bootstrap = e.fullBootstrapVersion.substring(0, i)) : (e.bootstrap = '2',
        ...
        if (a.find('.bootbox-body').html(e.message),
        0 < b(e.buttons) && (f(i, function(t, e) {
            let o = s(u.button);
        ...
        if (e.scrollable && (t.addClass('modal-dialog-scrollable'),
        ...
        e.title || e.closeButton) {
            if (e.title ? r.find('.modal-title').html(e.title) : r.addClass('border-0'),
            e.closeButton) {
        ...
        if (e.centerVertical && (t.addClass('modal-dialog-centered'),
        ...
        return o.on('escape.close.bb', function(t) {
    ...
    r.alert = function() {
        let t;
        if ((t = d('alert', ['ok'], ['message', 'callback'], arguments)).callback && !s.isFunction(t.callback))
    ...
    r.confirm = function() {
        let t;
        if (t = d('confirm', ['cancel', 'confirm'], ['message', 'callback'], arguments),
    ...
    r.prompt = function() {
        ...
        n.buttons.confirm.callback = function() {
            ...
            if ('checkbox' === n.inputType)
                e = i.find('input:checked').map(function() {
                    return s(this).val()
                }).get();
            else if ('radio' === n.inputType)
                e = i.find('input:checked').val();
            else {
                let t = i[0];
                if (n.errorMessage && t.setCustomValidity(''),
                t.checkValidity && !t.checkValidity())
                    return n.errorMessage && t.setCustomValidity(n.errorMessage),
                    t.reportValidity && t.reportValidity(),
                    !1;
                e = 'select' === n.inputType && !0 === n.multiple ? i.find('option:selected').map(function() {
                    return s(this).val()
                }).get() : i.val()
            }
        ...
        if (!u.inputs[n.inputType])
            throw new Error('Invalid prompt type');
        switch (i = s(u.inputs[n.inputType]),
        n.inputType) {
        case 'text':
        case 'textarea':
        case 'email':
        case 'password':
            ...
            n.rows && !isNaN(parseInt(n.rows)) && 'textarea' === n.inputType && i.attr({
                rows: n.rows
            });
            break;
        case 'date':
        ...
        case 'range':
            ...
            !function(t, e, o) {
                let a = !1
                  ...
                  , n = !0;
                if ('date' === t)
                    e === c || (r = v(e)) ? o === c || (n = v(o)) || console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your max value may not be enforced by this browser.') : console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your min value may not be enforced by this browser.');
                else if ('time' === t) {
                    if (e !== c && !(r = x(e)))
                ...
                return a
            }(n.inputType, n.min, n.max) || (n.min !== c && i.attr('min', n.min),
        ...
        case 'select':
            ...
            f(l, function(t, e) {
                ...
                e.group && (r[e.group] || (r[e.group] = s('<optgroup />').attr('label', e.group)),
                o = r[e.group]);
                let a = s(u.option);
        ...
        case 'radio':
            ...
            f(l, function(t, e) {
                ...
                o.find('label').append('\n' + e.text),
                n.value !== c && e.value === n.value && (o.find('input').prop('checked', !0),
                a = !1),
                i.append(o)
            }),
        ...
        '' !== s.trim(n.message) && (a = s(u.promptMessage).html(n.message),
        t.prepend(a)),
        n.message = t,
